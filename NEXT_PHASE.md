...
6. **Hardware co-design with specific silicon targets.** If Track 0.2 produces a compelling number for IBM PCM, can we collaborate or replicate the silicon-level experiment? Open question.
