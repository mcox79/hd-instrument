...
**cell:** `exp_rule_induction_heldout_entity_cskg_v1`
**recorded verdict:** `MIDDLE_BAND_PARTIAL_RULE_TRANSFER`
**margin (floor minus treatment):** `+0.2463`

|  | key | value |
|---|---|---|
| strongest floor found | `per_seed[0].arm_hits.BASELINE_POP.hits@100` | `0.394667` |
| best treatment found | `per_seed[0].arm_hits.RULE_ORACLE.hits@100` | `0.148333` |
...
2. Decide whether `per_seed[0].arm_hits.BASELINE_POP.hits@100` is the floor that claim must clear.
