...
**cell:** `exp_substrate_K2_x_cfrpe_compose_LM_v1`
**recorded verdict:** `MIDDLE_BAND`
**margin (floor minus treatment):** `+0.7783`

|  | key | value |
|---|---|---|
| strongest floor found | `per_seed[0].by_arm.ARM_BASELINE_RANK1_K1.best_T_for_mrr` | `1.0` |
| best treatment found | `per_seed[0].by_arm.ARM_CFRPE_K1.top1_acc` | `0.2217` |
...
2. Decide whether `per_seed[0].by_arm.ARM_BASELINE_RANK1_K1.best_T_for_mrr` is the floor that claim must clear.
