...
**cell:** `exp_unified_self_learning_loop_v5`
**recorded verdict:** `MIDDLE_BAND`
**margin (floor minus treatment):** `+0.3500`

|  | key | value |
|---|---|---|
| strongest floor found | `arms.SCRAMBLED.fast_diag.xsim_dense` | `0.9456` |
| best treatment found | `arms.MAIN_precision.spec_fact.ALL.hit1` | `0.5956` |
...
2. Decide whether `arms.SCRAMBLED.fast_diag.xsim_dense` is the floor that claim must clear.
