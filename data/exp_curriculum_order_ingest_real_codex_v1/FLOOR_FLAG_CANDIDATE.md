...
**cell:** `exp_curriculum_order_ingest_real_codex_v1`
**recorded verdict:** `MIDDLE_BAND_METRIC_NEAR_VACUOUS_INFO_CEI`
**margin (floor minus treatment):** `+0.3348`

|  | key | value |
|---|---|---|
| strongest floor found | `results.arms.random_hold.admit_rate_mean` | `1.0` |
| best treatment found | `results.arms.curriculum.degree_auroc_full` | `0.6651523648664824` |
...
2. Decide whether `results.arms.random_hold.admit_rate_mean` is the floor that claim must clear.
