...
**cell:** `exp_metacog_abstain_conformal_transfer_v1`
**recorded verdict:** `HARD_PASS_CONFORMAL_THRESHOLD_TRANSFERS_`
**margin (floor minus treatment):** `+0.2817`

|  | key | value |
|---|---|---|
| strongest floor found | `result.primary.frac_beats_random` | `1.0` |
| best treatment found | `result.target_cov_grid.0.7.median_realized_cov` | `0.7183098591549296` |
...
2. Decide whether `result.primary.frac_beats_random` is the floor that claim must clear.
