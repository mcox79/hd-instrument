...
**cell:** `exp_curriculum_order_ingest_real_alcpl_v1`
**recorded verdict:** `MIDDLE_BAND`
**margin (floor minus treatment):** `+0.0715`

|  | key | value |
|---|---|---|
| strongest floor found | `results.arms.random_hold.admit_rate_mean` | `1.0` |
| best treatment found | `results.arms.curriculum.degree_auroc_full` | `0.9284827860178801` |
