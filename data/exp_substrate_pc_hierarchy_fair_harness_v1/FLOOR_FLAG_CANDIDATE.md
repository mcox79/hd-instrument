...
**cell:** `exp_substrate_pc_hierarchy_fair_harness_v1`
**recorded verdict:** `HARD_PASS`
**margin (floor minus treatment):** `+0.7773`

|  | key | value |
|---|---|---|
| strongest floor found | `per_unit[2].by_arm.ARM_RANK_1_BASELINE.best_T_for_mrr` | `1.0` |
| best treatment found | `per_unit[2].by_arm.ARM_PC_HIERARCHY_2LEVEL_PLUS_CFRPE.top1_acc` | `0.2227` |
...
2. Decide whether `per_unit[2].by_arm.ARM_RANK_1_BASELINE.best_T_for_mrr` is the floor that claim must clear.
