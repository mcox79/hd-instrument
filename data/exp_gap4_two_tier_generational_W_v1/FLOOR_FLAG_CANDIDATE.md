...
**cell:** `exp_gap4_two_tier_generational_W_v1`
**recorded verdict:** `HARD_PASS`
**margin (floor minus treatment):** `+0.0833`

|  | key | value |
|---|---|---|
| strongest floor found | `detail.arms_aggregate.ARM_BASELINE_SINGLE_W.mean_final_forget` | `1.0` |
| best treatment found | `detail.arms_aggregate.ARM_TWO_TIER_PROMOTE_1000.mean_final_forget` | `0.9166666666666666` |
...
2. Decide whether `detail.arms_aggregate.ARM_BASELINE_SINGLE_W.mean_final_forget` is the floor that claim must clear.
