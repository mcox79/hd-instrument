...
**cell:** `exp_information_foraging_reading_v1`
**recorded verdict:** `HARD_PASS`
**margin (floor minus treatment):** `+0.1178`

|  | key | value |
|---|---|---|
| strongest floor found | `arms.RANDOM.banked_by_source.alice_in_wonderland` | `1.0` |
| best treatment found | `arms.FROZEN.dominant_domain_share` | `0.882184` |
...
2. Decide whether `arms.RANDOM.banked_by_source.alice_in_wonderland` is the floor that claim must clear.
