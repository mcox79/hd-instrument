...
**cell:** `exp_ner_gazetteer_external_cpu_v1`
**recorded verdict:** `MIDDLE_BAND`
**margin (floor minus treatment):** `+0.0368`

|  | key | value |
|---|---|---|
| strongest floor found | `per_seed[0].curve[2].baseline_f1` | `0.6441` |
| best treatment found | `per_seed[0].curve[2].gaz_f1` | `0.6073` |
...
2. Decide whether `per_seed[0].curve[2].baseline_f1` is the floor that claim must clear.
