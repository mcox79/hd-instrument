...
**cell:** `exp_role_filler_factorization_reader_coupled_cg_v1`
**recorded verdict:** `HARD_PASS_READING_AXIS_FIRST_CG`
**margin (floor minus treatment):** `+0.8495`

|  | key | value |
|---|---|---|
| strongest floor found | `aggregate.per_condition.control_synthetic.g_hat_cos_headline` | `0.9403224190076193` |
| best treatment found | `aggregate.real_content_cost_headline` | `0.09083333333333332` |
...
2. Decide whether `aggregate.per_condition.control_synthetic.g_hat_cos_headline` is the floor that claim must clear.
