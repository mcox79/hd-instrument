...
**cell:** `exp_role_filler_factorization_conceptnet_cg_v1`
**recorded verdict:** `HARD_PASS_READING_AXIS_FIRST_CG`
**margin (floor minus treatment):** `+0.8800`

|  | key | value |
|---|---|---|
| strongest floor found | `aggregate.per_condition.control_synthetic.factored_headline` | `0.9441666666666667` |
| best treatment found | `aggregate.real_content_cost_headline` | `0.0641666666666667` |
...
2. Decide whether `aggregate.per_condition.control_synthetic.factored_headline` is the floor that claim must clear.
