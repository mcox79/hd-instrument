...
**cell:** `exp_read_grow_adaptor_pyp_kn_breadth_v1`
**recorded verdict:** `HARD_PASS`
**margin (floor minus treatment):** `+0.9054`

|  | key | value |
|---|---|---|
| strongest floor found | `arm_b.baseline_reverb.per_class.compound_subject.n` | `1.0` |
| best treatment found | `arm_b.kn_gated.recall` | `0.0945945945945946` |
...
2. Decide whether `arm_b.baseline_reverb.per_class.compound_subject.n` is the floor that claim must clear.
