...
**cell:** `exp_earn_coref_match_or_allocate_dense_v1`
**recorded verdict:** `HARD_PASS_LEARNABLE_BEATS_BOTH_FLOORS_ON`
**margin (floor minus treatment):** `+0.0733`

|  | key | value |
|---|---|---|
| strongest floor found | `arms.recency_floor.overall.recall` | `1.0` |
| best treatment found | `arms.learnable.name_only.precision` | `0.9267399267399269` |
...
2. Decide whether `arms.recency_floor.overall.recall` is the floor that claim must clear.
