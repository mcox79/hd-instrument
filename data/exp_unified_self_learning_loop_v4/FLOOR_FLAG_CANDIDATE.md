...
**cell:** `exp_unified_self_learning_loop_v4`
**recorded verdict:** `MIDDLE_BAND`
**margin (floor minus treatment):** `+0.3023`

|  | key | value |
|---|---|---|
| strongest floor found | `arms.SCRAMBLED.fast_diag.xsim_dense` | `0.9883` |
| best treatment found | `arms.MAIN_plainavg.spec_fact.LOW.hit1` | `0.686` |
