...
**cell:** `exp_read_xsent_coref_centering_levers_v1`
**recorded verdict:** `MIDDLE_BAND`
**margin (floor minus treatment):** `+0.4473`

|  | key | value |
|---|---|---|
| strongest floor found | `within_sentence_same_table.single_sentence_baseline.attempt_rate` | `0.7946837763519706` |
| best treatment found | `within_sentence_same_table.xsent_adaptive_only.acc` | `0.3473877176901925` |
