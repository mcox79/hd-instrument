...
**cell:** `exp_reader_labeled_arc_candidate_filter_v1`
**recorded verdict:** `PASS`
**margin (floor minus treatment):** `+0.7226`

|  | key | value |
|---|---|---|
| strongest floor found | `C_payoff_mcguffey.per_construction.control_aspect.unlabeled_recall` | `1.0` |
| best treatment found | `C_payoff_mcguffey.candidate_precision.labeled_tight_obj_nsubjpass.precision` | `0.2774` |
...
2. Decide whether `C_payoff_mcguffey.per_construction.control_aspect.unlabeled_recall` is the floor that claim must clear.
