...
**cell:** `exp_reasoning_readout_length_generalization_clutrr_cg_v1`
**recorded verdict:** `HARD_PASS`
**margin (floor minus treatment):** `+0.1589`

|  | key | value |
|---|---|---|
| strongest floor found | `aggregate.mean_curve_scramble.2.arm_a` | `1.0` |
| best treatment found | `aggregate.mean_curve_clean.2.arm_a` | `0.8411111111111111` |
...
2. Decide whether `aggregate.mean_curve_scramble.2.arm_a` is the floor that claim must clear.
