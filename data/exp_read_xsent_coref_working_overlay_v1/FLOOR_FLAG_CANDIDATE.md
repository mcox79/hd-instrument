...
**cell:** `exp_read_xsent_coref_working_overlay_v1`
**recorded verdict:** `MIDDLE_BAND`
**margin (floor minus treatment):** `+0.4491`

|  | key | value |
|---|---|---|
| strongest floor found | `within_sentence_same_table.single_sentence_baseline.attempt_rate` | `0.7946837763519706` |
| best treatment found | `within_sentence_same_table.xsent_recency.acc` | `0.34555453712190654` |
