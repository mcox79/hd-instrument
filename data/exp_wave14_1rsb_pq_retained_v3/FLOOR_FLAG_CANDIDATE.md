...
**cell:** `exp_wave14_1rsb_pq_retained_v3`
**recorded verdict:** `PQ_RETAINED_MIDDLE`
**margin (floor minus treatment):** `+0.0404`

|  | key | value |
|---|---|---|
| strongest floor found | `summary.q_ea_random_floor` | `0.044194173824159216` |
| best treatment found | `summary.mean_q_sig` | `0.003760745945401737` |
...
2. Decide whether `summary.q_ea_random_floor` is the floor that claim must clear.
