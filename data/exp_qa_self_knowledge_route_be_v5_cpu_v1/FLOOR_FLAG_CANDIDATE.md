...
**cell:** `exp_qa_self_knowledge_route_be_v5_cpu_v1`
**recorded verdict:** `MIDDLE_BAND`
**margin (floor minus treatment):** `+0.0106`

|  | key | value |
|---|---|---|
| strongest floor found | `per_seed[0].macro_v1_baseline` | `0.4684` |
| best treatment found | `per_seed[0].macro_f1` | `0.4578` |
...
2. Decide whether `per_seed[0].macro_v1_baseline` is the floor that claim must clear.
