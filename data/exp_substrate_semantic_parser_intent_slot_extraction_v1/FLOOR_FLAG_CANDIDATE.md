...
**cell:** `exp_substrate_semantic_parser_intent_slot_extraction_v1`
**recorded verdict:** `HARD_PASS`
**margin (floor minus treatment):** `+0.0850`

|  | key | value |
|---|---|---|
| strongest floor found | `per_arm_per_seed.ARM_BASELINE_SYMBOLIC.11.intent_acc` | `1.0` |
| best treatment found | `per_arm_per_seed.ARM_SUBSTRATE_FULL.11.intent_acc` | `0.915` |
...
2. Decide whether `per_arm_per_seed.ARM_BASELINE_SYMBOLIC.11.intent_acc` is the floor that claim must clear.
