...
**cell:** `exp_substrate_dual_trace_sequential_neuromod_LM_v1`
**recorded verdict:** `HARD_PASS`
**margin (floor minus treatment):** `+0.7530`

|  | key | value |
|---|---|---|
| strongest floor found | `per_seed[2].by_arm.ARM_NAIVE_MULT.best_T_for_mrr` | `1.0` |
| best treatment found | `per_seed[2].by_arm.ARM_DUAL_TRACE.top1_acc` | `0.247` |
...
2. Decide whether `per_seed[2].by_arm.ARM_NAIVE_MULT.best_T_for_mrr` is the floor that claim must clear.
