# Pre-registration: substrate_cleanup_family_wm_kcliff_v1

**Date:** 2026-06-30
**Author:** exp_dev (Opus 4.7 1M, agent-spawn)
**Trigger:** Director spec `notes/director_cleanup_family_primitive_library_spec_2026-06-30.md`.

## Anchor

`substrate_cleanup_family_wm_kcliff_v1_seed_{7,13,19}` (3 chunked sibling cells).
Shared core: `experiments/_substrate_cleanup_family_wm_kcliff_v1_core.py`.
