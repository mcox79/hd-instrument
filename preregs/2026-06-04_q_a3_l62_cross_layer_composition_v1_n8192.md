# Prereg: q_a3_l62_cross_layer_composition_v1_n8192

## Anchor
q_a3_l62_cross_layer_composition_v1_n8192

## Priority
D (cycle 45 all-night burst, N=8192 depth ladder, rung 43)

## Scientific question
Does cross-layer composition fidelity remain EXACT-1.0 at L=62 N=8192?
...
2. M_MID length == L_DEPTH - 2 == 60. [INPUT: L_DEPTH=62] [EXPECTED: len(M_MID)=60]
