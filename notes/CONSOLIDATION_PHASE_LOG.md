...
| J | ATL conceptual/definitional channel + operation-routing | (pending) | (pending) | (pending) | ⬜ QUEUED |
...
- Commit: see git log (strategy: land graded_competition organ -- consolidation step 1).
