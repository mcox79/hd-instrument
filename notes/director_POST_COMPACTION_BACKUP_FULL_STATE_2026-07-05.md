...
1. Read the richer-content result (a88d7 / data/exp_schema_relation_TEM_scorer_scaleup*richer* or its metrics) -> if broad-win, prize achieved; if plateau, the one-to-many ceiling is genuine -> pivot generalization to CLS-consolidation (brain-component route).
