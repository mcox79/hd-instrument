...
generated: 2026-09-03T20:31:03Z  |  HEAD: 46001a409
...
Heartbeats (data/heartbeats/*.timestamp):
  - exp_dev: 8488 min ago <-- STALE
  - orchestrator: 54554 min ago <-- STALE
  - research: 1295 min ago <-- STALE
  - skunkworks: 57225 min ago <-- STALE
  - testbed: 93800 min ago <-- STALE
data/ directories touched in the last 180 min:
  ...
  - exp_register_predicate_crf_tagger_v1: 0 min ago, has metrics.json
  - exp_sg_lite_grounded_settling_readout_v1: 5 min ago, has metrics.json
  - _sglite_cache: 5 min ago, NO metrics.json yet (likely in-flight)
  - exp_referent_per_np_selection_improvement_v1: 7 min ago, has metrics.json
  - .metrics_sync: 15 min ago, NO metrics.json yet (likely in-flight)
  - exp_sg_lite_predictive_coding_encoder_wsd_v1: 25 min ago, NO metrics.json yet (likely in-flight)
...
- 12 new commit(s) since last snapshot (HEAD 8dda0e95a -> 46001a409)
- data/ directory count: 8964 -> 8981 (+17)
