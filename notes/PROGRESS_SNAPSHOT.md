...
generated: 2026-09-06T23:14:58Z  |  HEAD: 9f31bab60
...
Heartbeats (data/heartbeats/*.timestamp):
  - exp_dev: 12972 min ago <-- STALE
  - orchestrator: 59038 min ago <-- STALE
  - research: 1253 min ago <-- STALE
  - skunkworks: 61709 min ago <-- STALE
  - testbed: 98283 min ago <-- STALE
data/ directories touched in the last 180 min:
  ...
  - exp_spatial_position_qa_v1: 2 min ago, has metrics.json
  - exp_spatial_position_gold_v1: 2 min ago, has metrics.json
  - exp_spatial_reasoner_gold_relations_v1: 2 min ago, has metrics.json
  - exp_temporal_reason_duration_udstime_v1: 3 min ago, has metrics.json
  - corpora: 3 min ago, NO metrics.json yet (likely in-flight)
...
- 3 new commit(s) since last snapshot (HEAD bea69de26 -> 9f31bab60)
- data/ directory count: 9337 -> 9345 (+8)
