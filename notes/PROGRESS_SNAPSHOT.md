...
generated: 2026-09-06T02:21:41Z  |  HEAD: c9060345f
...
Heartbeats (data/heartbeats/*.timestamp):
  - exp_dev: 11719 min ago <-- STALE
  - orchestrator: 57784 min ago <-- STALE
  - research: 336 min ago <-- STALE
  - skunkworks: 60456 min ago <-- STALE
  - testbed: 97030 min ago <-- STALE
data/ directories touched in the last 180 min:
  ...
  - exp_coref_graded_upstream_drill_v1: 1 min ago, NO metrics.json yet (likely in-flight)
  - exp_space_ground_binding_litbank_v1: 2 min ago, has metrics.json
  - exp_space_named_ground_binding_v1: 2 min ago, has metrics.json
  - .metrics_sync: 8 min ago, NO metrics.json yet (likely in-flight)
  - exp_board_common_noun_coref_v1_selftest: 78 min ago, has metrics.json
...
- 17 new commit(s) since last snapshot (HEAD 845678820 -> c9060345f)
- data/ directory count: 9208 -> 9230 (+22)
