...
generated: 2026-09-03T12:06:03Z  |  HEAD: b2f0357ac
...
Heartbeats (data/heartbeats/*.timestamp):
  - exp_dev: 7983 min ago <-- STALE
  - orchestrator: 54049 min ago <-- STALE
  - research: 790 min ago <-- STALE
  - skunkworks: 56720 min ago <-- STALE
  - testbed: 93295 min ago <-- STALE
data/ directories touched in the last 180 min:
  ...
  - exp_whodidwhat_verb_id_recoverable_v1: 1 min ago, has metrics.json
  - _sglite_cache: 1 min ago, NO metrics.json yet (likely in-flight)
  - exp_whodidwhat_coverage_transitivity_control_v1: 9 min ago, has metrics.json
  - composedhub_conflict_flag_v1: 10 min ago, has metrics.json
  - .metrics_sync: 12 min ago, NO metrics.json yet (likely in-flight)
  - durability_reports: 55 min ago, NO metrics.json yet (likely in-flight)
...
- data/ directory count: 8921 -> 8923 (+2)
