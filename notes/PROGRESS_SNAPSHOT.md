...
generated: 2026-09-01T03:35:27Z  |  HEAD: 618768813
...
Heartbeats (data/heartbeats/*.timestamp):
  - exp_dev: 4592 min ago <-- STALE
  - orchestrator: 50658 min ago <-- STALE
  - research: 54 min ago
  - skunkworks: 53330 min ago <-- STALE
  - testbed: 89904 min ago <-- STALE
data/ directories touched in the last 180 min:
  ...
  - substrate_director_kb_v1.staging.11292: 4 min ago, NO metrics.json yet (likely in-flight)
  - exp_retrieval_practice_consolidation_v1_smoke: 19 min ago, has metrics.json
  - exp_grounded_distributional_fusion_paraphrase_v1: 21 min ago, has metrics.json
  - exp_situation_model_inference_mcscript_v1: 73 min ago, has metrics.json
  - exp_grounded_binding_paraphrase_coref_v1: 74 min ago, has metrics.json
