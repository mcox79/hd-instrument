...
generated: 2026-09-08T12:04:06Z  |  HEAD: cd0ba7e20
...
Heartbeats (data/heartbeats/*.timestamp):
  - exp_dev: 15181 min ago <-- STALE
  - orchestrator: 61247 min ago <-- STALE
  - research: 760 min ago <-- STALE
  - skunkworks: 63919 min ago <-- STALE
  - testbed: 100493 min ago <-- STALE
data/ directories touched in the last 180 min:
  ...
  - exp_causal_order_comprehension_organ_v1: 2 min ago, has metrics.json
  - exp_genworldmodel_optimized_coref_v1: 3 min ago, has metrics.json
  - .metrics_sync: 9 min ago, NO metrics.json yet (likely in-flight)
  - durability_reports: 53 min ago, NO metrics.json yet (likely in-flight)
  - snapshots: 53 min ago, NO metrics.json yet (likely in-flight)
  - capability_registry_reports: 164 min ago, NO metrics.json yet (likely in-flight)
...
- 18 new commit(s) since last snapshot (HEAD 664139141 -> cd0ba7e20)
- data/ directory count: 9484 -> 9492 (+8)
