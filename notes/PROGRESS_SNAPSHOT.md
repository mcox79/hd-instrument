...
generated: 2026-09-01T11:04:49Z  |  HEAD: 3cdc41593
...
Heartbeats (data/heartbeats/*.timestamp):
  - exp_dev: 5042 min ago <-- STALE
  - orchestrator: 51108 min ago <-- STALE
  - research: 416 min ago <-- STALE
  - skunkworks: 53779 min ago <-- STALE
  - testbed: 90353 min ago <-- STALE
data/ directories touched in the last 180 min:
  ...
  - exp_oracle_extraction_script_order_mcscript_v1: 7 min ago, has metrics.json
  - .metrics_sync: 8 min ago, NO metrics.json yet (likely in-flight)
  - exp_retrieval_practice_consolidation_v1_smoke: 15 min ago, has metrics.json
  - capability_registry_reports: 106 min ago, NO metrics.json yet (likely in-flight)
...
- 5 new commit(s) since last snapshot (HEAD b8d053d13 -> 3cdc41593)
- data/ directory count: 8763 -> 8766 (+3)
