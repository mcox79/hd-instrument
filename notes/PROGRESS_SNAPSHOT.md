...
generated: 2026-09-01T12:08:06Z  |  HEAD: 15d152ebe
...
Heartbeats (data/heartbeats/*.timestamp):
  - exp_dev: 5105 min ago <-- STALE
  - orchestrator: 51171 min ago <-- STALE
  - research: 63 min ago
  - skunkworks: 53843 min ago <-- STALE
  - testbed: 90417 min ago <-- STALE
data/ directories touched in the last 180 min:
  ...
  - exp_retrieval_practice_consolidation_v1_smoke: 5 min ago, has metrics.json
  - .metrics_sync: 11 min ago, NO metrics.json yet (likely in-flight)
  - hook_state: 14 min ago, NO metrics.json yet (likely in-flight)
  - exp_oracle_extraction_script_order_mcscript_v1: 49 min ago, has metrics.json
  - durability_reports: 57 min ago, NO metrics.json yet (likely in-flight)
  - snapshots: 57 min ago, NO metrics.json yet (likely in-flight)
...
- 4 new commit(s) since last snapshot (HEAD 3cdc41593 -> 15d152ebe)
