...
generated: 2026-09-09T18:20:45Z  |  HEAD: f5e878732
...
Heartbeats (data/heartbeats/*.timestamp):
  - exp_dev: 16998 min ago <-- STALE
  - orchestrator: 63064 min ago <-- STALE
  - research: 115 min ago <-- STALE
  - skunkworks: 65735 min ago <-- STALE
  - testbed: 102309 min ago <-- STALE
data/ directories touched in the last 180 min:
  ...
  - exp_grounded_meaning_readout_coverage_fusion_v1: 1 min ago, NO metrics.json yet (likely in-flight)
  - exp_causal_necessity_bf_reader_v1: 3 min ago, has metrics.json
  - exp_causal_rung_exposure_v1: 3 min ago, has metrics.json
  - exp_knowledge_lever_v1: 4 min ago, has metrics.json
  - .metrics_sync: 6 min ago, NO metrics.json yet (likely in-flight)
  - exp_knowledge_lever_v1_smoke: 9 min ago, has metrics.json
...
- 3 new commit(s) since last snapshot (HEAD 4be45f72d -> f5e878732)
- data/ directory count: 9654 -> 9666 (+12)
