...
generated: 2026-09-01T15:44:00Z  |  HEAD: 091214382
...
Heartbeats (data/heartbeats/*.timestamp):
  - exp_dev: 5321 min ago <-- STALE
  - orchestrator: 51387 min ago <-- STALE
  - research: 125 min ago <-- STALE
  - skunkworks: 54058 min ago <-- STALE
  - testbed: 90632 min ago <-- STALE
data/ directories touched in the last 180 min:
  ...
  - exp_ppr_spreading_activation_wsd_wic_v1: 0 min ago, has metrics.json
  - exp_parser_register_adaptation_v1: 1 min ago, has metrics.json
  - exp_atl_hub_mention_resolution_mcscript_v1: 8 min ago, has metrics.json
  - exp_conjunctive_event_aligner_probe_v1: 8 min ago, has metrics.json
  - .metrics_sync: 10 min ago, NO metrics.json yet (likely in-flight)
  - exp_construction_integration_reasoner_mcscript_v1: 15 min ago, has metrics.json
...
- 7 new commit(s) since last snapshot (HEAD 0f70d925d -> 091214382)
- data/ directory count: 8768 -> 8787 (+19)
