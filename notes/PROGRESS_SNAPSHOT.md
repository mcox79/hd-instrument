...
generated: 2026-09-03T18:53:16Z  |  HEAD: 8dda0e95a
...
Heartbeats (data/heartbeats/*.timestamp):
  - exp_dev: 8390 min ago <-- STALE
  - orchestrator: 54456 min ago <-- STALE
  - research: 1197 min ago <-- STALE
  - skunkworks: 57128 min ago <-- STALE
  - testbed: 93702 min ago <-- STALE
data/ directories touched in the last 180 min:
  ...
  - exp_referent_per_np_end_to_end_v1: 2 min ago, has metrics.json
  - hook_state: 12 min ago, NO metrics.json yet (likely in-flight)
  - exp_whodidwhat_joint_decoded_parser_v1: 19 min ago, has metrics.json
  - exp_sg_lite_knowledge_growth_diagnostic_v1: 22 min ago, NO metrics.json yet (likely in-flight)
  - _sglite_cache: 24 min ago, NO metrics.json yet (likely in-flight)
...
- data/ directory count: 8963 -> 8964 (+1)
