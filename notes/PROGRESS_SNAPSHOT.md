...
generated: 2026-08-31T23:23:14Z  |  HEAD: ad514014e
...
Heartbeats (data/heartbeats/*.timestamp):
  - exp_dev: 4340 min ago <-- STALE
  - orchestrator: 50406 min ago <-- STALE
  - research: 113 min ago <-- STALE
  - skunkworks: 53078 min ago <-- STALE
  - testbed: 89652 min ago <-- STALE
data/ directories touched in the last 180 min:
  ...
  - forward_prediction_flag_negative_diagnosis_v1: 1 min ago, has metrics.json
  - hook_state: 3 min ago, NO metrics.json yet (likely in-flight)
  - substrate_director_kb_v1.staging.13768: 6 min ago, NO metrics.json yet (likely in-flight)
  - forward_prediction_agent_conditioned_surprisal_v1: 6 min ago, has metrics.json
  - .metrics_sync: 7 min ago, NO metrics.json yet (likely in-flight)
  - exp_learner_live_canary_continual_growth_v1: 35 min ago, has metrics.json
...
- 6 new commit(s) since last snapshot (HEAD 95021944f -> ad514014e)
- data/ directory count: 8748 -> 8752 (+4)
