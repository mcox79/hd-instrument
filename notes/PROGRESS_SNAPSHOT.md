...
generated: 2026-08-29T21:22:56Z  |  HEAD: fb9824b0d
...
Heartbeats (data/heartbeats/*.timestamp):
  - exp_dev: 1340 min ago <-- STALE
  - orchestrator: 47406 min ago <-- STALE
  - research: 1241 min ago <-- STALE
  - skunkworks: 50077 min ago <-- STALE
  - testbed: 86651 min ago <-- STALE
data/ directories touched in the last 180 min:
  ...
  - substrate_director_kb_v1.staging.36448: 30 min ago, NO metrics.json yet (likely in-flight)
  - exp_discfact_store_multifact_load_v1: 105 min ago, has metrics.json
  - exp_causal_force_dynamics_probe_v1: 110 min ago, has metrics.json
  - exp_register_salience_gated_handoff_v1: 110 min ago, has metrics.json
