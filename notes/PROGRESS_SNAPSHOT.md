...
generated: 2026-09-07T22:49:14Z  |  HEAD: 21515fce7
...
Heartbeats (data/heartbeats/*.timestamp):
  - exp_dev: 14386 min ago <-- STALE
  - orchestrator: 60452 min ago <-- STALE
  - research: 1231 min ago <-- STALE
  - skunkworks: 63124 min ago <-- STALE
  - testbed: 99698 min ago <-- STALE
data/ directories touched in the last 180 min:
  ...
  - exp_crosstype_upgrades_gum_v1: 1 min ago, has metrics.json
  - hook_state: 2 min ago, NO metrics.json yet (likely in-flight)
  - exp_structured_matcher_event_goal_v1: 7 min ago, has metrics.json
  - exp_joint_causal_survival_v1: 10 min ago, has metrics.json
  - .metrics_sync: 14 min ago, NO metrics.json yet (likely in-flight)
  - exp_sdrt_no_regress_v1: 25 min ago, has metrics.json
...
- 8 new commit(s) since last snapshot (HEAD 160ad46f7 -> 21515fce7)
- data/ directory count: 9445 -> 9453 (+8)
