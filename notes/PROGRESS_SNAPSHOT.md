...
generated: 2026-08-30T03:52:43Z  |  HEAD: e6f72cbf3
...
Heartbeats (data/heartbeats/*.timestamp):
  - exp_dev: 1730 min ago <-- STALE
  - orchestrator: 47796 min ago <-- STALE
  - research: 20 min ago
  - skunkworks: 50467 min ago <-- STALE
  - testbed: 87041 min ago <-- STALE
data/ directories touched in the last 180 min:
  ...
  - exp_belief_timeline_real_prose_v1: 5 min ago, has metrics.json
  - substrate_director_kb_v1.staging.17452: 5 min ago, NO metrics.json yet (likely in-flight)
  - exp_belief_timeline_flashback_register_v1: 7 min ago, has metrics.json
  - exp_belief_timeline_query_v1: 12 min ago, has metrics.json
...
- data/ directory count: 8618 -> 8620 (+2)
