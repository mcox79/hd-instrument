...
generated: 2026-08-31T15:41:12Z  |  HEAD: e1c30392e
...
Heartbeats (data/heartbeats/*.timestamp):
  - exp_dev: 3878 min ago <-- STALE
  - orchestrator: 49944 min ago <-- STALE
  - research: 41 min ago
  - skunkworks: 52616 min ago <-- STALE
  - testbed: 89190 min ago <-- STALE
data/ directories touched in the last 180 min:
  ...
  - exp_assembled_reader_all_flags_on_v1: 23 min ago, NO metrics.json yet (likely in-flight)
  - verb_subcat_graded_presence_v3: 27 min ago, has metrics.json
  - verb_subcat_supply_through_reader_v1: 51 min ago, has metrics.json
  - exp_tense_preserving_parse_inheritance_v1: 58 min ago, has metrics.json
