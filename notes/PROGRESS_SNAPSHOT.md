...
generated: 2026-08-30T16:46:28Z  |  HEAD: b81e581b1
...
Heartbeats (data/heartbeats/*.timestamp):
  - exp_dev: 2503 min ago <-- STALE
  - orchestrator: 48569 min ago <-- STALE
  - research: 125 min ago <-- STALE
  - skunkworks: 51241 min ago <-- STALE
  - testbed: 87815 min ago <-- STALE
data/ directories touched in the last 180 min:
  ...
  - exp_patient_tendency_generalization_udewt_v1: 1 min ago, has metrics.json
  - exp_coref_participant_generalization_v1: 1 min ago, has metrics.json
  - exp_mcguffey_migrate_cue_competition_v1: 2 min ago, has metrics.json
  - substrate_director_kb_v1.staging.30456: 4 min ago, NO metrics.json yet (likely in-flight)
  - .metrics_sync: 12 min ago, NO metrics.json yet (likely in-flight)
  - exp_mcguffey_migrate_noncanon_by_type_v1: 47 min ago, has metrics.json
...
- 12 new commit(s) since last snapshot (HEAD 9cd539fba -> b81e581b1)
- data/ directory count: 8639 -> 8651 (+12)
