...
generated: 2026-08-31T19:59:41Z  |  HEAD: 4ce9a9be1
...
Heartbeats (data/heartbeats/*.timestamp):
  - exp_dev: 4137 min ago <-- STALE
  - orchestrator: 50202 min ago <-- STALE
  - research: 300 min ago <-- STALE
  - skunkworks: 52874 min ago <-- STALE
  - testbed: 89448 min ago <-- STALE
data/ directories touched in the last 180 min:
  ...
  - substrate_director_kb_v1.staging.24608: 17 min ago, NO metrics.json yet (likely in-flight)
  - exp_learner_growth_mcscript_v1: 44 min ago, has metrics.json
  - exp_learner_growth_multiseed_v1: 62 min ago, has metrics.json
  - exp_learner_growth_own_parser_v1: 92 min ago, has metrics.json
...
- 5 new commit(s) since last snapshot (HEAD 1ecfa55eb -> 4ce9a9be1)
- data/ directory count: 8738 -> 8739 (+1)
