...
generated: 2026-09-05T12:50:02Z  |  HEAD: 507db9858
...
Heartbeats (data/heartbeats/*.timestamp):
  - exp_dev: 10907 min ago <-- STALE
  - orchestrator: 56973 min ago <-- STALE
  - research: 795 min ago <-- STALE
  - skunkworks: 59644 min ago <-- STALE
  - testbed: 96219 min ago <-- STALE
data/ directories touched in the last 180 min:
  ...
  - exp_arc_parser_posfeat_e2e_robust_v1: 1 min ago, NO metrics.json yet (likely in-flight)
  - exp_knowledge_factory_consumer_growth_v1: 2 min ago, NO metrics.json yet (likely in-flight)
  - hook_state: 2 min ago, NO metrics.json yet (likely in-flight)
  - exp_commonnoun_entity_world_model_v1: 16 min ago, has metrics.json
  - .metrics_sync: 16 min ago, NO metrics.json yet (likely in-flight)
  - durability_reports: 99 min ago, NO metrics.json yet (likely in-flight)
...
- 13 new commit(s) since last snapshot (HEAD b8649fdab -> 507db9858)
- data/ directory count: 9135 -> 9146 (+11)
