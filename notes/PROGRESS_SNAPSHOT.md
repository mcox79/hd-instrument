...
generated: 2026-09-05T13:27:50Z  |  HEAD: b597c7ef3
...
Heartbeats (data/heartbeats/*.timestamp):
  - exp_dev: 10945 min ago <-- STALE
  - orchestrator: 57011 min ago <-- STALE
  - research: 833 min ago <-- STALE
  - skunkworks: 59682 min ago <-- STALE
  - testbed: 96256 min ago <-- STALE
data/ directories touched in the last 180 min:
  ...
  - exp_reader_sitmodel_cache_v1: 0 min ago, NO metrics.json yet (likely in-flight)
  - hook_state: 2 min ago, NO metrics.json yet (likely in-flight)
  - exp_causal_bridge_plausibility_beats_locality_v1: 11 min ago, has metrics.json
  - .metrics_sync: 14 min ago, NO metrics.json yet (likely in-flight)
  - exp_causal_selection_instrument_diagnostic_v1: 21 min ago, has metrics.json
  - exp_arc_parser_posfeat_attribution_v1: 28 min ago, NO metrics.json yet (likely in-flight)
...
- 5 new commit(s) since last snapshot (HEAD 507db9858 -> b597c7ef3)
- data/ directory count: 9146 -> 9151 (+5)
