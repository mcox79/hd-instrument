...
generated: 2026-09-03T16:42:51Z  |  HEAD: e65664b34
...
Heartbeats (data/heartbeats/*.timestamp):
  - exp_dev: 8260 min ago <-- STALE
  - orchestrator: 54326 min ago <-- STALE
  - research: 1067 min ago <-- STALE
  - skunkworks: 56997 min ago <-- STALE
  - testbed: 93571 min ago <-- STALE
data/ directories touched in the last 180 min:
  ...
  - exp_whodidwhat_composed_pipeline_v1: 6 min ago, has metrics.json
  - .metrics_sync: 8 min ago, NO metrics.json yet (likely in-flight)
  - exp_whodidwhat_fillergap_fix_v1: 20 min ago, has metrics.json
  - frontend_assets: 20 min ago, NO metrics.json yet (likely in-flight)
  - exp_whodidwhat_noncanonical_upstream_v1: 31 min ago, has metrics.json
  - exp_sg_lite_brain_gap_attribution_v1: 31 min ago, has metrics.json
...
- 6 new commit(s) since last snapshot (HEAD b6031689b -> e65664b34)
- data/ directory count: 8946 -> 8948 (+2)
