...
generated: 2026-09-05T03:24:00Z  |  HEAD: b8649fdab
...
Heartbeats (data/heartbeats/*.timestamp):
  - exp_dev: 10341 min ago <-- STALE
  - orchestrator: 56407 min ago <-- STALE
  - research: 229 min ago <-- STALE
  - skunkworks: 59078 min ago <-- STALE
  - testbed: 95652 min ago <-- STALE
data/ directories touched in the last 180 min:
  ...
  - exp_knowledge_factory_targeted_acq_v1: 1 min ago, NO metrics.json yet (likely in-flight)
  - exp_affect_reroute_speedup_v2: 1 min ago, NO metrics.json yet (likely in-flight)
  - hook_state: 2 min ago, NO metrics.json yet (likely in-flight)
  - .metrics_sync: 10 min ago, NO metrics.json yet (likely in-flight)
  - exp_affect_reroute_speedup_v1: 48 min ago, NO metrics.json yet (likely in-flight)
  - exp_affect_reroute_byteident_v1: 52 min ago, NO metrics.json yet (likely in-flight)
