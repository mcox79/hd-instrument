...
generated: 2026-09-01T17:55:07Z  |  HEAD: d73d6107d
...
Heartbeats (data/heartbeats/*.timestamp):
  - exp_dev: 5452 min ago <-- STALE
  - orchestrator: 51518 min ago <-- STALE
  - research: 256 min ago <-- STALE
  - skunkworks: 54190 min ago <-- STALE
  - testbed: 90764 min ago <-- STALE
data/ directories touched in the last 180 min:
  ...
  - exp_generative_role_binding_v1: 11 min ago, has metrics.json
  - exp_grounded_semantic_graph_ladder_wsd_v1: 73 min ago, NO metrics.json yet (likely in-flight)
  - exp_grounded_semantic_graph_ladder_wsd_v1_smoke: 85 min ago, NO metrics.json yet (likely in-flight)
  - exp_learned_cue_integrator_v1: 93 min ago, has metrics.json
...
- 4 new commit(s) since last snapshot (HEAD 091214382 -> d73d6107d)
- data/ directory count: 8788 -> 8792 (+4)
