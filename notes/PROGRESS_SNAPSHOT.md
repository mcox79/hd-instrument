...
generated: 2026-09-09T01:35:29Z  |  HEAD: afe3cd9ba
...
Heartbeats (data/heartbeats/*.timestamp):
  - exp_dev: 15992 min ago <-- STALE
  - orchestrator: 62058 min ago <-- STALE
  - research: 16 min ago
  - skunkworks: 64730 min ago <-- STALE
  - testbed: 101304 min ago <-- STALE
data/ directories touched in the last 180 min:
  ...
  - exp_multistep_pairwise_discrimination_v1: 3 min ago, has metrics.json
  - exp_genworldmodel_cloze_forward_v1: 5 min ago, has metrics.json
  - exp_genworldmodel_online_forward_model_v1: 11 min ago, has metrics.json
  - exp_causal_antecedent_solution_v6_bf_full: 14 min ago, NO metrics.json yet (likely in-flight)
