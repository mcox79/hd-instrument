...
generated: 2026-09-13T16:28:03Z  |  HEAD: e2cacd4a0
...
Heartbeats (data/heartbeats/*.timestamp):
  - exp_dev: 22645 min ago <-- STALE
  - orchestrator: 68711 min ago <-- STALE
  - research: 2 min ago
  - skunkworks: 71382 min ago <-- STALE
  - testbed: 107957 min ago <-- STALE
data/ directories touched in the last 180 min:
  ...
  - exp_role_slot_occupancy_oracle_v1: 1 min ago, has metrics.json
  - hook_state: 2 min ago, NO metrics.json yet (likely in-flight)
  - exp_structured_matcher_event_goal_v1: 2 min ago, has metrics.json
  - exp_joint_temporal_realreasoner_v1: 3 min ago, has metrics.json
  - exp_joint_temporal_survival_v1: 3 min ago, has metrics.json
  - exp_temporal_reason_integrated_v1: 3 min ago, has metrics.json
