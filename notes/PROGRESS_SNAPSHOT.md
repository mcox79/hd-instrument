...
generated: 2026-09-06T22:51:41Z  |  HEAD: bea69de26
...
Heartbeats (data/heartbeats/*.timestamp):
  - exp_dev: 12949 min ago <-- STALE
  - orchestrator: 59014 min ago <-- STALE
  - research: 1230 min ago <-- STALE
  - skunkworks: 61686 min ago <-- STALE
  - testbed: 98260 min ago <-- STALE
data/ directories touched in the last 180 min:
  ...
  - frontend_assets: 77 min ago, NO metrics.json yet (likely in-flight)
  - exp_occ_appraisal_emotion_v1: 77 min ago, has metrics.json
  - exp_occ_social_agency_v1: 78 min ago, has metrics.json
  - exp_spatial_position_gold_v1: 88 min ago, has metrics.json
  - exp_temporal_reason_duration_v1: 89 min ago, has metrics.json
