...
generated: 2026-09-05T16:14:37Z  |  HEAD: fcdb0a070
...
Heartbeats (data/heartbeats/*.timestamp):
  - exp_dev: 11111 min ago <-- STALE
  - orchestrator: 57177 min ago <-- STALE
  - research: 999 min ago <-- STALE
  - skunkworks: 59849 min ago <-- STALE
  - testbed: 96423 min ago <-- STALE
data/ directories touched in the last 180 min:
  ...
  - exp_causal_upstream_fixes_v1: 2 min ago, has metrics.json
  - hook_state: 2 min ago, NO metrics.json yet (likely in-flight)
  - exp_knowledge_factory_meaning_store_v1: 4 min ago, NO metrics.json yet (likely in-flight)
  - exp_reader_sitmodel_cache_v1: 5 min ago, NO metrics.json yet (likely in-flight)
  - exp_entitykb_resolver_v2: 6 min ago, NO metrics.json yet (likely in-flight)
...
- 12 new commit(s) since last snapshot (HEAD b597c7ef3 -> fcdb0a070)
- data/ directory count: 9151 -> 9164 (+13)
