...
generated: 2026-09-16T23:45:02Z  |  HEAD: 6db012348
...
Heartbeats (data/heartbeats/*.timestamp):
  - exp_dev: 27402 min ago <-- STALE
  - orchestrator: 73468 min ago <-- STALE
  - research: 547 min ago <-- STALE
  - skunkworks: 76139 min ago <-- STALE
  - testbed: 112714 min ago <-- STALE
data/ directories touched in the last 180 min:
  ...
  - exp_causal_sign_integrated_v1: 1 min ago, has metrics.json
  - .metrics_sync: 9 min ago, NO metrics.json yet (likely in-flight)
  - hook_state: 16 min ago, NO metrics.json yet (likely in-flight)
  - exp_structured_matcher_event_goal_v1: 17 min ago, has metrics.json
  - exp_joint_temporal_realreasoner_v1: 21 min ago, has metrics.json
