...
generated: 2026-08-28T21:30:05Z  |  HEAD: 7228d4d7d
...
Heartbeats (data/heartbeats/*.timestamp):
  - exp_dev: 37644 min ago <-- STALE
  - orchestrator: 45973 min ago <-- STALE
  - research: 37 min ago
  - skunkworks: 48645 min ago <-- STALE
  - testbed: 85219 min ago <-- STALE
data/ directories touched in the last 180 min:
  ...
  - exp_multiproto_sense_learner_v1: 0 min ago, has metrics.json
  - hook_state: 2 min ago, NO metrics.json yet (likely in-flight)
  - .metrics_sync: 16 min ago, NO metrics.json yet (likely in-flight)
  - exp_semantic_control_intrinsic_demand_v1: 18 min ago, has metrics.json
  - exp_location_register_serves_tom_v1: 33 min ago, has metrics.json
  - exp_location_register_where_is_x_v1: 34 min ago, has metrics.json
...
- 4 new commit(s) since last snapshot (HEAD 0a4a3a6a2 -> 7228d4d7d)
- data/ directory count: 8511 -> 8513 (+2)
