...
generated: 2026-09-01T21:00:57Z  |  HEAD: 2a3fd8f8d
...
Heartbeats (data/heartbeats/*.timestamp):
  - exp_dev: 5638 min ago <-- STALE
  - orchestrator: 51704 min ago <-- STALE
  - research: 442 min ago <-- STALE
  - skunkworks: 54375 min ago <-- STALE
  - testbed: 90949 min ago <-- STALE
data/ directories touched in the last 180 min:
  ...
  - exp_event_mention_resolver_v1: 8 min ago, has metrics.json
  - exp_domain_matched_fhrr_demo_v1: 63 min ago, has metrics.json
  - syntagnet: 69 min ago, NO metrics.json yet (likely in-flight)
  - exp_wall_corpus_axis_v1: 70 min ago, has metrics.json
  - exp_order_wall_dissection_v1: 98 min ago, has metrics.json
...
- 10 new commit(s) since last snapshot (HEAD d73d6107d -> 2a3fd8f8d)
- data/ directory count: 8792 -> 8811 (+19)
