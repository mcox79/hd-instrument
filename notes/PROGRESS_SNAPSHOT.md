...
generated: 2026-08-29T16:01:04Z  |  HEAD: ae33e5a63
...
Heartbeats (data/heartbeats/*.timestamp):
  - exp_dev: 1018 min ago <-- STALE
  - orchestrator: 47084 min ago <-- STALE
  - research: 919 min ago <-- STALE
  - skunkworks: 49756 min ago <-- STALE
  - testbed: 86330 min ago <-- STALE
data/ directories touched in the last 180 min:
  ...
  - exp_shared_predarg_frontend_v2_selftest: 0 min ago, has metrics.json
  - hook_state: 2 min ago, NO metrics.json yet (likely in-flight)
  - .metrics_sync: 7 min ago, NO metrics.json yet (likely in-flight)
  - exp_shared_predarg_frontend_v3_topdown_richrep: 84 min ago, has metrics.json
  - exp_shared_predarg_frontend_v3_topdown_richrep_smoke: 98 min ago, has metrics.json
  - exp_shared_predarg_frontend_v3_topdown_selftest: 100 min ago, has metrics.json
...
- 7 new commit(s) since last snapshot (HEAD f35b6e650 -> ae33e5a63)
- data/ directory count: 8577 -> 8580 (+3)
