...
generated: 2026-09-01T00:03:34Z  |  HEAD: 04139c835
...
Heartbeats (data/heartbeats/*.timestamp):
  - exp_dev: 4380 min ago <-- STALE
  - orchestrator: 50446 min ago <-- STALE
  - research: 153 min ago <-- STALE
  - skunkworks: 53118 min ago <-- STALE
  - testbed: 89692 min ago <-- STALE
data/ directories touched in the last 180 min:
  ...
  - substrate_director_kb_v1.staging.5344: 9 min ago, NO metrics.json yet (likely in-flight)
  - forward_prediction_parse_disagreement_flag_v1: 11 min ago, has metrics.json
  - exp_tiered_bound_event_token_coref_v1: 20 min ago, has metrics.json
  - forward_prediction_confusability_flag_v1: 23 min ago, has metrics.json
...
- 2 new commit(s) since last snapshot (HEAD 5a183ec74 -> 04139c835)
- data/ directory count: 8756 -> 8757 (+1)
