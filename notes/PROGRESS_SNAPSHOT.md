...
generated: 2026-08-30T03:32:01Z  |  HEAD: f14567bf1
...
Heartbeats (data/heartbeats/*.timestamp):
  - exp_dev: 1709 min ago <-- STALE
  - orchestrator: 47775 min ago <-- STALE
  - research: 54 min ago
  - skunkworks: 50446 min ago <-- STALE
  - testbed: 87020 min ago <-- STALE
data/ directories touched in the last 180 min:
  ...
  - exp_state_register_serves_live_coref_v1: 13 min ago, has metrics.json
  - hook_state: 16 min ago, NO metrics.json yet (likely in-flight)
  - exp_discfact_realtext_factpresent_v1: 17 min ago, has metrics.json
  - .metrics_sync: 17 min ago, NO metrics.json yet (likely in-flight)
  - exp_state_register_serves_coref_v1: 19 min ago, has metrics.json
  - exp_state_register_semantic_v1: 19 min ago, has metrics.json
...
- 3 new commit(s) since last snapshot (HEAD e2eab5b97 -> f14567bf1)
