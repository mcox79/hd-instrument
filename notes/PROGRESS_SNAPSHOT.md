...
generated: 2026-08-29T22:15:48Z  |  HEAD: 397b1c3d6
...
Heartbeats (data/heartbeats/*.timestamp):
  - exp_dev: 1393 min ago <-- STALE
  - orchestrator: 47459 min ago <-- STALE
  - research: 45 min ago
...
data/ directories touched in the last 180 min:
  ...
  - exp_causal_force_dynamic_typer_v1: 17 min ago, has metrics.json
  - exp_role_confound_incidence_litbank_v1: 22 min ago, has metrics.json
  - force_dynamics_lexicon_v1: 24 min ago, NO metrics.json yet (likely in-flight)
  - hook_state: 25 min ago, NO metrics.json yet (likely in-flight)
  - exp_role_parse_accuracy_probe_v1: 26 min ago, has metrics.json
