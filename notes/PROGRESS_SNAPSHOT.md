...
generated: 2026-09-09T11:58:55Z  |  HEAD: 255201498
...
Heartbeats (data/heartbeats/*.timestamp):
  - exp_dev: 16616 min ago <-- STALE
  - orchestrator: 62682 min ago <-- STALE
  - research: 640 min ago <-- STALE
  - skunkworks: 65353 min ago <-- STALE
  - testbed: 101927 min ago <-- STALE
data/ directories touched in the last 180 min:
  ...
  - durability_reports: 47 min ago, NO metrics.json yet (likely in-flight)
  - snapshots: 48 min ago, NO metrics.json yet (likely in-flight)
