...
generated: 2026-08-29T19:06:03Z  |  HEAD: 36c5e9a11
...
Heartbeats (data/heartbeats/*.timestamp):
  - exp_dev: 1203 min ago <-- STALE
  - orchestrator: 47269 min ago <-- STALE
  - research: 1104 min ago <-- STALE
  - skunkworks: 49940 min ago <-- STALE
  - testbed: 86515 min ago <-- STALE
data/ directories touched in the last 180 min:
  ...
  - exp_discfact_store_bridging_graded_v1: 0 min ago, has metrics.json
  - hook_state: 3 min ago, NO metrics.json yet (likely in-flight)
  - exp_temporal_order_extraction_recall_v1: 5 min ago, has metrics.json
  - .metrics_sync: 11 min ago, NO metrics.json yet (likely in-flight)
  - substrate_director_kb_v1.staging.40540: 18 min ago, NO metrics.json yet (likely in-flight)
  - exp_temporal_order_serves_causal_v1: 134 min ago, has metrics.json
...
- 8 new commit(s) since last snapshot (HEAD 2adf14c87 -> 36c5e9a11)
- data/ directory count: 8580 -> 8587 (+7)
