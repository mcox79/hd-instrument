...
generated: 2026-09-02T13:48:20Z  |  HEAD: e42850af7
...
Heartbeats (data/heartbeats/*.timestamp):
  - exp_dev: 6645 min ago <-- STALE
  - orchestrator: 52711 min ago <-- STALE
  - research: 816 min ago <-- STALE
  - skunkworks: 55383 min ago <-- STALE
  - testbed: 91957 min ago <-- STALE
data/ directories touched in the last 180 min:
  ...
  - exp_world_state_bridging_powered_v1: 34 min ago, has metrics.json
  - exp_arceager_calibrated_abstain_v1: 43 min ago, has metrics.json
  - exp_world_state_downstream_v1: 99 min ago, has metrics.json
  - exp_19c_pp_attachment_prototype_v1: 107 min ago, has metrics.json
  - exp_19c_selection_failure_v1: 112 min ago, has metrics.json
