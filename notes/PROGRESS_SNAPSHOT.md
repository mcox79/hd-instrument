...
generated: 2026-09-09T14:17:23Z  |  HEAD: d42d95338
...
Heartbeats (data/heartbeats/*.timestamp):
  - exp_dev: 16754 min ago <-- STALE
  - orchestrator: 62820 min ago <-- STALE
  - research: 18 min ago
  - skunkworks: 65492 min ago <-- STALE
  - testbed: 102066 min ago <-- STALE
data/ directories touched in the last 180 min:
  ...
  - exp_causal_testimony_eval_v1: 0 min ago, has metrics.json
  - .metrics_sync: 1 min ago, NO metrics.json yet (likely in-flight)
  - exp_causal_testimony_mine_v1: 4 min ago, has metrics.json
  - exp_causal_testimony_baseline_v1: 14 min ago, has metrics.json
  - exp_namebridge_discourse_type_v1: 33 min ago, NO metrics.json yet (likely in-flight)
...
- 2 new commit(s) since last snapshot (HEAD b3abd637f -> d42d95338)
- data/ directory count: 9620 -> 9621 (+1)
