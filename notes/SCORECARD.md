...
Last full check: 2026-09-13T09:32:27.935274+00:00 (16 on record). Generated 2026-09-13T10:59:47+00:00.
...
| Who was affected by what happened | People and things | right 38 in 100 | clearly better than the simple rule (32 in 100) | up 0.008 since the previous check | brain model; some details still open |
...
| What something is or is like ('the sky is blue') | Actions and roles | right 80 in 100 | clearly better than the simple rule (56 in 100) | up 0.148 since the previous check | brain model; some details still open |
| Who did the action in a sentence | Actions and roles | right 84 in 100 | not better than the simple rule (86 in 100) yet | up 0.015 since the previous check | brain model; one part is a stand-in we are replacing |
| Who or what the action was done to | Actions and roles | right 81 in 100 | clearly better than the simple rule (74 in 100) | up 0.081 since the previous check | brain model; one part is a stand-in we are replacing |
