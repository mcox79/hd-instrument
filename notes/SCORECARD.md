...
Last full check: 2026-09-13T12:05:35.777067+00:00 (18 on record). Generated 2026-09-13T12:39:35+00:00.
...
| Who was affected by what happened | People and things | right 38 in 100 | clearly better than the simple rule (32 in 100) | unchanged since the previous check | brain model; some details still open |
...
| What something is or is like ('the sky is blue') | Actions and roles | right 80 in 100 | clearly better than the simple rule (56 in 100) | unchanged since the previous check | brain model; some details still open |
| Who did the action in a sentence | Actions and roles | right 84 in 100 | not better than the simple rule (86 in 100) yet | unchanged since the previous check | brain model; one part is a stand-in we are replacing |
| Who or what the action was done to | Actions and roles | right 81 in 100 | clearly better than the simple rule (74 in 100) | unchanged since the previous check | brain model; one part is a stand-in we are replacing |
...
| Picking out place information correctly | Time and place | right 58 in 100 | clearly better than the simple rule (52 in 100) | DOWN 0.006 since the previous check | brain model; some details still open |
| Where things are relative to each other | Time and place | right 24 in 100 | clearly better than the simple rule (20 in 100) | DOWN 0.039 since the previous check | brain model; some details still open |
| Whether a state still holds at a later point | Time and place | right 38 in 100 | clearly better than the simple rule (11 in 100) | DOWN 0.030 since the previous check | brain model; some details still open |
...
| Working out what a new word means from reading | Learning from reading | right meaning ranked near the top 38 in 100 | clearly better than the simple rule (16 in 100) | DOWN 0.007 since the previous check | brain model; some details still open |
