...
Last full check: 2026-09-12T17:15:08.947214+00:00 (7 on record). Generated 2026-09-13T01:41:54+00:00.
...
| Who was affected by what happened | People and things | right 39 in 100 | clearly better than the simple rule (34 in 100) | DOWN 0.009 since the previous check | brain model; some details still open |
...
| What something is or is like ('the sky is blue') | Actions and roles | right 83 in 100 | clearly better than the simple rule (57 in 100) | up 0.013 since the previous check | brain model; some details still open |
...
| Who or what the action was done to | Actions and roles | right 82 in 100 | clearly better than the simple rule (75 in 100) | up 0.012 since the previous check | brain model; one part is a stand-in we are replacing |
...
| Knowing when to hold back on 'who was acted on' | Knowing its limits | right 96 in 100 | clearly better than the simple rule (87 in 100) | up 0.010 since the previous check | brain model; one part is a stand-in we are replacing |
...
Brain-faithfulness of the 86 building blocks: 7 copy the brain's math exactly, 73 are brain models with open details, 6 are stand-ins being replaced (arc_labeler, arc_parser, arceager_parser, commonnoun_binder, parse_confidence, pos_tagger).
