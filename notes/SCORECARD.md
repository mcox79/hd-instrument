...
Last full check: 2026-09-13T07:11:50.287579+00:00 (14 on record). Generated 2026-09-13T07:39:08+00:00.
...
| Who was affected by what happened | People and things | right 38 in 100 | clearly better than the simple rule (32 in 100) | up 0.005 since the previous check | brain model; some details still open |
...
| What something is or is like ('the sky is blue') | Actions and roles | right 80 in 100 | clearly better than the simple rule (56 in 100) | up 0.140 since the previous check | brain model; some details still open |
...
| Who or what the action was done to | Actions and roles | right 81 in 100 | clearly better than the simple rule (74 in 100) | up 0.080 since the previous check | brain model; one part is a stand-in we are replacing |
