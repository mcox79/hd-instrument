...
Last full check: 2026-09-12T16:31:14.699252+00:00 (6 on record). Generated 2026-09-12T17:13:56+00:00.
...
| Who was affected by what happened | People and things | right 40 in 100 | clearly better than the simple rule (34 in 100) | up 0.010 since the previous check | brain model; some details still open |
...
| What something is or is like ('the sky is blue') | Actions and roles | right 81 in 100 | clearly better than the simple rule (57 in 100) | DOWN 0.019 since the previous check | brain model; some details still open |
...
| Who or what the action was done to | Actions and roles | right 81 in 100 | clearly better than the simple rule (75 in 100) | DOWN 0.022 since the previous check | brain model; one part is a stand-in we are replacing |
...
| Knowing when to hold back on 'who was acted on' | Knowing its limits | right 95 in 100 | clearly better than the simple rule (85 in 100) | DOWN 0.016 since the previous check | brain model; one part is a stand-in we are replacing |
