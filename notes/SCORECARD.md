...
Last full check: 2026-09-13T07:48:32.288409+00:00 (15 on record). Generated 2026-09-13T08:19:00+00:00.
...
| Who was affected by what happened | People and things | right 37 in 100 | not better than the simple rule (40 in 100) yet | DOWN 0.008 since the previous check | brain model; some details still open |
...
| What something is or is like ('the sky is blue') | Actions and roles | right 65 in 100 | clearly better than the simple rule (56 in 100) | DOWN 0.146 since the previous check | brain model; some details still open |
| Who did the action in a sentence | Actions and roles | right 82 in 100 | not better than the simple rule (84 in 100) yet | unchanged since the previous check | brain model; one part is a stand-in we are replacing |
| Who or what the action was done to | Actions and roles | right 73 in 100 | clearly better than the simple rule (64 in 100) | DOWN 0.081 since the previous check | brain model; one part is a stand-in we are replacing |
