...
> 🔎 **AND I WAS CARRYING "5 of 5 reproduced" FROM BEFORE A COMPACTION.** *Reviewed != verified;
> the ledger outranks recollection.* **Re-running all five: `harness_cannot_recompute` PASS,
> `stored_terms_are_stems` `0/141 = 0.00%` (exact match to its claim); three slow ones in flight.**
>
