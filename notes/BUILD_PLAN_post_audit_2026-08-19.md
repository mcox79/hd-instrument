...
> 🔎 **AND I WAS CARRYING "5 of 5 reproduced" FROM BEFORE A COMPACTION.** *Reviewed != verified; the ledger outranks recollection.* **RE-RAN ALL FIVE: it is `3` of `5`.** ✅ `harness_cannot_recompute` PASS; `stored_terms_are_stems` `0/141` exact; `eval_bank_too_small` `166`/`124` match.
