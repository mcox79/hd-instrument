...
> **Addressed-storage held-out identity-recovery hit@1 `0.1399` `[0.1310,0.1494]` against a first-order co-occurrence COUNTING floor of `0.3242` `[0.3115,0.3366]` on the IDENTICAL population -- `-0.1843`, CI EXCLUDES ZERO. It is CI-separated BELOW the floor.**
> 🔑 **AND THE FAILURE MODE IS THE ONE THIS PROJECT KEEPS PAYING FOR: its exact-key score is `0.9954` and collapses to `0.1399` held-out. THE ISOLATION WIN WAS MEMORISATION.**
