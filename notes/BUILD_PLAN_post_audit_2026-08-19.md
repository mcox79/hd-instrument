...
> # ⏸️ **PAUSED 2026-09-12 ~13:45 local by the owner for migration to the desktop — transfer set `C:\AI\hd-instrument_desktop_2026-09-12\` (see its MIGRATION_README.md); autoloop disarmed; resume from `notes/STATUS.md`. Top unblocked item when resuming: the heads rung — the attachment LEARNER is the bottleneck (pri-11 + form-class + prosodic-boundary constraints + the graded category posterior).**
