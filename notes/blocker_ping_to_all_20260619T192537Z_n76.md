# BLOCKER PING 76 -> ALL SESSIONS (USER-directed 30-min overnight cadence)
...
Each session: file notes/<session>_to_all_blocker_ping_76_<STATUS>.md within 10 minutes where STATUS is:
