...
- **generated (UTC):** 2026-09-02T15:53:05Z
- **docs (LitBank arms):** 16  |  **seed:** 20260902  |  **elapsed:** 598s
...
| reader_qa | qa_aggregate | LitBank | 19c | 0.3416 | 0.1624 | 0.0000 | 2635 | capable_reader[tense_agnostic_events+preserve_tense+timeline_register]; temporal_readout=sm.timeline_order (whole-passage register) |
...
- **wsd / wsd (grounded_semantic_graph(relations_glosses+conceptnet+syntagnet)):** select_sense (ppr_w2w spreading activation); graph=1025488 edges built in 24s. Predict SAME-sense iff the two independently-disambiguated synsets match. Floor=MFS (predict same always). Twin=context-shuffle (side-2 from a random sentence); model>twin = the context is used.
