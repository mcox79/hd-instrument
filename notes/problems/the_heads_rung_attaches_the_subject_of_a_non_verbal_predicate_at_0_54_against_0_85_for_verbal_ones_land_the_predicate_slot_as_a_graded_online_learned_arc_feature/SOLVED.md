...
INTEGRATED_BY_STRATEGY 2026-09-15 10:24 local -- DONE by strategy after first-hand reverify: the diff applied (attachment_arm: the predicate-slot occupancy as a graded arc feature with a validity ACCRUED ONLINE from 4,560 predications, the predicate-arrival reanalysis, hyphen crossing on the subject side, the None-head guard; build_attachment_validities: the joint-teaching path; the clausal-subject refusal OFF as measured; five switches default ON). Witnesses green: cell 19/19, attachment_arm 17/17, fastpath, coordination 6/6, cache_shared 4/4, copular 6/6, state_qa 9/9, double_parse 14/14, coarse_role 37/37, predicate_recall 30/30, role_route 4/4. FULL BOARD A/B (pri116a -> pri117a): six rows byte-identical, who_did_what_patient 0.8151 -> 0.8143 (-1 item of 1255: the clausal-subject case 'Call a vet would be a good idea', deferred to the csubj lead), AGG 0.6205 -> 0.6204. Landed per the 09-12 rule (a BF upstream stays on; the one item is a named consumer repair). The owner's prototype (0.6509, hand-set) reproduced and exceeded by the learned form (0.6568 at the plateau; 0.6509 with the hyphen fix that buys the patient item back on the board arm).
