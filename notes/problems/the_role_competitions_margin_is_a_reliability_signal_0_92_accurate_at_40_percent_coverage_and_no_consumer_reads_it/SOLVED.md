...
INTEGRATED_BY_STRATEGY 2026-09-14 15:53 local -- verdict: the brief's own hypothesis (the role margin as a reliability signal consumed downstream) is REFUTED at its primary consumer with mechanism (correlated errors 0.7519 both-wrong cell; 25.9% flat-indicator decisions; a perfect gate loses -0.0050) and power-bound at the agent read (+0.0077 over the positional floor, gate-vs-twin n.s. on 62 items); WHAT LANDED is the landed!=live repair the probe found: the affected-entity resolver reads the role competition's LABEL (HDLAB_AER_ROLE_CUE default 'label', commit a38f0ecd1) -- CI-separated on three independent measurements (harness dev +0.0352, harness test +0.0352, live reader 40 docs n=275 +0.0509 CI[+0.0036,+0.0982]); the graded forms are opt-in and separated on none. Board-invisible by construction (7/7 identical with ppc); gauged by the cell's --wire-price arm. Witness green (A5_full 0.4721; W4 deployment +0.0358 sep). Status for the record: SOLVED as a wire, REFUTED as a margin hypothesis -- both with numbers. Residue routed: pri 111 (the false passive licences), pri 103 (the posterior's core-arc quality).
