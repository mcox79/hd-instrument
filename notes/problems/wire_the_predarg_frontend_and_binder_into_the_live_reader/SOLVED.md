...
reverify: ".venv/Scripts/python.exe verification/test_wire_predarg_binder_live_reader.py (10/10) AND .../test_wire_predarg_binder_litbank_whodidwhat.py (6/6, LitBank who-did-what) AND .../test_wire_predarg_binder_live_reader_integration.py (1/1, the diff demonstrated IN the live situation_reader.read() path, no regression)"
---
...
-- case-independent, and the faithful form in the reader's context. This closes the "proven in a mirror, not the
live reader" gap: the proposed diff runs, composes, and does not regress, in the real reader class.
