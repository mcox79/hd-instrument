...
reverify: cd d:/AI/hd-instrument && .venv/Scripts/python.exe experiments/goal_bearing_eval_v2_finalize.py  # VERIFIED SAFE 2026-08-23: this writes only the bank + baselines it owns, and regeneration is BYTE-IDENTICAL (sha256 unchanged across two runs), so it does not clobber a landed cell record. Numbers reproduce exactly: 166 items, 124 scorable, majority floor 0.6048387, 49 met / 75 unmet.
---
