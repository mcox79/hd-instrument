...
INTEGRATED_BY_STRATEGY 2026-09-13 12:42 local -- owner-DONE 12:26; reverified first-hand: witness 6/6; diff landed VERBATIM in hdlab/attachment_arm.py (coord_sites / parallel_class / parallel-head coord_arcs / parallelism_boost; commit 34e9f51d6) + the one-line teacher boost in tools/build_attachment_validities.py; asset rebuilt with the signal (attachment_validities_coord_v1.json -> live attachment_validities_v1.json; previous kept at data/hook_state/attachment_validities_v1_precoord.json): UD-EWT test 700 gold cats, in-order decode conj 0.305 -> 0.382, root 0.711 -> 0.721, nmod 0.406 -> 0.427, advcl 0.306 -> 0.321, xcomp 0.693 -> 0.715; nsubj 0.770 -> 0.763, obl 0.457 -> 0.432, ccomp 0.638 -> 0.603 (the named give-backs, kept); UAS 0.6142 -> 0.6125 (noise); search decode conj 0.391, UAS 0.6092. Arm witnesses 17/17 + fast path. NOT wired: slot-sharing (refuted). Follow-ons filed: FAR coordination (9+ tokens) as a meaning-channel problem; coref / who-did-what re-check on the full board (running).
