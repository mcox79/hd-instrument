...
2. **The real 19c lever is SELECTION, and it is a MEANING-STORE register problem** -- route it to the existing
   ...
   Feed it the parser's `_pp_args_for_verb` candidate set; the pick is semantic, not structural.
