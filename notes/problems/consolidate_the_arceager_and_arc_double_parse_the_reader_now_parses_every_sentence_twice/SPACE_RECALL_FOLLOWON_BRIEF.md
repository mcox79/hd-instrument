---
priority:            # strategy assigns on filing (integer, 1=first; cert-enforced unique)
review:
review_text:
---
...
- Do NOT re-run the refuted easy fixes: toggling the noisy-channel gates (+0.000 recall) or naive fire-on-any-goal-role broadening (−0.074) — both are located negatives on disk.
