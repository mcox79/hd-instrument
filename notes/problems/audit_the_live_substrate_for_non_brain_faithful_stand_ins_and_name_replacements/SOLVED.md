...
files_changed: "verification/test_audit_live_standins.py (30/30 witness); notes/problems/audit_the_live_substrate_for_non_brain_faithful_stand_ins_and_name_replacements/CATALOG.md (the deliverable); notes/problems/audit_the_live_substrate_for_non_brain_faithful_stand_ins_and_name_replacements/SOLVED.md. NO hdlab/ writes (Q111 -- strategy lands any code change; this is a MAP + proposed fixes)."
