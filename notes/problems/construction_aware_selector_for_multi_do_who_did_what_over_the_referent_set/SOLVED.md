...
reverify: ".venv/Scripts/python.exe verification/test_construction_aware_selector.py   # 10/10 -- selector-level null (n=149) + full-power null (n=669) + premise-refuted + tied-with-brain + parse-is-the-real-lever + register-invariant + end-to-end null + IDEAL-composition indef-pronoun win (CI-sep) + composition ceiling 0.969 + the WHOLE composition proven CI-sep (indef drives, RHR a documented null), all from landed metrics.json (re-runs no cell)"
---
