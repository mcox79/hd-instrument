...
INTEGRATED_BY_STRATEGY 2026-09-13 21:35 local -- DONE by strategy after first-hand reverify (owner 20:05: strategy marks DONE); pri 99 unseen-word patch applied to lexical_categories; both count tables (UPOS + Penn) rebuilt with the module and LIVE; who-did-what witness null recalibrated (p95 of 200 draws). Wave board (97+98+99+100+103 together, assets live): AGG 0.6352 -> 0.6369, patient 0.7920 -> 0.8072, every other dimension identical (notes/INTEGRATION_LEDGER.md 21:06). Also corrected in the same commit: the reader's own heads default ('arceager') never flipped with the frontend's -- now one default imported from hdlab.frontend.
