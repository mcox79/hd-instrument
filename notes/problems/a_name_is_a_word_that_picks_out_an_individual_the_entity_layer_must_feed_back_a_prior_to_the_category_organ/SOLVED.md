...
| A2_k1_w5 (kappa 1) | **+0.0107 CI[+0.0044, +0.0176] SEPARATED** | **+0.0040 CI[+0.0020, +0.0063] SEPARATED** | **+0.0008 CI[+0.0005, +0.0012] SEPARATED** |
| **TWIN A -- shuffled chains** | **+0.0016 CI[-0.0031, +0.0063] -- AT THE FLOOR** | -0.0009 n.s. | +0.0002 n.s. |
| **TWIN B -- permuted table** | -0.0053 n.s. | **-0.0209 CI[-0.0280, -0.0151] CI-SEP BELOW THE FLOOR** | **-0.0027 CI[-0.0033, -0.0022] CI-SEP BELOW** |
