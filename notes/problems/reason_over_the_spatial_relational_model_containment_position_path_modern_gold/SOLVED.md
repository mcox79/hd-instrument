...
train): the parse+extractor recovers **containment 0.129 (81/628), position 0.058 (7/120), moves 0.021 (6/291)**, and
**multi-hop containment CHAIN survival is 1/90 = 0.011** (trial 0/33). So end-to-end >1-fact reasoning is essentially
impossible on that prose -- not because the reasoner fails, but because the chains never survive extraction. On
