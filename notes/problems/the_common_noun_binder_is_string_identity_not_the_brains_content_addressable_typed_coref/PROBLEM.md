...
- **MEASURED (on disk):** `commonnoun_binder` 0.4904 < string-identity 0.5412 on the C2 slice (reader CATALOG); `typed_coref` exists + typed common-noun coref has prior honest-floor wins (INTEGRATION_LEDGER / CROSS_SOLUTION map Target 3).
