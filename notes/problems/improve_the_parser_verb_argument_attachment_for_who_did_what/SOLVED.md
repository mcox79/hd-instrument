...
- **The QA instrument asks only agent questions.** 498/1602 patient picks changed with 0.0 aggregate delta was
  not "no effect" -- it was "the events QA has no patient questions." Read the QUESTION builder before believing a
  flat end-to-end number.
