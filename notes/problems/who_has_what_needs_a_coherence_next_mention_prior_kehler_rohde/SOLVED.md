...
## QUESTIONS
One label call (same as the 2026-08-29 solver): I marked this REFUTED (the brief's mechanism is the wrong fix +
a near-duplicate of an owner-DONE negative). A rigorous located negative is a full pass either way; content is
identical if you prefer SOLVED. Otherwise: none.
