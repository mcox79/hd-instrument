...
### 2026-09-05 (CONT-6, LATEST) -- 🎯 **NEW DIRECTION (OWNER): a top-down FULL-SUBSTRATE INTEGRATION PASS + the INTEGRATION LEDGER. Integrated the causal mental-bridge; built the ledger. Committed `8cbb1b0ed` (causal) + `2bcabd223` (ledger), NOTHING pushed.**
