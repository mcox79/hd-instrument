...
### 2026-08-31 (LATEST — WIRING ROUND) -- ⚡ **LANDED `predict_surprisal` into the live reader — the FIRST live node of the prediction-error hierarchy. Burned down ONE of the two queued reader-wires (WIRE-DON'T-ISLAND).**
