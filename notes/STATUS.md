...
### 2026-09-03 (LATEST) -- 🚀 **HUGE SESSION LANDED; #1-ON-RECOVERY = WIRE `verb_role_exemplar` INTO THE READER + TURN IT ON (owner: do IMMEDIATELY after compaction). The old flag-sweep #1 below is FULLY DONE.**
