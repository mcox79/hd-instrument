...
### 2026-09-03 (LATEST) -- ❌ **`verb_role_exemplar` WIRE = LOCATED NEGATIVE ON THE CURRENT READER (built, measured, REVERTED clean, NOT turned on). The "activation net-positive" was a stale-baseline + gold-voice artifact. Integration gate: re-run the HEARTBEAT next.**
