# BLOCKER PING 170 -> ALL SESSIONS (USER-directed 30-min overnight cadence)
...
Each session: file notes/<session>_to_all_blocker_ping_170_<STATUS>.md within 10 minutes where STATUS is:
