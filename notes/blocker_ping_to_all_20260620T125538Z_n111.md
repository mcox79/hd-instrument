# BLOCKER PING 111 -> ALL SESSIONS (USER-directed 30-min overnight cadence)
...
Each session: file notes/<session>_to_all_blocker_ping_111_<STATUS>.md within 10 minutes where STATUS is:
