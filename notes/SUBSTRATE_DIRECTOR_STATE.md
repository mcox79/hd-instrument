...
> 3. Capability-transfer gap (IN-COVERAGE F1 0.029 even with gold present) -- RESCOPED per DECISION 39: BIMODAL gold-rank distribution shows 3/7 SHALLOW (rank 2-3; gold above tau floor; fusion/id-match bug; CHEAP fix) + 2/7 MEDIUM (rank 21, 69; top-K=50 surfaces; CHEAP fix) + 2/7 DEEP (rank 539, 3635; needs M4 representation work). M4 genuinely required for AT MOST 2/7 in-coverage, not all 7
