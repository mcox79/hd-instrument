...
**Last updated:** 2026-05-23 cycle 186 (v166; BATCHED FOUR-verdict cap_map update -- (1) wave14_R_transform_kerdock_v1_multi_N_v2 GPU FULL = R_TRANSFORM_STABLE_IN_N (3/3 alpha cells stable+diverge across N range; R-transform deviation > 0.20 STAYS and does NOT shrink with N; substrate-novel additive-free-prob fingerprint DIMENSION-STABLE; v164a free-cumulant fingerprint row PROMOTED 🟢 -> ✅ on the explicit pre-registered N-scaling promotion criterion satisfied) + (2) wave14_codeword_overlap_kerdock_v2 CPU FULL = KERDOCK_OVERLAPS_NON_GAUSSIAN (6/6 cells KS > 0.10; max_ks=0.259; THIRD independent algebraic-fingerprint axis alongside additive R-transform + multiplicative S-transform; NEW 🟢 evidence-strength row) + (3) wave14_spectral_support_kerdock_v2 CPU FULL = KERDOCK_SPECTRUM_BULK_BOUNDED (3/3 cells substrate spectrum confined within 5% MP bulk edges; max excursion=0.000; substrate-novel signature is MOMENT-BASED ONLY shape-of-bulk NOT outliers; mechanism-narrowing annotation on v164a row + substrate-physics characterization; unlocks Wigner-null follow-up framing) + (4) wave14_kerdock_hessian_tachyon_v2 CPU FULL = KERDOCK_HAS_EXCESS_ZERO_MODES (1/3 cells excess zero modes beyond generic rank-deficiency floor; max_excess=0.500 at alpha=0.50; SURPRISE POSITIVE substrate-novel flat-direction signature from Kerdock 4-coset algebra; NEW 🟢 evidence-strength row); v166 adds ONE ✅ promotion (v164a 🟢 -> ✅) + TWO new 🟢 rows + ONE mechanism-narrowing annotation; substrate-product portfolio at 11 demonstrated capabilities UNCHANGED IN COUNT (v164a promotion is substrate-physics observability row not portfolio capability); "outside AMP universality class" wedge gains FIRST ✅-grade substrate-physics anchor + THIRD independent algebraic-fingerprint axis + mechanism narrowed to bulk-shape; v165 S-transform multiplicative row STAYS at 🟢 -- v166 N-stability promotion is additive-axis ONLY per [[feedback-dont-overextend-theorems]] (each axis carries its own promotion criterion); 4 Research/Exp Dev candidate follow-up experiments noted (Wigner-null moment-by-moment baseline + S-transform multi-N + Hessian broader alpha sweep + codeword-overlap multi-N) but NOT shipped this cycle (parallel exp_dev dispatch handles queue-refill); per [[feedback-pipeline-pacing]] queue-refill responsibility is parallel exp_dev's; verdict_handler does NOT also ship; smoke->FULL broad anchors +4 by v166 batch FULL landings (33 broad / 25 strict); 80th PROT-009 paired commit MILESTONE. Prior: cycle 185 v165 BATCHED S_TRANSFORM_DIVERGE + PARISI_INCONCLUSIVE added 1 evidence-strength row. Cycle 184 v164 BATCHED FREE_CUMULANTS_DIVERGE + GLAUBER_BIMODAL_KERDOCK added 2 evidence-strength rows.
**Cap map version this refers to:** v166
**Substrate-product portfolio:** **11 demonstrated capabilities** (Cap 2 left the v153 list at v160; v161 carries forward unchanged in count) + 3 envelope-characterization rows (v158 Cap 1 Tier-2 Sagawa-Ueda + v158 Cap 3 streaming noise envelope + v161 Cap 5 Online W noise envelope at p_flip<=0.30 CONFIRMED structural boundary) + **5 evidence-strength rows under Substrate-physics characterization** (**v164/v166 additive free-cumulant fingerprint of Kerdock R-transform ✅ PROMOTED v166 on N-stability** -- first ✅-grade substrate-physics observability row for the "outside AMP universality" wedge; v164 Cap 3 Glauber-Hopfield discrete-spin NESS extension 🟢; v165 multiplicative free-convolution (S-transform) fingerprint of Kerdock spectrum 🟢; **v166 codeword-overlap distribution structural fingerprint of Kerdock 🟢** -- third independent algebraic-fingerprint axis; **v166 excess Hessian zero modes from Kerdock 4-coset structure 🟢** -- substrate-novel kernel dimension SURPRISE POSITIVE) + mechanism-narrowing annotation v166 (substrate spectrum bounded within 5% MP bulk edges; signature is moment-based ONLY).
