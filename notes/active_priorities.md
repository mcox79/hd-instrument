...
**Last updated:** 2026-05-23 cycle 185 (v165; BATCHED two-verdict cap_map update -- (A) wave14_S_transform_kerdock_v1 Remote CPU FULL = S_TRANSFORM_DIVERGE (5/5 cells exceed 20% S-transform deviation; max_dev=1.000 at alpha=4.00 S_1; 531.8s elapsed) + (B) wave14_parisi_pq_kerdock_v1 Remote CPU INCONCLUSIVE = PARISI_INCONCLUSIVE (11/12 cells "undetermined" at 24.4s elapsed; "need longer chains or finer T grid"); Verdict A lands the second algebraic-free-prob axis (multiplicative free-convolution via S-transform; complementary to v164a additive free-convolution via free cumulants) on which Kerdock spectrum departs from MP -- "outside AMP universality" wedge now anchored on TWO independent algebraic axes; Verdict B is under-resolution NOT refutation; v165 adds ONE new evidence-strength row "Multiplicative free-convolution (S-transform) fingerprint of Kerdock spectrum" 🟢 paired with v164a additive free-cumulant row; substrate-product portfolio at 11 demonstrated capabilities UNCHANGED IN COUNT; v164a free-cumulant row STAYS at 🟢 (cross-axis corroboration does NOT substitute for explicit N-scaling promotion criterion gated on running wave14_R_transform_kerdock_v1_multi_N GPU job); Parisi v2 filed as DEFERRED GPU re-run candidate (gated on R_transform_multi_N completion); per [[feedback-pipeline-pacing]] GPU has work; remote CPU queue=0 and intentionally NOT auto-refilled per user feedback this cycle ("seems like a mistake" to ship to CPU when GPU is idle/busy -- CPU systematically under-resolves >=5-seed x >=10 cells probes); inefficiency LOCKED -- CPU-vs-GPU venue selection guideline flagged for memory curator next cycle; smoke->FULL broad anchors +1 by S-transform cell-extension; 79th PROT-009 paired commit. Prior: cycle 184 v164 BATCHED FREE_CUMULANTS_DIVERGE + GLAUBER_BIMODAL_KERDOCK added 2 evidence-strength rows.
**Cap map version this refers to:** v165
**Substrate-product portfolio:** **11 demonstrated capabilities** (Cap 2 left the v153 list at v160; v161 carries forward unchanged in count) + 3 envelope-characterization rows (v158 Cap 1 Tier-2 Sagawa-Ueda + v158 Cap 3 streaming noise envelope + v161 Cap 5 Online W noise envelope at p_flip<=0.30 CONFIRMED structural boundary) + **3 evidence-strength rows** (v164 additive free-cumulant fingerprint of Kerdock R-transform 🟢; v164 Cap 3 Glauber-Hopfield discrete-spin NESS extension 🟢; **v165 multiplicative free-convolution (S-transform) fingerprint of Kerdock spectrum 🟢** -- paired with v164a additive axis for two-axis algebraic-free-prob characterization).
