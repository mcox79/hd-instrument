...
| Grammatical-role assignment by cue competition (Bates & MacWhinney Competition Model 1982/1989; MacWhinney 1987) | role(NP) = arg-max over roles of Σ_cues w_cue · cue_strength(NP, role) — word order, case morphology, agreement, animacy; weights learned from cue validity (availability × reliability) | PINNED (cue competition; English word-order dominance) / MODEL (exact combination rule) | TO BUILD: the dependency LABELER is the lossy rung of the affected-entity chain (−0.037 of −0.0705, probe v11 2026-09-12); a solver measured a Competition-Model labeler at 0.640 vs supervised 0.722 (scale_the_reading_learned_arc_scorer line) | `arc_labeler` (NOT_BF) → BF role labeler to build |
