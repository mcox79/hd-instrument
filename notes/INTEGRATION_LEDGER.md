...
| **Precision / reliability** | patient selective@50 0.879→0.975 (+0.0956); obl 0.758→0.892 | parse_confidence organ LANDED; precision_weight_roles default-**OFF** (measured: no consumer defers) | **NO (latent)** | the defer-consumer FILED (p4, in progress) + a modern selective-reliability board arm |
