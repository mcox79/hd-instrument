...
| **Spatial / location** | where_is 0.319→0.468 modern; LIVE read() +0.170; board `location` at-ceiling 1.0 (coarse) | named-ground binding default-ON (kept, board-invisible) | **PARTIAL** | modern where_is board arm + relational reasoning (FILED p6) + Ground-aware attach |
...
### p6 — reason_over_the_spatial_relational_model_containment_position_path_modern_gold  [landing IN-FLIGHT; EXCELLENT; reverified 11/11]
