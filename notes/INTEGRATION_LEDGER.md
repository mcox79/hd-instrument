...
| **Temporal** | board 0.813 (19c); modern = NAMED GAP (Phase-1-gated, non-circular needs world-knowledge) | timeline extraction kept; INFERENCE not built | **NO (as reasoning)** | temporal-reasoning problem FILED (p5) + Phase-1 meaning |
...
### p5 — reason_over_event_time_order_and_duration_on_a_modern_gold  [reverified 18/18; QUEUED behind p6; EXCELLENT]  *(I pre-wired the tense-granularity finding + MC-TACO into this brief; the solver used MC-TACO and DRILLED it — it mismeasures duration.)*
