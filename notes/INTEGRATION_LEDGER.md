...
### p2 — extract_relations_from_prose_whole_subgraph_survival_the_shared_reasoner_bottleneck  [reverified EXCELLENT (22 checks/7 witnesses); landing IN-FLIGHT]  *(the #1 shared-bottleneck problem I filed — a solver delivered it)*
