...
| **Causal** | board 0.643 (CI-sep over twin, not strong floor); mental-bridge 1.000 vs 0.500 (instrument-gap) | causal_mental_bridge default-ON (kept, board-invisible); p10 **IN PROGRESS** | **PARTIAL** | multi-hop+counterfactual (p10) + a mental-causal board arm |
