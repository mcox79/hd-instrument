...
| **The BOARD / instrument** | 19c aggregate 0.659; modern board (p1) 0.605 modern, 4/7 CI-sep, 19c-FREE | 19c board LIVE; modern board **IN-FLIGHT** (retires 19c aggregate to informational) | **NO (mid-upgrade)** | land the modern board (now) + per-arm modern instruments (byhead/where_is/reliability) |
