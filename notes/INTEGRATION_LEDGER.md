...
|---|---|---|---|---|
| **Coref — pronoun** | live 0.469→0.602 (19c, graded ACT-R); GUM 0.362→0.468 (unified-referent); ceiling oracle-unified **0.584** | graded_pick default-ON (kept); unified_referent **IN-FLIGHT** | **PARTIAL** | land unified-referent (now) + clustering→0.584 + a modern pronoun corpus |
