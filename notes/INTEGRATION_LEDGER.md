...
| **Meaning / WSD channel** | curated +0.0755 · rare-sense +0.065 · ATL-precision +0.023 · clean-foundation +0.067 · word-sense shared-core **+0.1377**; wic arm +0.0633 (scored) | loader LANDED but **LATENT**; underspecified_sense_reader promotion **IN-FLIGHT** (p7); read()-time stage NOT built | **NO (entire channel latent)** | **BUILD the read()-time meaning stage — the single highest-leverage wire.** Fine-sense ceiling is context-input-bound (Phase-1); §2 no-encoder HOLD **empirically SETTLED** |
