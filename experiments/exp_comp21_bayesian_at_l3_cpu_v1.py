"""
exp_comp21_bayesian_at_l3_cpu_v1.py -- Bayesian belief update over L3 composite hypotheses -- CPU.

ROUTING: Research COMP_DIRECTION_CONFIRMED P4 (COMP-21 BAYESIAN-AT-L3); pure-FHRR (no download). Posterior-weighted bundle of L3 composite hypotheses; MAP recovered via cleanup; vs atomic L1.
...
PRE-REGISTERED: HARD-PASS L3 MAP-recall>=0.85 AND |gap-to-L1|<=0.10. MIDDLE>=0.70. HARD-FAIL<0.70.
...
ANCHOR_NAME = "comp21_bayesian_at_l3_cpu_v1"
