...
Pre-reg: preregs/2026-05-21_wave14r_multihop_K100.md
"""
...
def run_smoke():
    out_dir = get_output_dir("wave14r_multihop_K100_smoke")
    log_event("experiment_started", name="wave14r_multihop_K100", mode="smoke")
    ...
    log_event("experiment_outcome", name="wave14r_multihop_K100",
              mode="smoke", verdict=verdict, verdict_msg=msg, elapsed_s=elapsed)
    print(f"\nSMOKE OK: {verdict}", flush=True)


def run_main():
    out_dir = get_output_dir("wave14r_multihop_K100")
    log_event("experiment_started", name="wave14r_multihop_K100", mode="full")
