...
single-seed chunk for SEED=19. Parent design spec:
...
Architecture:
  ...
  This file = SEED 19. Sibling files exist for seeds 7 and 13. Skunkworks
...
ANCHOR_NAME = "substrate_swr_v3_iterative_clean_replay_seed_19_v1_GPU"
SEED_THIS_CHUNK = 19
_HARDENING_MARKER = "v3_iterative_seq_replay_seed_19"
