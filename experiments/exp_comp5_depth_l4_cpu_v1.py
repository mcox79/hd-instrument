"""
exp_comp5_depth_l4_cpu_v1.py -- compositional depth L=4 (between L3 and L5) -- CPU.

ROUTING: Research COMP_OVERCOME_BARRIER_BATCH P1 (COMP-5 DEPTH-L4); pure-FHRR (no download). L=4 K=10 retrieval with hierarchical cleanup; intermediate depth test.
...
PRE-REGISTERED: HARD-PASS recall>=0.80 at L=4 K=10. MIDDLE within 0.20. HARD-FAIL else.
...
ANCHOR_NAME = "comp5_depth_l4_cpu_v1"
