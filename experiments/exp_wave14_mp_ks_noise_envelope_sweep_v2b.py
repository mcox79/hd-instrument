...
Pre-reg: preregs/2026-05-24_wave14_mp_ks_noise_envelope_sweep_v2b.md
"""
...
def run_smoke() -> None:
    self_test()
    out_dir = get_output_dir("wave14_mp_ks_noise_envelope_sweep_v2b_smoke")
...
def run_main() -> None:
    self_test()
    out_dir = get_output_dir("wave14_mp_ks_noise_envelope_sweep_v2b")
