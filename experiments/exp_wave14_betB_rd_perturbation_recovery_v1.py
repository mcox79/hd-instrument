"""RD-terrace vs saddle-cascade: perturbation-recovery falsifier. v1.
...
K_PERTURB_FULL = 3   # rounds of false-pattern injection
K_PERTURB_SMOKE = 1
...
def run(smoke: bool = False):
    ...
    out_dir = get_output_dir("wave14_betB_rd_perturbation_recovery_v1")
