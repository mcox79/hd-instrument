...
Pre-reg: preregs/2026-05-24_wave14_cap8_vamp_iterates_srht_hadamard_v1.md
"""
...
def run_experiment(smoke: bool) -> tuple[dict, str, str, float, dict]:
    ...
    out_dir = get_output_dir(
        "wave14_cap8_vamp_iterates_srht_hadamard_v1_smoke" if smoke
        else "wave14_cap8_vamp_iterates_srht_hadamard_v1"
    )
...
def run_smoke() -> None:
    self_test()
    out_dir = get_output_dir("wave14_cap8_vamp_iterates_srht_hadamard_v1_smoke")
...
def run_main() -> None:
    self_test()
    out_dir = get_output_dir("wave14_cap8_vamp_iterates_srht_hadamard_v1")
