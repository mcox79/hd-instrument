"""Overnight experiment variant 7 — heavy multi-condition smoother sweep with high trial count."""
...
def run_experiment(smoke):
    ...
    seed = 7 * 100 + 7
    # Variant 7 varies: smaller N, different K and depth combos
    Ns = [4096, 16384, 65536]
    ...
    summary = {"results": results, "seed": seed, "variant": 7}
    verdict, msg = compute_verdict(summary)
    return summary, verdict, msg, time.monotonic()-t0, {"smoke":smoke,"seed":seed,"variant":7}
