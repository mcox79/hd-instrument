...
Pre-reg: preregs/2026-05-22_wave14_betV_self_reflective_v1.md
"""
...
def run_smoke():
    out_dir = get_output_dir("wave14_betV_self_reflective_v1_smoke")
...
def run_main():
    out_dir = get_output_dir("wave14_betV_self_reflective_v1")
