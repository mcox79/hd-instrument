"""
exp_substrate_kf1_ngram_augmented_v1 -- Slot G10: KF-1 on Pythia-160m (order-sensitive causal encoder) -- GPU.
...
ANCHOR_NAME = "substrate_kf1_hallucination_order_sensitive_encoder_v1"
...
def verdict(ps) -> Tuple[str, str]:
    ...
    if aa >= 0.85:
        return ("HARD_PASS", "HARD_PASS: order-sensitive Pythia encoder rescues word-order hallucination detection (adv AUC>=0.85) -- Phase-4 order-sensitive path via causal encoder. " + summary)
    if aa >= 0.70:
