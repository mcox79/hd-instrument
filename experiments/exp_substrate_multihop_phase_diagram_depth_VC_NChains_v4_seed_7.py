"""substrate_multihop_phase_diagram_depth_VC_NChains_v4_seed_7

CHUNKED phase-diagram cell (seed=7). Thin wrapper around
experiments._multihop_phase_diagram_v4_base.run_one_seed(seed=7).
...
# L4 import sentinel: capture import-time crashes (e.g., torch missing) and
# write metrics.json with verdict=UNKNOWN so the runner records the failure
...
try:
    ...
    sentinel = {
        "anchor_name": "substrate_multihop_phase_diagram_depth_VC_NChains_v4_seed_7",
        "verdict": "UNKNOWN",
