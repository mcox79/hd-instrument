...
Pre-reg: preregs/2026-05-21_wave14_r17_sketch_c_deeper.md
"""
...
def run_experiment(smoke):
    ...
    config = {"mode": "smoke" if smoke else "full",
              "N": 512 if smoke else 8192,  # deeper: was 2048
              "M_stored": 256 if smoke else 4096,
              "fracs": [0.0625, 0.125, 0.25, 0.5],  # added smaller frac for tighter fit
...
def run_smoke():
    out_dir = get_output_dir("wave14_r17_sketch_c_deeper_smoke")
...
def run_main():
    out_dir = get_output_dir("wave14_r17_sketch_c_deeper")
