...
ANCHOR_NAME = "substrate_capacity_battery_long_gpu_v1"
FLIP = 0.05; STEPS = 6
...
if RUN_MODE == "smoke":
    ...
    SEEDS = [7, 17, 23, 29, 37, 41, 43, 47, 53, 59]; N_GRID = [8192, 16384, 32768]; LOADS = [0.02, 0.04, 0.06, 0.08, 0.1, 0.13, 0.16, 0.2, 0.25, 0.3, 0.4, 0.6, 0.8, 1.0]
