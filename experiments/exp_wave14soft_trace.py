...
def main(smoke: bool = False) -> None:
    ...
    if smoke:
        ...
        # Bracket alpha_c = 0.153 * 4096 = 627 with K below + above
        config = {"mode": "full", "N": 4096,
                  "K_list": [50, 100, 200, 400, 627, 1000, 1800, 3000],
                  "seeds": [17, 23, 31, 41, 53, 67, 79]}
    print(f"wave14soft_trace. mode={config['mode']} device={device}", flush=True)
    ...
    out_dir = get_output_dir("wave14soft_trace")
