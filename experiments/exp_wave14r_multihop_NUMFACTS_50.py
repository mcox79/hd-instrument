...
Pre-reg: preregs/2026-05-21_wave14r_multihop_NUMFACTS_50.md
"""
...
NUM_FACTS_FULL = 50  # half the baseline; less cross-talk
NUM_FACTS_SMOKE = 20
...
def run_smoke():
    out_dir = get_output_dir("wave14r_multihop_NUMFACTS_50_smoke")
    log_event("experiment_started", name="wave14r_multihop_NUMFACTS_50", mode="smoke")
    ...
    log_event("experiment_outcome", name="wave14r_multihop_NUMFACTS_50",
              mode="smoke", verdict=verdict, verdict_msg=msg, elapsed_s=elapsed)
    print(f"\nSMOKE OK: {verdict}", flush=True)


def run_main():
    out_dir = get_output_dir("wave14r_multihop_NUMFACTS_50")
    log_event("experiment_started", name="wave14r_multihop_NUMFACTS_50", mode="full")
