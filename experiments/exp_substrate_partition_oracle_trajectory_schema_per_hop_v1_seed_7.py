"""substrate_partition_oracle_trajectory_schema_per_hop_v1 (seed=7).
...
NUMBER TAGGING (META_RULE_AC):
    ...
    MEASURED@DRILL_A_SUB_A_TOP1: 0.00
        d:/AI/hd-instrument/data/exp_substrate_partition_oracle_pfc_wm_state_tracker_v1_seed_7_smoke/metrics.json
...
DISCIPLINE TAGS:
    ...
    CHUNKED single-seed-per-cell sibling (seed=7; siblings seed=13, seed=19)

SOURCE CITATIONS (ABSOLUTE PATHS; META_RULE_AE):
    - Drill A template (cell):
      d:/AI/hd-instrument/experiments/exp_substrate_partition_oracle_pfc_wm_state_tracker_v1_seed_7.py
...
Author: exp_dev 2026-06-28 (Drill B; chunked single-seed sibling seed=7).
...
ANCHOR_NAME = "substrate_partition_oracle_trajectory_schema_per_hop_v1_seed_7"
_LLM_CALL_COUNTER = [0]
...
# Chain configuration
N_CHAINS_TRAIN = 200
SEEDS = [7]  # CHUNKED single-seed cell; siblings seed_13, seed_19
if RUN_MODE == "smoke":
    N_CHAINS_TEST = 100
else:
    N_CHAINS_TEST = 200
...
CONFIG_VERSION = (
    "ANCHOR=%s,trajectorySchemaPerHopV1Seed7: N=%d V_C=%d V_P=%d depth=%d "
...
def _selftest() -> None:
    ...
    assert "_seed_7" in ANCHOR_NAME
    assert ANCHOR_NAME.endswith("_seed_7")
...
if __name__ == "__main__":
    ...
    metrics = {
        ...
        "DESIGN_NOTE": (
            ...
            "v1_seed_7.py (template); pre-reg preregs/2026-06-28_substrate_"
