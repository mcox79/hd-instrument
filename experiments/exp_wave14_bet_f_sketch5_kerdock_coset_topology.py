...
Pre-reg: preregs/2026-05-21_wave14_bet_f_sketch5_kerdock_coset_topology.md
"""
...
def run_smoke():
    out_dir = get_output_dir("wave14_bet_f_sketch5_kerdock_coset_topology_smoke")
...
def run_main():
    out_dir = get_output_dir("wave14_bet_f_sketch5_kerdock_coset_topology")
