...
Pre-reg: preregs/2026-05-21_wave14_parisi_pq_sweep_v3c.md
"""
...
def run_smoke():
    out_dir = get_output_dir("wave14_parisi_pq_sweep_v3c_smoke")
...
def run_main():
    out_dir = get_output_dir("wave14_parisi_pq_sweep_v3c")
