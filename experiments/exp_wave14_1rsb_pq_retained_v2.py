...
N_FULL = 4096         # higher resolving power vs v1's N=2048
N_SMOKE = 512
SEEDS_FULL = list(range(20))   # 20 seeds (2x v1)
SEEDS_SMOKE = [7, 17, 23]
BATCH_SIZE_FULL = 64
BATCH_SIZE_SMOKE = 16
EPOCHS_FULL = 5
...
KDE_BW = 0.02         # tighter bandwidth for N=4096
PEAK_SEP_SIGMA = 2.0
BINDER_1RSB = 0.30
BINDER_RS = 0.05
...
def main():
    ...
    outdir = get_output_dir("wave14_1rsb_pq_retained_v2")
