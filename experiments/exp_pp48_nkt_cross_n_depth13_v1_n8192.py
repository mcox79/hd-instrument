"""
pp48_nkt_cross_n_depth13_v1_n8192 -- PP-48 NKT cross-N: depth-13 at N=8192.

Cross-N envelope expansion: depth-13 confirmed at N=4096; now test at N=8192.
  Same sampled-leaf NKT design, same depth-13, same K_FORBIDDEN=100.
  alpha_total = (10 pos + 100 forbidden) / 8192 = 0.0134. Even safer sub-capacity.

  Enables band-lift via cross-N criterion: if depth-13 holds at BOTH N=4096 AND N=8192,
  NKT row gets cross-N endorsement (like PP-52 rollback/addition).
...
PRE-REGISTERED BANDS:
  ...
  Calibration: N=4096 depth-13 HARD_PASS; bands unchanged for cross-N.
...
ANCHOR_NAME = "pp48_nkt_cross_n_depth13_v1_n8192"
...
def compute_verdict(results: List[Dict]) -> tuple:
    ...
    if hp1 and hp2:
        return ("HARD_PASS", f"HARD_PASS: both HP at NKT depth-13 cross-N N=8192. {summary}")
    if hp1 or hp2:
