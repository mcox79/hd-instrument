"""
exp_pseudoinverse_real_encoder_keys_v1 -- propose-back: E5-large-v2 hebb-vs-pinv capacity (vs BGE F6) -- CPU.
...
def verdict(ps) -> Tuple[str, str]:
    ...
    summary = "on real whitened E5-large keys: hebb_alpha_c=%.3f pinv_alpha_c=%.3f | pinv vs hebb: %s (synthetic was 8x)" % (h, pv, ratio_txt)
