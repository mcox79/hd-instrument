"""
exp_comp28_kb_shard_l3_cpu_v1.py -- KB-of-KBs shards (~1000 facts) retrieved hierarchically -- CPU.

ROUTING: Research COMP_DIRECTION_CONFIRMED P5 (COMP-28 KB-SHARD-L3); pure-FHRR (no download). KB composites (~1000 facts each); hierarchical retrieval by key (KB-of-KBs).
...
PRE-REGISTERED: HARD-PASS KB-level retrieval >=0.80. MIDDLE within 0.15. HARD-FAIL else.
...
ANCHOR_NAME = "comp28_kb_shard_l3_cpu_v1"
...
NSHARD = 40; MBODY = 1000; NFEAT = 3; BAR = 0.8; LABEL = "KB"
def _selftest():
