...
Pre-reg: preregs/2026-05-21_wave14_bet_f_high_noise.md
"""
...
def run_experiment(smoke):
    ...
    config = {"mode": "smoke" if smoke else "full",
              ...
              "p_sweep": [0.05, 0.30] if smoke else [0.05, 0.15, 0.30, 0.40, 0.50],
...
def run_smoke():
    out_dir = get_output_dir("wave14_bet_f_high_noise_smoke")
...
def run_main():
    out_dir = get_output_dir("wave14_bet_f_high_noise")
