...
ANCHOR_NAME = "combo1_gram_kappa3_n32768_v1"

# PROT-018: anchor has _n32768 -> N must = 32768 (Wave 5 production-scale)
# This is the N=32768 ratification of the N=4096 COMBO-1 result.
_N_SUFFIX = 32768
N = 32768
...
# NB: at N=32768, M=8N=262144 would produce M*N Gram fragments of 16GB FP32 per
# pattern matmul -- too big even on A100-80GB without chunking. Cap M_LIST at
# alpha=2 (M=65536) for the production cell; smoke at N=32768 alpha=2 only.
if RUN_MODE == "smoke":
    SEEDS = [7, 17]
    M_LIST = [2 * N]
    N_PROBES_K3 = 100
    ...
    SEEDS = [7, 17, 23, 31, 41]
    M_LIST = [2 * N]   # alpha=2 only at N=32768 (memory constraint vs N=4096)
    N_PROBES_K3 = 500
    N_TEST_RETRIEVAL = 50
...
def run_seed(seed: int) -> Dict:
    ...
    for M in M_LIST:
        ...
        k3_gram = hutchinson_kappa3(G, N_PROBES_K3, seed)
        kappa3_theory = M / N
...
def _instrumentation_selftest():
    ...
    k3 = hutchinson_kappa3(G_t, 50, seed)
    theory = M_t / N_t
