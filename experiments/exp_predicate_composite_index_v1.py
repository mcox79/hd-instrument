...
ROUTING: four-drills/top20 #4 composite-index. Bind composite (predicate (x) subject) keys instead of predicate-only; measure recall@10 at high selectivity (20%+) where flat predicate routing degraded. CPU.
PRE-REGISTERED: HARD-PASS composite recall@10>=0.90 at 20%+ selectivity.
FORMULA SELF-TESTS (PROT-022): 1. composite bind. 2. unbind inverts. 3. unit phasor.
...
ANCHOR_NAME = "predicate_composite_index_v1"; N = 4096
