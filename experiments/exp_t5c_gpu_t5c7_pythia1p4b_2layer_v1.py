"""
exp_t5c_gpu_t5c7_pythia1p4b_2layer_v1 -- Tier-5c Phase C: multi-layer Flamingo adapter continued training (LOCAL 4060 Ti) -- GPU.
...
ANCHOR_NAME = "t5c_gpu_t5c7_pythia1p4b_2layer_v1"; MODEL = "EleutherAI/pythia-1.4b"; LAYERS = [10, 11]
...
def _selftest():
    ...
    print("[selftest] PASS: gpu-t5c7-pythia1p4b", flush=True)
