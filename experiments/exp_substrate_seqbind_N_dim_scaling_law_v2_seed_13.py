"""substrate_seqbind_N_dim_scaling_law_v2 sibling seed=13.
...
SEED = 13
ANCHOR_NAME = f"substrate_seqbind_N_dim_scaling_law_v2_seed_{SEED}"
...
CONFIG_VERSION = (
    ...
    f"posctrl_N=8192,posctrl_log2_K_center=log2(500),posctrl_tol=1.0,"
...
def _write_minimal_metrics(out_dir: Path, verdict: str, verdict_msg: str,
    ...
    try:
        ...
        m = {
            ...
            "_hardening_marker": "v2_seqbind_N_dim_scaling_law_gate_D_recalibrated",
        }
        if extra:
            m.update(extra)
...
def main() -> int:
    ...
    from experiments._substrate_seqbind_N_dim_scaling_law_v2_core import (
    ...
    final["_hardening_marker"] = "v2_seqbind_N_dim_scaling_law_gate_D_recalibrated"
