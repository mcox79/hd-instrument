"""Long-horizon reversibility - 500 cycles extends zj.

zj at 50 cycles -> REVERSIBLE_BOTH_HOLD. zs runs 500 cycles to test whether
correlated keys eventually drift, or substrate is truly cycle-invariant.

Pre-reg: preregs/2026-05-21_wave14zs_reversibility_long.md
"""
...
def run_smoke():
    out_dir = get_output_dir("wave14zs_reversibility_long_smoke")
...
def run_main():
    out_dir = get_output_dir("wave14zs_reversibility_long")
