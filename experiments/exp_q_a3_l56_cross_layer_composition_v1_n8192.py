"""
q_a3_l56_cross_layer_composition_v1_n8192 -- Q-A3/PP-12: L=56 cross-layer composition at N=8192.
...
PRE-REGISTERED BANDS (Q-A3 L=51 N=8192):
  HARD-PASS: all 52 level fidelities >= 0.9999 unanimous (5/5 seeds) AND l56_acc >= 0.5.
  MIDDLE: any L_fid in [0.85, 0.9999) OR graceful degradation.
  HARD-FAIL: any L_fid < 0.85 OR l56_acc < 0.5.

FORMULA SELF-TESTS (PROT-022):
  1. L=51 chain: 55-ctx Hadamard roundtrip recovers xi_L1.
...
ANCHOR_NAME = "q_a3_l56_cross_layer_composition_v1_n8192"
