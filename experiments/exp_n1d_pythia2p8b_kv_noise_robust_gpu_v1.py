"""
exp_pythia_substrate_memory_mve_gpu_v1 -- N1d Tier-5 noise robustness (query corruption NOISE=0.30, 3x N1): substrate-KV memory keyed by Pythia-2.8B (3B-class) hidden states -- GPU.
...
ANCHOR_NAME = "n1d_pythia2p8b_kv_noise_robust_gpu_v1"; MODEL = "EleutherAI/pythia-2.8b"
RUN_MODE = ("smoke" if "--smoke" in sys.argv else os.environ.get("HDLAB_RUN_MODE", "full")).lower()
_ap = argparse.ArgumentParser(); _ap.add_argument("--smoke", action="store_true"); _ap.add_argument("--self-test", action="store_true"); _ARGS, _ = _ap.parse_known_args()
SMOKE = RUN_MODE == "smoke"
M = 300 if SMOKE else 2000; NOISE = 0.30; IN_CONTEXT_CEIL = 64
...
def _selftest():
    ...
    print("[selftest] PASS: n1d-pythia2p8b-kv-noise-robust", flush=True)
