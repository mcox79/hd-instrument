"""substrate_partition_oracle_brain_composition_hint_v1 (seed=13).
...
ANCHOR_NAME = "substrate_partition_oracle_brain_composition_hint_v1_seed_13"
_LLM_CALL_COUNTER = [0]
...
# Chain configuration
N_CHAINS_TRAIN = 200
SEEDS = [13]  # CHUNKED single-seed cell; siblings: seeds_7_13_19_minus_this
if RUN_MODE == "smoke":
    N_CHAINS_TEST = 100
else:
    N_CHAINS_TEST = 200
...
CONFIG_VERSION = (
    "ANCHOR=%s,substratePartOracleBrainCompV1Seed13: N=%d V_C=%d V_P=%d depth=%d "
...
def _selftest() -> None:
    ...
    # T15: anchor binding (seed=13 sibling)
...
if __name__ == "__main__":
    ...
    metrics = {
        ...
        "DESIGN_NOTE": (
            ...
            "single-seed sibling (seed=13); siblings seed_7+other "
