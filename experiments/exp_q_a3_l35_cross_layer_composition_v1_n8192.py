"""
q_a3_l35_cross_layer_composition_v1_n8192 -- Q-A3/PP-12: L=35 cross-layer composition at N=8192.
...
CONTEXT (v370 cycle 38 results):
  ...
  L=35 is the 15th rung in the N=8192 cross-N depth ladder (paired with L=36 this cycle).
  Establishes 2-N cross-N {N=4096+N=8192} coverage at L=35 (N=4096 already passed L=35).

SCIENTIFIC QUESTION:
  Does cross-layer composition fidelity remain EXACT-1.0 at L=35 N=8192?
  If yes: extends N=8192 cross-N series to L=35 (2-N cross-N at L=35).

MEMORY ESTIMATE (on-demand W):
  One W matrix at a time: 8192 x 8192 x 4 bytes = 268 MB. Well within 8 GB GPU.

PRE-REGISTERED BANDS (Q-A3 L=35 N=8192):
...
TIMEOUT ESTIMATE: L=34 N=8192 elapsed ~6s (5-seed). L=35 near-linear.
...
ANCHOR_NAME = "q_a3_l35_cross_layer_composition_v1_n8192"
...
# M_MID: 33 entries for L2..L34, M_OUTER = L35
# Total layers: 1 (L1=M_INNER) + 33 (M_MID) + 1 (M_OUTER=L35) = 35 = L_DEPTH
