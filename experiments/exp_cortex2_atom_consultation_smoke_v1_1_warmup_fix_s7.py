"""Wrapper: seed_7 entry-point for cortex2 atom-consultation smoke v1.1 warmup-fix.

Delegates to the core cell
(exp_cortex2_atom_consultation_smoke_v1_1_warmup_fix_core.py).
...
_CORE = Path(__file__).resolve().parent / "exp_cortex2_atom_consultation_smoke_v1_1_warmup_fix_core.py"
