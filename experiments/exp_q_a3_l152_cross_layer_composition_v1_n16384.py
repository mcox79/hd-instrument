"""
q_a3_l152_cross_layer_composition_v1_n16384 -- Q-A3/PP-12: L=152 cross-layer composition at N=16384.

CONTEXT (v372 cycle 42 all-night burst):
  N=16384 series: L=20..L=65 all EXACT-1.0000 (L=65 NEW DEEPEST cycle 41).
  L=152 is rung 133 in the N=16384 depth ladder.
...
PRE-REGISTERED BANDS (PP-12/Q-A3 L=152 N=16384):
...
FORMULA SELF-TESTS (PROT-022):
  1. L=152 chain: 151-ctx Hadamard roundtrip recovers xi_L1.
...
TIMEOUT ESTIMATE: ceil(1.5 * 109 * 1.0) = 164s. Use PROT-019 floor: 21600s.
"""
import sys
...
ANCHOR_NAME = "q_a3_l152_cross_layer_composition_v1_n16384"
