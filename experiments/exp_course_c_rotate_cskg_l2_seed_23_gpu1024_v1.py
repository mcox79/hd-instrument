"""PARALLEL GPU shot (seed 23, fpe_dim=1024) for the decisive ROTATION-score reasoning cell. Identical recipe
to exp_course_c_rotate_cskg_l2_seed_17_gpu1024_v1 EXCEPT SEEDS=[23]. The SECONDARY FPE-readout projection dim is
...
ANCHOR_NAME = "course_c_rotate_cskg_l2_seed_23_gpu1024_v1"
SEEDS = [23]
