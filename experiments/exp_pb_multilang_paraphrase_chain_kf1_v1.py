"""
exp_kf1_paraphrase_robustness_marianmt_v1 -- propose-back: HARDER multi-language paraphrase chain (en->de->fr->en) vs KF-1 -- GPU.
...
ANCHOR_NAME = "pb_multilang_paraphrase_chain_kf1_v1"
