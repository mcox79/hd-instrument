...
Pre-reg: preregs/2026-05-21_wave14r_multihop_N8192.md
"""
...
N_FULL = 8192  # intermediate N to fill scaling curve between v3 (N=4096) and largeN (N=16384)
N_SMOKE = 512
...
def run_smoke():
    out_dir = get_output_dir("wave14r_multihop_N8192_smoke")
    log_event("experiment_started", name="wave14r_multihop_N8192", mode="smoke")
    ...
    log_event("experiment_outcome", name="wave14r_multihop_N8192",
              mode="smoke", verdict=verdict, verdict_msg=msg, elapsed_s=elapsed)
    print(f"\nSMOKE OK: {verdict}", flush=True)


def run_main():
    out_dir = get_output_dir("wave14r_multihop_N8192")
    log_event("experiment_started", name="wave14r_multihop_N8192", mode="full")
