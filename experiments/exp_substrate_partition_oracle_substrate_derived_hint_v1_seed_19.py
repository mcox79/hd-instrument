"""substrate_partition_oracle_substrate_derived_hint_v1_seed_19.
...
ANCHOR_NAME = "substrate_partition_oracle_substrate_derived_hint_v1_seed_19"
_LLM_CALL_COUNTER = [0]
...
def _selftest() -> None:
    ...
    assert "substrate_derived_hint" in ANCHOR_NAME and ANCHOR_NAME.endswith("_seed_19")
...
if __name__ == "__main__":
    ...
    metrics = {
        ...
        "DESIGN_NOTE": (
            ...
            "seed (seed_19); siblings: seed_7 + seed_13. cv enforced post-hoc "
