"""
q_a3_l93_cross_layer_composition_v1_n16384 -- Q-A3/PP-12: L=93 cross-layer composition at N=16384.

CONTEXT (v374 cycle 44 all-night burst):
  N=16384 series: L=20..L=90 all EXACT-1.0000 (queued cycle 44).
  L=93 is rung 74 in the N=16384 depth ladder.
...
PRE-REGISTERED BANDS (PP-12/Q-A3 L=91 N=16384):
  HARD-PASS: all 90 level fidelities >= 0.9999 unanimous (5/5 seeds) AND l93_acc >= 0.5.
  MIDDLE: any L_fid in [0.85, 0.9999) OR graceful degradation.
  HARD-FAIL: any L_fid < 0.85 OR l93_acc < 0.5.

FORMULA SELF-TESTS (PROT-022):
  1. L=91 chain: 92-ctx Hadamard roundtrip recovers xi_L1.
     [INPUT: 2-element +-1 vectors, 92 context ops] [EXPECTED: decode = xi_L1 exactly]
...
ANCHOR_NAME = "q_a3_l93_cross_layer_composition_v1_n16384"
