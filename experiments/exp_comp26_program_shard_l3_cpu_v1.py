"""
exp_comp26_program_shard_l3_cpu_v1.py -- program-module shards (~100 functions) retrieved by behavior -- CPU.

ROUTING: Research COMP_DIRECTION_CONFIRMED P5 (COMP-26 PROGRAM-SHARD-L3); pure-FHRR (no download). 50 module composites (~100 functions each); retrieve by behavior.
...
PRE-REGISTERED: HARD-PASS behavior-retrieval >=0.80 on 50 modules. MIDDLE within 0.15. HARD-FAIL else.
...
ANCHOR_NAME = "comp26_program_shard_l3_cpu_v1"
...
NSHARD = 50; MBODY = 100; NFEAT = 3; BAR = 0.8; LABEL = "PROGRAM"
def _selftest():
