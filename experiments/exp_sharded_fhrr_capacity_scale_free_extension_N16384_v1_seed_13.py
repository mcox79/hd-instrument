"""sharded_fhrr_capacity_scale_free_extension_N16384_v1 seed=13 entry point.

Pre-reg: preregs/2026-07-02_sharded_fhrr_capacity_scale_free_extension_N16384_v1.md
Core: exp_sharded_fhrr_capacity_scale_free_extension_N16384_v1.py
...
_CORE = Path(__file__).with_name("exp_sharded_fhrr_capacity_scale_free_extension_N16384_v1.py")
