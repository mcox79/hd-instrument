"""substrate_partition_oracle_substrate_derived_hint_v1_seed_7.
...
ANCHOR_NAME = "substrate_partition_oracle_substrate_derived_hint_v1_seed_7"
_LLM_CALL_COUNTER = [0]
...
def _selftest() -> None:
    ...
    assert "substrate_derived_hint" in ANCHOR_NAME and ANCHOR_NAME.endswith("_seed_7")
...
if __name__ == "__main__":
    ...
    metrics = {
        ...
        "DESIGN_NOTE": (
            ...
            "seed (seed_7); siblings: seed_13 + seed_19. cv enforced post-hoc "
