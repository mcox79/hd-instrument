...
2026-06-30) single-seed chunk for SEED=7. Parent prereg:
...
CHUNKED single-seed-per-cell. This file = SEED 7. Sibling files exist for
seeds 13 and 19. Skunkworks aggregates the 3 per-seed metrics for chain-grade.
...
ANCHOR_NAME = "substrate_swr_v3_1_noisy_cue_replay_seed_7_v1_GPU"
SEED_THIS_CHUNK = 7
_HARDENING_MARKER = "v3_1_noisy_cue_seq_replay_seed_7"
