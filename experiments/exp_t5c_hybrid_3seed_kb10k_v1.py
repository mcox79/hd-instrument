"""
exp_t5c_hybrid_3seed_kb10k_v1 -- CYCLE_204 Tier-3 HYBRID: every-layer Flamingo (LM gain) + PP-225 projection head (fact recall) -- GPU.
...
ANCHOR_NAME = "t5c_hybrid_3seed_kb10k_v1"; MODEL = "EleutherAI/pythia-160m"; ENCODER = "BAAI/bge-large-en-v1.5"
...
def _selftest():
    ...
    print("[selftest] PASS: hybrid-3seed-kb10k", flush=True)
