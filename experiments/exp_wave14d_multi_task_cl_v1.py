...
Pre-reg: preregs/2026-05-21_wave14d_multi_task_cl_v1.md
"""
...
def run_experiment(smoke):
    ...
    config = {"mode": "smoke" if smoke else "full",
              ...
              "bytes_per_corpus": 5000 if smoke else 50000,
...
def run_smoke():
    out_dir = get_output_dir("wave14d_multi_task_cl_v1_smoke")
...
def run_main():
    out_dir = get_output_dir("wave14d_multi_task_cl_v1")
