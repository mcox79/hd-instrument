"""Substrate at N=262144 — Strategy 00:13 P3, 4x beyond V2.D."""
...
def compute_verdict(s):
    if "smoother_acc" not in s: return ("N262K_INCONCLUSIVE", "Missing.")
    a = s["smoother_acc"]
    if a >= 0.5: return ("N262K_SCALES", f"acc={a:.3f}>=0.5; substrate scales 4x beyond V2.D.")
    if a >= 0.3: return ("N262K_PARTIAL", f"acc={a:.3f}.")
    return ("N262K_KILLED", f"acc={a:.3f}<0.3.")


def self_test_verdict():
    for s,exp in [({"smoother_acc":0.8},"N262K_SCALES"),({"smoother_acc":0.4},"N262K_PARTIAL"),({"smoother_acc":0.2},"N262K_KILLED"),({},"N262K_INCONCLUSIVE")]:
...
def run_experiment(smoke):
    ...
    cfg = {"N":16384 if smoke else 262144, "K":100, "depth":25 if smoke else 50,
           "num_entities":200, "num_relations":20, "n_trials":5 if smoke else 15, "seed":17}
...
def run_smoke():
    out_dir = get_output_dir("wave14_substrate_N262144_v1_smoke")
...
def run_main():
    out_dir = get_output_dir("wave14_substrate_N262144_v1")
