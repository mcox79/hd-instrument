"""Smoother burst variant 3 — seed=3*7+30, larger N or K."""
...
def run_experiment(smoke):
    ...
    seed = 3*7 + 30
    K = 100 + 3*100  # K varies per variant
