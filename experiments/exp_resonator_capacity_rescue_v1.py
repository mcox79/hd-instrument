"""
exp_resonator_factorization_v1 -- Resonator capacity RESCUE (lower M, higher N) for the K=3 MIDDLE -- CPU.
...
ANCHOR_NAME = "resonator_capacity_rescue_v1"; N = 4096; M = 20; MAX_IT = 120
RUN_MODE = ("smoke" if "--smoke" in sys.argv else os.environ.get("HDLAB_RUN_MODE", "full")).lower()
_ap = argparse.ArgumentParser(); _ap.add_argument("--smoke", action="store_true"); _ap.add_argument("--self-test", action="store_true"); _ARGS, _ = _ap.parse_known_args()
K_GRID = [3] if RUN_MODE == "smoke" else [3, 4]; TRIALS = 30 if RUN_MODE == "smoke" else 150
