...
Anchor: substrate_state_compression_v1_n4096
Queue: remote_cpu_queue
Pre-reg: preregs/2026-05-30_substrate_state_compression_v1_n4096.md
"""
...
_ck_spec = importlib.util.spec_from_file_location("_seed_ckpt_c3", _ck_path)
...
def get_output_dir(default_name: str = "substrate_state_compression_v1_n4096") -> Path:
...
def _instrumentation_selftest() -> None:
    ...
    print(f"[selftest] substrate_state_compression_v1_n4096 PASS "
...
def main():
    ...
    t0 = time.time()
    print(f"[run] substrate_state_compression_v1_n4096 smoke={smoke} N={N_cfg} "
    ...
    summary = {"anchor": "substrate_state_compression_v1_n4096",
