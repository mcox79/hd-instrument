"""
q_a3_l27_cross_layer_composition_v1_n8192 -- Q-A3/PP-12: L=27 cross-layer composition at N=8192.

CONTEXT (v366 refill cycle):
  N=4096 series: L=2..L=35 all EXACT-1.0000.
  N=8192: L=19, L=22, L=23, L=24, L=25, L=26 all HARD_PASS EXACT-1.0000 (v366 L=26).
  L=27 is the 7th rung in the N=8192 cross-N depth ladder.

SCIENTIFIC QUESTION:
  Does cross-layer composition fidelity remain EXACT-1.0 at L=27 N=8192?
  If yes: extends N=8192 N-scale confirmation to L=27 rungs.

MEMORY ESTIMATE (on-demand W):
  One W matrix at a time: 8192 x 8192 x 4 bytes = 268 MB. Well within 8 GB GPU.

PRE-REGISTERED BANDS (Q-A3 L=27 N=8192):
...
TIMEOUT ESTIMATE: L=26 N=8192 FULL elapsed ~2.84s (5-seed). L=27 near-linear.
  ceil(1.5 * 2.84 * (27/26) * 1.0) = ceil(4.43) -> 300s.
"""
import sys
...
ANCHOR_NAME = "q_a3_l27_cross_layer_composition_v1_n8192"
...
# M_MID: 25 entries for L2..L26, M_OUTER = L27
# Total layers: 1 (L1=M_INNER) + 25 (M_MID) + 1 (M_OUTER=L27) = 27 = L_DEPTH
