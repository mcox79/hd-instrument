"""
exp_g2_pinv_write_throughput_v1 -- Batch I6 (pinv throughput DIRECT at N=65536; closes G2 extrapolation) -- GPU.
...
ANCHOR_NAME = "i6_pinv_throughput_n65536_v1"
ALPHA = 0.3
...
def verdict(r) -> Tuple[str, str]:
    ...
    if tp >= 500:
        return ("HARD_PASS", "HARD_PASS: pinv throughput >=500 writes/sec at N=65536 -- production-viable at scale. " % N_GRID[-1] + summary)
    if tp >= 50:
