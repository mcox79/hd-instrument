"""
q_a3_l48_cross_layer_composition_v1_n16384 -- Q-A3/PP-12: L=48 cross-layer composition at N=16384.

CONTEXT (v367 refill cycle):
  N=4096 series: L=2..L=35 all EXACT-1.0000.
  N=16384: {L=20..L=47} 28 rungs all EXACT-1.0000 (v366 HARD_PASS at L=46; v367 recent L=47 completed).
  L=48 is the 29th rung in the N=16384 depth ladder.

SCIENTIFIC QUESTION:
  Does cross-layer composition fidelity remain EXACT-1.0 at L=48 N=16384?

PRE-REGISTERED BANDS (PP-12/Q-A3 L=48 N=16384):
...
TIMEOUT ESTIMATE: L=47 elapsed ~21s (5-seed). L=48 near-linear scale.
  ceil(1.5 * 25 * 1.0 * 5) = ceil(187.5) -> 300s; floor 21600s per PROT-019 convention.
"""
import sys
...
ANCHOR_NAME = "q_a3_l48_cross_layer_composition_v1_n16384"
...
if RUN_MODE == "smoke":
    ...
    SEEDS = [7, 17]
    M_INNER = 20
    # 46 middle layers (L2..L47), then M_OUTER=L48
...
# M_MID: 46 entries for L2..L47, M_OUTER = L48
# Total layers: 1 (L1=M_INNER) + 46 (M_MID) + 1 (M_OUTER=L48) = 48 = L_DEPTH
