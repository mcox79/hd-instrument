"""
substrate_long_conversation_10k_exchanges_v1 -- HP-8: long-conv memory at 10,000 exchanges (10x scale), multi-session -- GPU.
...
ANCHOR_NAME = "substrate_long_conversation_10k_exchanges_v1"
MODEL_ID = "EleutherAI/pythia-160m"; N_SUB = 16384; LR = 0.5
RUN_MODE = ("smoke" if "--smoke" in sys.argv else os.environ.get("HDLAB_RUN_MODE", "full")).lower()
_ap = argparse.ArgumentParser(); _ap.add_argument("--smoke", action="store_true"); _ap.add_argument("--self-test", action="store_true"); _ARGS, _ = _ap.parse_known_args()
if RUN_MODE == "smoke":
    SEEDS = [1]; E = 10000; DEPTHS = [50, 2000, 9000]; N_THREADS = 5
else:
    SEEDS = [7, 17, 23]; E = 12000; DEPTHS = [50, 1000, 4000, 8000, 11000]; N_THREADS = 5
...
def _selftest():
    ...
    assert N_SUB == 16384; print("[selftest] PASS: distance-independent", flush=True)
