"""
q_a3_l28_cross_layer_composition_v1_n8192 -- Q-A3/PP-12: L=28 cross-layer composition at N=8192.

CONTEXT (v367 refill cycle):
  N=4096 series: L=2..L=35 all EXACT-1.0000.
  N=8192: L=19, L=22..L=27 all HARD_PASS EXACT-1.0000 (v367 recent L=27 completed).
  L=28 is the 8th rung in the N=8192 cross-N depth ladder.

SCIENTIFIC QUESTION:
  Does cross-layer composition fidelity remain EXACT-1.0 at L=28 N=8192?
  If yes: extends N=8192 N-scale confirmation to L=28 (2-N cross-N at L=28 confirmed).

MEMORY ESTIMATE (on-demand W):
  One W matrix at a time: 8192 x 8192 x 4 bytes = 268 MB. Well within 8 GB GPU.

PRE-REGISTERED BANDS (Q-A3 L=28 N=8192):
...
TIMEOUT ESTIMATE: L=27 N=8192 FULL elapsed ~2.84s (5-seed). L=28 near-linear.
...
ANCHOR_NAME = "q_a3_l28_cross_layer_composition_v1_n8192"
...
# M_MID: 26 entries for L2..L27, M_OUTER = L28
# Total layers: 1 (L1=M_INNER) + 26 (M_MID) + 1 (M_OUTER=L28) = 28 = L_DEPTH
