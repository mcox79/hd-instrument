...
Pre-reg: preregs/2026-05-21_wave14d_multi_task_cl_v8.md
"""
...
REPLAY_FRAC = 0.40  # v8 push beyond Ibrahim canonical recipe to see if EMA+replay compounds
...
def run_smoke():
    out_dir = get_output_dir("wave14d_multi_task_cl_v8_smoke")
...
def run_main():
    out_dir = get_output_dir("wave14d_multi_task_cl_v8")
