"""
q_a3_l43_cross_layer_composition_v1_n16384 -- Q-A3/PP-12: L=43 cross-layer composition at N=16384.
...
CONTEXT (v364 refill cycle):
  ...
  L=43 is the 24th rung in the N=16384 depth ladder.

SCIENTIFIC QUESTION:
  Does cross-layer composition fidelity remain EXACT-1.0 at L=43 N=16384?

PRE-REGISTERED BANDS (PP-12/Q-A3 L=43 N=16384):
...
FORMULA SELF-TESTS (PROT-022):
  1. L=43 chain: 42-ctx Hadamard roundtrip recovers xi_L1.
     [INPUT: 2-element +-1 vectors, 42 context ops] [EXPECTED: decode = xi_L1 exactly]
...
ANCHOR_NAME = "q_a3_l43_cross_layer_composition_v1_n16384"
...
if RUN_MODE == "smoke":
    ...
    SEEDS = [7, 17]
    M_INNER = 20
    # 41 middle layers (L2..L42), then M_OUTER=L43
    M_MID = [10, 5, 3, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2]
    M_OUTER = 2
    N_QUERIES = 2
else:
    N_ACTIVE = N
    SEEDS = [7, 17, 23, 31, 41]
    M_INNER = 100
    M_MID = [50, 25, 12, 6, 3, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2]
    M_OUTER = 2
    N_QUERIES = 2

# M_MID: 41 entries for L2..L42, M_OUTER = L43
# Total layers: 1 (L1=M_INNER) + 41 (M_MID) + 1 (M_OUTER=L43) = 43 = L_DEPTH
