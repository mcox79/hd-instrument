"""
q_a3_l2000_cross_layer_composition_v1_n16384 -- Q-A3/PP-12: L=2000 cross-layer composition at N=16384.

CONTEXT (v372 cycle 42 all-night burst):
  N=16384 series: L=20..L=65 all EXACT-1.0000 (L=65 NEW DEEPEST cycle 41).
  L=2000 is rung 1981 in the N=16384 depth ladder.
...
SCIENTIFIC QUESTION:
  Does cross-layer composition fidelity remain EXACT-1.0 at L=2000 N=16384?

PRE-REGISTERED BANDS (PP-12/Q-A3 L=2000 N=16384):
...
FORMULA SELF-TESTS (PROT-022):
  1. L=2000 chain: 1999-ctx Hadamard roundtrip recovers xi_L1.
...
TIMEOUT ESTIMATE: ceil(1.5 * 1957 * 1.0) = 2936s. Use PROT-019 floor: 21600s.
"""
import sys
...
ANCHOR_NAME = "q_a3_l2000_cross_layer_composition_v1_n16384"
