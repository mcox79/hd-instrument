"""substrate_storage_update_rule_family_phase_diagram_v1 sibling seed=13.
...
Inner axis: alpha-sweep {0.5, 1.0, 2.0, 4.0}.
...
PRE-REG: preregs/2026-06-30_substrate_storage_update_rule_family_phase_diagram_v1.md
...
Routing target: remote_cpu_queue (matmul-bound at modest K*B=1024 slots; CPU OK).
...
# torch imported at TOP for PROT-020 GPU eligibility scan
...
SEED = 13
ANCHOR_NAME = f"substrate_storage_update_rule_family_phase_diagram_v1_seed_{SEED}"
...
CONFIG_VERSION = (
    ...
    f"alpha_full=[0.5,1.0,2.0,4.0],alpha_smoke=[0.5,1.0,2.0,4.0],"
...
def _write_minimal_metrics(out_dir: Path, verdict: str, verdict_msg: str,
    ...
    try:
        ...
        m = {
            ...
            "_hardening_marker": "v1_storage_update_rule_family_phase_diagram_chunked",
        }
        if extra:
            m.update(extra)
...
def _write_import_crash_sentinel(exc: BaseException) -> None:
    try:
        ...
        s = {
            ...
            "_hardening_marker": "v1_storage_update_rule_family_import_crash",
        }
        tmp = out_dir / "metrics.json.tmp"
        final = out_dir / "metrics.json"
...
def main() -> int:
    ...
    from experiments._substrate_storage_update_rule_family_phase_diagram_v1_core import (
    ...
    final["_hardening_marker"] = "v1_storage_update_rule_family_phase_diagram_chunked"
