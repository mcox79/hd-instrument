...
runs the shared retrieval-agreement readout-fix diagnostic core at seed=23.
...
core.run_diag. A runner-death on this process loses only seed=23, not siblings.
