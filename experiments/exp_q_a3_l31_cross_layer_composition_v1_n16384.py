"""
q_a3_l31_cross_layer_composition_v1_n16384 -- Q-A3/PP-12: L=31 cross-layer composition at N=16384.

CONTEXT (v362 refill cycle):
  N=4096 series: L=2..L=35 all EXACT-1.0000 (21st consecutive streak).
  N=16384: L=20..L=30 all HARD_PASS (shipped v361/v362/v363 cycles).
  L=31 is twelfth rung in the N=16384 depth ladder.

SCIENTIFIC QUESTION:
  Does cross-layer composition fidelity remain EXACT-1.0 at L=31 N=16384?

PRE-REGISTERED BANDS (PP-12/Q-A3 L=31 N=16384):
...
TIMEOUT ESTIMATE: L=30 elapsed~15s (5-seed estimate); L=31 scales linearly.
...
ANCHOR_NAME = "q_a3_l31_cross_layer_composition_v1_n16384"
...
if RUN_MODE == "smoke":
    ...
    SEEDS = [7, 17]
    M_INNER = 20
    # 29 middle layers (L2..L30), then M_OUTER=L31
    M_MID = [10, 5, 3, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2]
    M_OUTER = 2
    N_QUERIES = 2
else:
    N_ACTIVE = N
    ...
    M_INNER = 100
    # 29 middle layers (L2..L30), then M_OUTER=L31
    M_MID = [50, 25, 12, 6, 3, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2]
    M_OUTER = 2
    N_QUERIES = 2
