"""
exp_kb_determinism_sweep_gpu_v1 -- PP-225 kb10k fact-recall determinism at n=3 seeds (Wave-3 Tier-A) -- GPU.
...
ANCHOR_NAME = "kb_determinism_sweep_gpu_v1"
RUN_MODE = ("smoke" if "--smoke" in sys.argv else os.environ.get("HDLAB_RUN_MODE", "full")).lower()
_ap = argparse.ArgumentParser(); _ap.add_argument("--smoke", action="store_true"); _ap.add_argument("--self-test", action="store_true"); _ARGS, _ = _ap.parse_known_args()
SMOKE = RUN_MODE == "smoke"
EXP = REPO / "experiments"
KB_CELL = "exp_t5c_pp225_kb10k_genuine_v1.py"
...
def _selftest():
    ...
    print("[selftest] PASS: kb-determinism-sweep", flush=True)
_selftest()
if _ARGS.self_test:
    sys.exit(0)
