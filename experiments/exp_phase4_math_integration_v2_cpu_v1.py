...
ANCHOR_NAME = "phase4_math_integration_v2_cpu_v1"
...
def _selftest():
    ...
    print("[selftest] PASS: phase4-math-integration-v2", flush=True)
_selftest()
if _ARGS.self_test:
    sys.exit(0)
def run() -> Dict:
    g = np.random.default_rng(int(os.environ.get("HDLAB_SEED", "1004")))
    try:
