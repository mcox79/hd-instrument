"""
exp_pythia_substrate_memory_mve_gpu_v1 -- N1b Tier-5 capacity ceiling sweep (M=5000): substrate-KV memory keyed by Pythia-2.8B (3B-class) hidden states -- GPU.
...
ANCHOR_NAME = "n1b_pythia2p8b_kv_capacity_5k_gpu_v1"; MODEL = "EleutherAI/pythia-2.8b"
RUN_MODE = ("smoke" if "--smoke" in sys.argv else os.environ.get("HDLAB_RUN_MODE", "full")).lower()
_ap = argparse.ArgumentParser(); _ap.add_argument("--smoke", action="store_true"); _ap.add_argument("--self-test", action="store_true"); _ARGS, _ = _ap.parse_known_args()
SMOKE = RUN_MODE == "smoke"
M = 300 if SMOKE else 5000; NOISE = 0.10; IN_CONTEXT_CEIL = 64
...
def _selftest():
    ...
    print("[selftest] PASS: n1b-pythia2p8b-kv-capacity-5k", flush=True)
