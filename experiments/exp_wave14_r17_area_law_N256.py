...
Pre-reg: preregs/2026-05-21_wave14_r17_area_law_N256.md
"""
...
def run_experiment(smoke):
    ...
    config = {"mode": "smoke" if smoke else "full",
              "N": 128 if smoke else 256,  # smallest N anchor for scaling curve
              "M_stored": 256 if smoke else 1024,
...
def run_smoke():
    out_dir = get_output_dir("wave14_r17_area_law_N256_smoke")
...
def run_main():
    out_dir = get_output_dir("wave14_r17_area_law_N256")
