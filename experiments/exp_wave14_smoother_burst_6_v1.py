"""Smoother burst variant 6 — seed=6*7+30, larger N or K."""
...
def run_experiment(smoke):
    ...
    seed = 6*7 + 30
    K = 100 + 6*100  # K varies per variant
