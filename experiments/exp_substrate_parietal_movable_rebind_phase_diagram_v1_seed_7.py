...
experiments._parietal_phase_diagram_v1_base.run_one_seed(seed=7).
...
# L4 import sentinel
try:
    from experiments._parietal_phase_diagram_v1_base import run_one_seed
    ...
    sentinel = {
        "anchor_name": "substrate_parietal_movable_rebind_phase_diagram_v1_seed_7",
        "verdict": "UNKNOWN",
