"""
exp_i3_f4_pinv_corruption_reaudit_v1 -- propose-back: does pinv corruption-robustness (I3, dense) hold for SPARSE patterns -- CPU.
...
ANCHOR_NAME = "pb_pinv_corruption_sparse_v1"
