...
instruction file section 13): runs the shared carry-through core at seed=31.
...
never receive a distinct seed. This wrapper hard-codes SEED=31 and forwards to
the core's run_carrythrough entry fn. A runner-death on this process loses only
seed=31, not the sibling seed runs (..._seed_7.py / _seed_13.py / _seed_23.py /
_seed_29.py).
