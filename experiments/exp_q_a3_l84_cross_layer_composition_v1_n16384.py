"""
q_a3_l84_cross_layer_composition_v1_n16384 -- Q-A3/PP-12: L=84 cross-layer composition at N=16384.

CONTEXT (v373 cycle 43):
  N=16384 series: L=20..L=83 all EXACT-1.0000 (L=83 expected in cycle 43 batch).
  L=84 is rung 65 in the N=16384 depth ladder.
...
SCIENTIFIC QUESTION:
  Does cross-layer composition fidelity remain EXACT-1.0 at L=84 N=16384?

PRE-REGISTERED BANDS (PP-12/Q-A3 L=84 N=16384):
  HARD-PASS: all 84 level fidelities >= 0.9999 unanimous (5/5 seeds) AND l84_acc >= 0.5.
  MIDDLE: any L_fid in [0.85, 0.9999) OR graceful degradation.
  HARD-FAIL: any L_fid < 0.85 OR l84_acc < 0.5.

FORMULA SELF-TESTS (PROT-022):
  1. L=84 chain: 83-ctx Hadamard roundtrip recovers xi_L1.
     [INPUT: 2-element +-1 vectors, 83 context ops] [EXPECTED: decode = xi_L1 exactly]
  ...
  4. M_MID length == L_DEPTH - 2 == 82.
     [INPUT: L_DEPTH=84] [EXPECTED: len(M_MID)=82]
...
TIMEOUT ESTIMATE: L=83 elapsed ~30s (5-seed). L=84 near-linear.
...
ANCHOR_NAME = "q_a3_l84_cross_layer_composition_v1_n16384"
