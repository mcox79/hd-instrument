"""Smoother burst variant 8 — seed=8*7+30, larger N or K."""
...
def run_experiment(smoke):
    ...
    seed = 8*7 + 30
    K = 100 + 8*100  # K varies per variant
