"""
q_a3_l137_cross_layer_composition_v1_n16384 -- Q-A3/PP-12: L=137 cross-layer composition at N=16384.

CONTEXT (v381 cycle 51 all-night burst):
  N=16384 series continues depth ladder past L=136.
  Per-stage alpha = 100/16384 = 0.0061 << alpha_c=0.138.

PRE-REGISTERED BANDS (Q-A3 L=137 N=16384):
  HARD-PASS: all 137 level fidelities >= 0.9999 unanimous (5/5 seeds) AND l137_acc >= 0.5.
  MIDDLE: any L_fid in [0.85, 0.9999) OR graceful degradation.
  HARD-FAIL: any L_fid < 0.85 OR l137_acc < 0.5.
...
ANCHOR_NAME = "q_a3_l137_cross_layer_composition_v1_n16384"
_N_SUFFIX = 16384
N = 16384
