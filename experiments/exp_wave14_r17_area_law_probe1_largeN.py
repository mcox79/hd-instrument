...
Pre-reg: preregs/2026-05-21_wave14_r17_area_law_probe1_largeN.md
"""
...
def run_experiment(smoke):
    ...
    config = {"mode": "smoke" if smoke else "full",
              "N": 512 if smoke else 4096,  # large N follow-up to v1 (N=2048) AREA_LAW_LIKE
...
def run_smoke():
    out_dir = get_output_dir("wave14_r17_area_law_probe1_largeN_smoke")
...
def run_main():
    out_dir = get_output_dir("wave14_r17_area_law_probe1_largeN")
