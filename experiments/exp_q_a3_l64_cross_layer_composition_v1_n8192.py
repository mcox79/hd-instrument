"""
q_a3_l64_cross_layer_composition_v1_n8192 -- Q-A3/PP-12: L=64 cross-layer composition at N=8192.

CONTEXT (v376 cycle 46 all-night burst):
  N=8192 series: L=19..L=62 all EXACT-1.0000 (cycles 42-45).
  L=64 is rung 45 in the N=8192 depth ladder.
...
SCIENTIFIC QUESTION:
  Does cross-layer composition fidelity remain EXACT-1.0 at L=64 N=8192?
...
FORMULA SELF-TESTS (PROT-022):
  1. L=64 chain: 63-ctx Hadamard roundtrip recovers xi_L1.
     [INPUT: 2-element +-1 vectors, 63 context ops] [EXPECTED: decode = xi_L1 exactly]
...
ANCHOR_NAME = "q_a3_l64_cross_layer_composition_v1_n8192"
