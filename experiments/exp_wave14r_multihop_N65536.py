...
Pre-reg: preregs/2026-05-21_wave14r_multihop_N65536.md
"""
...
N_FULL = 65536  # extreme N - tests whether Goldstone-mode scaling continues
N_SMOKE = 512
...
def run_smoke():
    out_dir = get_output_dir("wave14r_multihop_N65536_smoke")
    log_event("experiment_started", name="wave14r_multihop_N65536", mode="smoke")
    ...
    log_event("experiment_outcome", name="wave14r_multihop_N65536",
              mode="smoke", verdict=verdict, verdict_msg=msg, elapsed_s=elapsed)
    print(f"\nSMOKE OK: {verdict}", flush=True)


def run_main():
    out_dir = get_output_dir("wave14r_multihop_N65536")
    log_event("experiment_started", name="wave14r_multihop_N65536", mode="full")
