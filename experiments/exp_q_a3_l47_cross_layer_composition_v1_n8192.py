"""
q_a3_l47_cross_layer_composition_v1_n8192 -- Q-A3/PP-12: L=47 cross-layer composition at N=8192.
...
CONTEXT (v372 cycle 42 all-night burst):
  ...
  L=47 is rung 28 in the N=8192 depth ladder.
...
SCIENTIFIC QUESTION:
  Does cross-layer composition fidelity remain EXACT-1.0 at L=47 N=8192?
  If yes: extends N=8192 cross-N series to L=47 (cross-N at L=47).

MEMORY ESTIMATE (on-demand W):
  One W matrix at a time: 8192 x 8192 x 4 bytes = 268 MB. Well within 8 GB GPU.

PRE-REGISTERED BANDS (Q-A3 L=47 N=8192):
...
TIMEOUT ESTIMATE: L=45 N=8192 elapsed ~6s (5-seed). L=47 near-linear. L=45 near-linear.
...
ANCHOR_NAME = "q_a3_l47_cross_layer_composition_v1_n8192"
