...
Pre-reg: preregs/2026-05-21_wave14r_multihop_FHRR_largeN.md
"""
...
def run_smoke():
    out_dir = get_output_dir("wave14r_multihop_FHRR_largeN_smoke")
...
def run_main():
    out_dir = get_output_dir("wave14r_multihop_FHRR_largeN")
