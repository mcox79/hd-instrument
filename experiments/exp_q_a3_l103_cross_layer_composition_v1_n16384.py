"""
q_a3_l103_cross_layer_composition_v1_n16384 -- Q-A3/PP-12: L=103 cross-layer composition at N=16384.

CONTEXT (v376 cycle 46 all-night burst):
  N=16384 series: L=20..L=100 all EXACT-1.0000 (cycles 42-45, CENTURY RUNG passed).
  L=103 is rung 84 in the N=16384 depth ladder.
...
SCIENTIFIC QUESTION:
  Does cross-layer composition fidelity remain EXACT-1.0 at L=103 N=16384?

PRE-REGISTERED BANDS (PP-12/Q-A3 ladder continuation):
  HARD-PASS: all 103 level fidelities >= 0.9999 unanimous (5/5 seeds) AND l103_acc >= 0.5.
  MIDDLE: any L_fid in [0.85, 0.9999) OR graceful degradation.
  HARD-FAIL: any L_fid < 0.85 OR l103_acc < 0.5.

FORMULA SELF-TESTS (PROT-022):
  1. L=103 chain: 102-ctx Hadamard roundtrip recovers xi_L1.
     [INPUT: 2-element +-1 vectors, 102 context ops] [EXPECTED: decode = xi_L1 exactly]
  ...
  4. M_MID length == L_DEPTH - 2 == 101.
     [INPUT: L_DEPTH=103] [EXPECTED: len(M_MID)=101]
...
ANCHOR_NAME = "q_a3_l103_cross_layer_composition_v1_n16384"
