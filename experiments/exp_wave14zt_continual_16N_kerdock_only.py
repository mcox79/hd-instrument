...
zh held at M=2N continual, zi held at M=4N continual. zq pushes to M=16N
sequential editing to find substrate ceiling under combined stress.

Pre-reg: preregs/2026-05-21_wave14zt_continual_16N_kerdock_only.md
"""
...
def run_experiment(smoke):
    ...
    config = {"mode": "smoke" if smoke else "full", "N": 1024 if smoke else 4096,
              "M_stored": 4096 if smoke else 65536,  # full=8N; smoke shrunk to fit 4-coset codebook
...
def run_smoke():
    out_dir = get_output_dir("wave14zt_continual_16N_kerdock_only_smoke")
...
def run_main():
    out_dir = get_output_dir("wave14zt_continual_16N_kerdock_only")
