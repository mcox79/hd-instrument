"""
pp48_nkt_depth_19_v1_n4096 -- PP-48 NKT negative-knowledge tree at depth-19 at N=4096.

Extends depth-17 to depth-19. Ceiling chase for NKT depth.
  depth-17 verdict just completed (pending verdict read).
  Total binary tree at depth-19: 2^19 - 1 = 524287 nodes. Sampled-leaf design.
  ...
  Test: does substrate still repel depth-19 leaves with anti-Hebbian inhibition?

PRE-REGISTERED BANDS (ceiling push from depth-17):
  ...
  Calibration: depth-13 and depth-17 both HARD_PASS; bands unchanged at depth-19.

FORMULA SELF-TESTS:
  1. BRANCH=2, depth=19 total tree: sum(2^d for d in range(19)) = 2^19 - 1 = 524287.
...
ANCHOR_NAME = "pp48_nkt_depth_19_v1_n4096"
...
def compute_verdict(results: List[Dict]) -> tuple:
    ...
    if hp1 and hp2:
        return ("HARD_PASS", f"HARD_PASS: both HP at NKT depth-19 sampled-leaves. {summary}")
    if hp1 or hp2:
