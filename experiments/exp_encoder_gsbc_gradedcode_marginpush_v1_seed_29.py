...
seed=29. A runner-death on this process loses only seed=29.
...
run_tag="seed29" isolates this seed's metrics under
data/exp_encoder_gsbc_gradedcode_marginpush_v1_seed29/.
