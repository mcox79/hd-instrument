"""
q_a3_l104_cross_layer_composition_v1_n16384 -- Q-A3/PP-12: L=104 cross-layer composition at N=16384.

CONTEXT (v376 cycle 46 all-night burst):
  N=16384 series: L=20..L=100 all EXACT-1.0000 (cycles 42-45, CENTURY RUNG passed).
  L=104 is rung 85 in the N=16384 depth ladder.
...
SCIENTIFIC QUESTION:
  Does cross-layer composition fidelity remain EXACT-1.0 at L=104 N=16384?

PRE-REGISTERED BANDS (PP-12/Q-A3 ladder continuation):
  HARD-PASS: all 104 level fidelities >= 0.9999 unanimous (5/5 seeds) AND l104_acc >= 0.5.
  MIDDLE: any L_fid in [0.85, 0.9999) OR graceful degradation.
  HARD-FAIL: any L_fid < 0.85 OR l104_acc < 0.5.

FORMULA SELF-TESTS (PROT-022):
  1. L=104 chain: 103-ctx Hadamard roundtrip recovers xi_L1.
     [INPUT: 2-element +-1 vectors, 103 context ops] [EXPECTED: decode = xi_L1 exactly]
  ...
  4. M_MID length == L_DEPTH - 2 == 102.
     [INPUT: L_DEPTH=104] [EXPECTED: len(M_MID)=102]
...
ANCHOR_NAME = "q_a3_l104_cross_layer_composition_v1_n16384"
