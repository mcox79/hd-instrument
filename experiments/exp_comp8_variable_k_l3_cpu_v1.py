"""
exp_comp8_variable_k_l3_cpu_v1.py -- variable-K sweep at fixed L=3 (capacity-vs-depth) -- CPU.

ROUTING: Research COMP_OVERCOME_BARRIER_BATCH P1 (COMP-8 DEPTH-VARIABLE-K); pure-FHRR (no download). Sweep K (5/10/20/50) at L=3 with cleanup; capacity-vs-depth tradeoff curve.
...
PRE-REGISTERED: HARD-PASS recall>=0.85 at K=50 L=3. MIDDLE>=0.65. HARD-FAIL else.
...
ANCHOR_NAME = "comp8_variable_k_l3_cpu_v1"
