...
Pre-reg: preregs/2026-05-21_wave14_continual_4N_500edits.md
"""
...
def run_experiment(smoke):
    ...
    config = {"mode": "smoke" if smoke else "full", "N": 1024 if smoke else 4096,
              ...
              "n_edits": 10 if smoke else 500,  # 10x continual stress
...
def run_smoke():
    out_dir = get_output_dir("wave14_continual_4N_500edits_smoke")
...
def run_main():
    out_dir = get_output_dir("wave14_continual_4N_500edits")
