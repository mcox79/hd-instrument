"""
exp_two_vector_alpha_tradeoff_gpu_v2.py -- the production two-vector composite's alpha tradeoff curve (N=4096, GPU) -- GPU.
...
ANCHOR_NAME = "two_vector_alpha_tradeoff_gpu_v2"
...
def _selftest():
    ...
    print("[selftest] PASS: two_vector_alpha_tradeoff_gpu_v2", flush=True)
