"""
exp_pythia_substrate_memory_mve_gpu_v1 -- T5a-S2 production-scale substrate-KV (M=100000): substrate-KV memory keyed by Pythia-2.8B (3B-class) hidden states -- GPU.
...
ANCHOR_NAME = "t5a_s2_substrate_kv_m100000_gpu_v1"; MODEL = "EleutherAI/pythia-2.8b"
RUN_MODE = ("smoke" if "--smoke" in sys.argv else os.environ.get("HDLAB_RUN_MODE", "full")).lower()
_ap = argparse.ArgumentParser(); _ap.add_argument("--smoke", action="store_true"); _ap.add_argument("--self-test", action="store_true"); _ARGS, _ = _ap.parse_known_args()
SMOKE = RUN_MODE == "smoke"
M = 1000 if SMOKE else 100000; NOISE = 0.10; IN_CONTEXT_CEIL = 64
...
def _selftest():
    ...
    print("[selftest] PASS: t5a-s2-substrate-kv-m100000", flush=True)
