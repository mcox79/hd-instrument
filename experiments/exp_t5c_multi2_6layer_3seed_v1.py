"""
exp_t5c_multi2_6layer_3seed_v1 -- Tier-5c Phase C: multi-layer Flamingo adapter continued training (LOCAL 4060 Ti) -- GPU.
...
ANCHOR_NAME = "t5c_multi2_6layer_3seed_v1"; MODEL = "EleutherAI/pythia-160m"; LAYERS = [3, 4, 5, 6, 7, 8]
...
def _selftest():
    ...
    print("[selftest] PASS: multi2-6layer-3seed", flush=True)
