...
def main(smoke: bool = False) -> None:
    ...
    if smoke:
        ...
        config = {"mode": "full", "N": 4096, "K_sources": 8,
                  "L_items_list": [50, 150, 300, 500, 800, 1200, 1500, 2000],
                  "seeds": [17, 23, 31, 41, 53, 67, 79]}
    print(f"wave14source_monitoring_extended. mode={config['mode']} device={device}", flush=True)
    ...
    out_dir = get_output_dir("wave14source_monitoring_extended")
