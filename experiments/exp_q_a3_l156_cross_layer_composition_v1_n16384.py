"""
q_a3_l156_cross_layer_composition_v1_n16384 -- Q-A3/PP-12: L=156 cross-layer composition at N=16384.

CONTEXT (v372 cycle 42 all-night burst):
  N=16384 series: L=20..L=65 all EXACT-1.0000 (L=65 NEW DEEPEST cycle 41).
  L=156 is rung 137 in the N=16384 depth ladder.
...
SCIENTIFIC QUESTION:
  Does cross-layer composition fidelity remain EXACT-1.0 at L=156 N=16384?

PRE-REGISTERED BANDS (PP-12/Q-A3 L=156 N=16384):
  HARD-PASS: all 156 level fidelities >= 0.9999 unanimous (5/5 seeds) AND l156_acc >= 0.5.
  MIDDLE: any L_fid in [0.85, 0.9999) OR graceful degradation.
  HARD-FAIL: any L_fid < 0.85 OR l156_acc < 0.5.

FORMULA SELF-TESTS (PROT-022):
  1. L=156 chain: 155-ctx Hadamard roundtrip recovers xi_L1.
...
TIMEOUT ESTIMATE: ceil(1.5 * 113 * 1.0) = 170s. Use PROT-019 floor: 21600s.
"""
import sys
...
ANCHOR_NAME = "q_a3_l156_cross_layer_composition_v1_n16384"
