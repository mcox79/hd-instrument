...
Pre-reg: preregs/2026-05-21_wave14_bet_f_sketch5_N4096.md
"""
...
def run_experiment(smoke):
    ...
    config = {"mode": "smoke" if smoke else "full",
              ...
              "M": 256 if smoke else 4096,  # capacity stress: 4x more facts than Sketch 5 baseline
...
def run_smoke():
    out_dir = get_output_dir("wave14_bet_f_sketch5_N4096_smoke")
...
def run_main():
    out_dir = get_output_dir("wave14_bet_f_sketch5_N4096")
