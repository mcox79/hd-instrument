"""
q_a3_l128_cross_layer_composition_v1_n16384 -- Q-A3/PP-12: L=128 cross-layer composition at N=16384.

CONTEXT (v380 cycle 50 all-night burst):
  N=16384 series continues depth ladder past L=127 (HARD_PASS).
  Per-stage alpha = 100/16384 = 0.0061 << alpha_c=0.138.

PRE-REGISTERED BANDS (Q-A3 L=128 N=16384):
  HARD-PASS: all 128 level fidelities >= 0.9999 unanimous (5/5 seeds) AND l128_acc >= 0.5.
  MIDDLE: any L_fid in [0.85, 0.9999) OR graceful degradation.
  HARD-FAIL: any L_fid < 0.85 OR l128_acc < 0.5.
...
ANCHOR_NAME = "q_a3_l128_cross_layer_composition_v1_n16384"
_N_SUFFIX = 16384
N = 16384
