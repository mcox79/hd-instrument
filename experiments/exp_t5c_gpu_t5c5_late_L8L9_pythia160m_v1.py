"""
exp_t5c_gpu_t5c5_late_L8L9_pythia160m_v1 -- Tier-5c Phase C: multi-layer Flamingo adapter continued training (LOCAL 4060 Ti) -- GPU.
...
ANCHOR_NAME = "t5c_gpu_t5c5_late_L8L9_pythia160m_v1"; MODEL = "EleutherAI/pythia-160m"; LAYERS = [8, 9]
...
def _selftest():
    ...
    print("[selftest] PASS: gpu-t5c5-late", flush=True)
