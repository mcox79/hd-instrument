"""
q_a3_l126_cross_layer_composition_v1_n16384 -- Q-A3/PP-12: L=126 cross-layer composition at N=16384.
...
PRE-REGISTERED BANDS (Q-A3 L=126 N=16384):
  HARD-PASS: all 126 level fidelities >= 0.9999 unanimous (5/5 seeds) AND l126_acc >= 0.5.
  MIDDLE: any L_fid in [0.85, 0.9999) OR graceful degradation.
  HARD-FAIL: any L_fid < 0.85 OR l126_acc < 0.5.
...
ANCHOR_NAME = "q_a3_l126_cross_layer_composition_v1_n16384"
_N_SUFFIX = 16384
N = 16384
