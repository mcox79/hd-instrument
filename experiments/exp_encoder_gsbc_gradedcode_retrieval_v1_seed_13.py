...
hard-block-STE vs graded-GSBC ship-metric cell for seed=13. A runner-death on
this process loses only seed=13, not the sibling seed=7 / seed=19 runs.
...
run_tag="seed13" isolates this seed's metrics under
data/exp_encoder_gsbc_gradedcode_retrieval_v1_seed13/.
