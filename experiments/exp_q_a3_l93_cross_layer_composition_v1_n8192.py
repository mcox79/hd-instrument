"""
q_a3_l93_cross_layer_composition_v1_n8192 -- Q-A3/PP-12: L=88 cross-layer composition at N=8192.

CONTEXT (v381 cycle 50 refill):
  N=8192 series continues depth ladder past L=88 (HARD_PASS).
  Per-stage alpha = 100/8192 = 0.0122 << alpha_c=0.138.

PRE-REGISTERED BANDS (Q-A3 L=93 N=8192):
  HARD-PASS: all 93 level fidelities >= 0.9999 unanimous (5/5 seeds) AND l93_acc >= 0.5.
...
ANCHOR_NAME = "q_a3_l93_cross_layer_composition_v1_n8192"
_N_SUFFIX = 8192
N = 8192
