"""Overnight experiment variant 3 — heavy multi-condition smoother sweep with high trial count."""
...
def run_experiment(smoke):
    ...
    seed = 3 * 100 + 7
    # Variant 3 varies: smaller N, different K and depth combos
    Ns = [4096, 16384, 65536]
    ...
    summary = {"results": results, "seed": seed, "variant": 3}
    verdict, msg = compute_verdict(summary)
    return summary, verdict, msg, time.monotonic()-t0, {"smoke":smoke,"seed":seed,"variant":3}
