"""
q_a3_l26_cross_layer_composition_v1_n8192 -- Q-A3/PP-12: L=26 cross-layer composition at N=8192.

CONTEXT (v364 refill cycle):
  N=4096 series: L=2..L=35 all EXACT-1.0000.
  N=8192: L=2 (v333), L=3 (v354), L=4, L=19 (v354), L=22-25 (v355-v358) all HARD_PASS.
  L=25 N=8192 was HARD_PASS (all 25 levels fidelity=1.0000 unanimous, 5-seed FULL).
  L=26 is the next rung in the N=8192 cross-N depth ladder (D candidate from v364 prompt).

SCIENTIFIC QUESTION:
  Does cross-layer composition fidelity remain EXACT-1.0 at L=26 N=8192?
  If yes: extends N=8192 N-scale confirmation to L=26 rungs.

MEMORY ESTIMATE (on-demand W):
  One W matrix at a time: 8192 x 8192 x 4 bytes = 268 MB. Well within 8 GB GPU.
  L=25 all-at-once approach used ~6.71 GB. L=26 on-demand avoids materialization risk.

PRE-REGISTERED BANDS (Q-A3 L=26 N=8192):
...
TIMEOUT ESTIMATE: L=25 N=8192 FULL elapsed ~2.08s (5-seed). L=26 near-linear.
...
ANCHOR_NAME = "q_a3_l26_cross_layer_composition_v1_n8192"
...
# M_MID: 24 entries for L2..L25, M_OUTER = L26
# Total layers: 1 (L1=M_INNER) + 24 (M_MID) + 1 (M_OUTER=L26) = 26 = L_DEPTH
