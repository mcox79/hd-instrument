"""
q_a3_l117_cross_layer_composition_v1_n16384 -- Q-A3/PP-12: L=117 cross-layer composition at N=16384.

CONTEXT (v378 cycle 48 all-night burst):
  N=16384 series: L=20..L=112 all EXACT-1.0000 (L=112 NEW DEEPEST cycle 47).
  L=117 is rung 98 in the N=16384 depth ladder.
...
SCIENTIFIC QUESTION:
  Does cross-layer composition fidelity remain EXACT-1.0 at L=117 N=16384?

PRE-REGISTERED BANDS (PP-12/Q-A3 L=117 N=16384):
  HARD-PASS: all 117 level fidelities >= 0.9999 unanimous (5/5 seeds) AND l117_acc >= 0.5.
  MIDDLE: any L_fid in [0.85, 0.9999) OR graceful degradation.
  HARD-FAIL: any L_fid < 0.85 OR l117_acc < 0.5.

FORMULA SELF-TESTS (PROT-022):
  1. L=117 chain: 116-ctx Hadamard roundtrip recovers xi_L1.
...
ANCHOR_NAME = "q_a3_l117_cross_layer_composition_v1_n16384"
