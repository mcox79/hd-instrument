"""
pp50_transition_zone_n_sweep_tw_vs_hadamard_v3_gpu_highprobe -- PP-50 transition-zone mechanism discriminator (N-sweep, GPU).
...
ANCHOR_NAME = "pp50_transition_zone_n_sweep_tw_vs_hadamard_v3_gpu_highprobe"
...
if RUN_MODE == "smoke":
    ...
    SEEDS = [7, 17, 23, 31, 41]
    N_PROBES = 20000   # v3: v2 @1000 probes was noise-limited (non-monotone sigma_sep); matrix-free is cheap
