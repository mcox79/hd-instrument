...
ANCHOR_NAME = "substrate_partition_oracle_pfc_wm_state_tracker_v1_seed_19"
_LLM_CALL_COUNTER = [0]
...
# Chain configuration
N_CHAINS_TRAIN = 200
SEEDS = [19]  # CHUNKED single-seed cell; siblings seed_7, seed_13
if RUN_MODE == "smoke":
    N_CHAINS_TEST = 100
else:
    N_CHAINS_TEST = 200
...
CONFIG_VERSION = (
    "ANCHOR=%s,pfcWmStateTrackerV1Seed19: N=%d V_C=%d V_P=%d depth=%d "
...
def _selftest() -> None:
    ...
    # T18: anchor binding (seed=19 sibling)
