...
# Main driver
# ---------------------------------------------------------------------------
# RULE_EXPERIMENT_CELLS_MUST_GUARD_MAIN_WITH___NAME___DUNDER
# Guard added 2026-06-27: prior versions ran the main loop at IMPORT TIME,
# contaminating any cell that imported a helper from this module (e.g.
# stratified_replay_baseline_diagnostic_v1 imported setup_substrate_with_trace_and_clusters
# and triggered THIS file's 6-arm sweep into the importing cell's output dir).
# See notes/research_drill_stratified_replay_HARD_FAIL_3x_2026-06-27.md.
