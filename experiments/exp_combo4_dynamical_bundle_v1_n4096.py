...
ANCHOR_NAME = "combo4_dynamical_bundle_v1_n4096"
...
if RUN_MODE == "smoke":
    N_SMOKE = 512   # smoke runs at smaller N for speed
    N_ACTIVE = N_SMOKE
    SEEDS = [7]
    R = 100        # replicas for M_dyn
    T_MAX = 512    # max time steps
    TW_LIST = [16, 64]
    T_RATIO_GRID = [2.0, 4.0, 8.0]
else:
    N_ACTIVE = N
    SEEDS = [7, 17, 23]
    R = 500        # reduced from 2000 for wall-time; R=500 still resolves M_dyn to 0.01
    T_MAX = 2048
    TW_LIST = [16, 64, 256]
