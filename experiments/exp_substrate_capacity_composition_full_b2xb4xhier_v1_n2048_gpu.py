"""
substrate_capacity_composition_full_b2xb4xhier_v1_n2048_gpu -- full capacity-axis composition M_crit (GPU).
...
ANCHOR_NAME = "substrate_capacity_composition_full_b2xb4xhier_v1_n2048_gpu"
...
if RUN_MODE == "smoke":
    ...
    N_DIM = N; N_DG = N * 4; SEEDS = [7, 17, 23]; M_DENSE = [50, 100, 200, 300]; M_SPARSE = [400, 1200, 3600, 7200, 12000]
...
def _selftest():
    ...
    assert N == 2048; print("[selftest] PASS: sparse_completion dense_recall", flush=True)
