"""Thin per-seed wrapper (CHUNKED single-seed-per-cell): runs the shared v7
...
sibling seed=7 run (exp_encoder_v7_k512_capacity_paired_v1_seed_7.py).

Core: experiments/exp_encoder_v7_k512_capacity_paired_v1_core.py
...
from experiments import (  # noqa: E402
    exp_encoder_v7_k512_capacity_paired_v1_core as core,
)
