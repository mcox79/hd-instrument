"""
exp_pythia_substrate_memory_mve_gpu_v1 -- D1 (Tier-5): substrate as the LLM's external memory, keyed by Pythia hidden states -- GPU.
...
ANCHOR_NAME = "pythia_substrate_memory_mve_gpu_v1"; MODEL = "EleutherAI/pythia-160m"
...
def _selftest():
    ...
    print("[selftest] PASS: pythia-substrate-memory-mve", flush=True)
