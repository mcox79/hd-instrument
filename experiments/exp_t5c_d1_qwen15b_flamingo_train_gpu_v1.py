...
ANCHOR_NAME = "t5c_d1_qwen15b_flamingo_train_gpu_v1"; MODEL = "Qwen/Qwen2.5-1.5B-Instruct"; LAYERS = [12, 13]
...
def _selftest():
    ...
    print("[selftest] PASS: t5c-d1-qwen15b-flamingo-train", flush=True)
