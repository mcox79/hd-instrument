"""substrate_cleanup_family_wm_kcliff_v1 sibling seed=7.
...
regime grid. Multi-bank: num_banks=16, N=8192 (full); N=2048 (smoke).
...
PROT-018: anchor has no _n<N> suffix (multi-N config -- N=8192 full, N=2048 smoke).
...
softmax-attention at N=8192 x M~8000 codebook); cell aborts to CPU only when
...
SEED = 19
ANCHOR_NAME = f"substrate_cleanup_family_wm_kcliff_v1_seed_{SEED}"
...
CONFIG_VERSION = (
    ...
    f"encoder=bipolar,N_full=8192,N_smoke=2048,SEED={SEED},mode={RUN_MODE},"
    f"K_per_bank_full=[50,100,250,500,1000],K_per_bank_smoke=[50,100,250],"
    f"num_banks=16,regimes_full=[RANDOM,ADVERSARIAL],regimes_smoke=[RANDOM],"
...
def _write_minimal_metrics(out_dir: Path, verdict: str, verdict_msg: str,
    ...
    try:
        ...
        m = {
            ...
            "_hardening_marker": "v1_cleanup_family_wm_kcliff_chunked",
        }
        if extra:
            m.update(extra)
...
def _write_import_crash_sentinel(exc: BaseException) -> None:
    ...
    try:
        ...
        s = {
            ...
            "_hardening_marker": "v1_cleanup_family_wm_kcliff_import_crash",
        }
...
def main() -> int:
    ...
    from experiments._substrate_cleanup_family_wm_kcliff_v1_core import (
    ...
    final["_hardening_marker"] = "v1_cleanup_family_wm_kcliff_chunked"
