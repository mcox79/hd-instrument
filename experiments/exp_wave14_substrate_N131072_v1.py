"""Substrate at N=131072 — push beyond V2.D N=65536 with bf16."""
...
def compute_verdict(s):
    if "smoother_acc" not in s: return ("N131K_INCONCLUSIVE", "Missing.")
    a = s["smoother_acc"]
    if a >= 0.5: return ("N131K_SCALES", f"smoother@N=131072: {a:.3f}>=0.5; substrate scales beyond V2.D.")
    return ("N131K_BREAKS", f"smoother@N=131072: {a:.3f}<0.5.")


def self_test_verdict():
    for s,exp in [({"smoother_acc":0.8},"N131K_SCALES"),({"smoother_acc":0.3},"N131K_BREAKS"),({},"N131K_INCONCLUSIVE")]:
...
def run_experiment(smoke):
    ...
    cfg = {"N":16384 if smoke else 131072, "K":100, "depth":25 if smoke else 50,
    ...
    print(f"  smoother@N={cfg['N']}: acc={acc:.3f}", flush=True)
...
def run_smoke():
    out_dir = get_output_dir("wave14_substrate_N131072_v1_smoke")
...
def run_main():
    out_dir = get_output_dir("wave14_substrate_N131072_v1")
