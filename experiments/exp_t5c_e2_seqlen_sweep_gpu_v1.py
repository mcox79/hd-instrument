"""
exp_t5c_e2_seqlen_sweep_gpu_v1 -- Tier-5c Phase C: multi-layer Flamingo adapter continued training (LOCAL 4060 Ti) -- GPU.
...
ANCHOR_NAME = "t5c_e2_seqlen_sweep_gpu_v1"; MODEL = "EleutherAI/pythia-160m"; LAYERS = [4, 5]
...
def _selftest():
    ...
    print("[selftest] PASS: t5c-e2-seqlen-sweep", flush=True)
...
def run() -> Dict:
    ...
    enc = lambda t: tok(t, return_tensors="pt", truncation=True, max_length=globals().get("SEQLEN", 512)).to(DEV)
