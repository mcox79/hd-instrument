...
+ graded-code(m=5) vs coarse(m=1) ret_agree10-vs-BGE-eval-oracle cell, seed=7.
A runner-death on this process loses only seed=7, not the sibling seeds.
...
HDLAB_RUN_MODE=full; this wrapper aliases full -> the core's FULL tier for seed 7.
