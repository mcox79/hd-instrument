...
single-seed chunk for SEED=7. Parent design spec:
...
Architecture:
  ...
  This file = SEED 7. Sibling files exist for seeds 13 and 19. Skunkworks
...
ANCHOR_NAME = "substrate_swr_v3_iterative_clean_replay_seed_7_v1_GPU"
SEED_THIS_CHUNK = 7
_HARDENING_MARKER = "v3_iterative_seq_replay_seed_7"
