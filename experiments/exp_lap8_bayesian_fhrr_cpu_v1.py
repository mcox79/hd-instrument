"""
exp_lap8_bayesian_fhrr_cpu_v1.py -- FHRR amplitude-as-probability on canonical Bayes problems -- CPU.

ROUTING: Research OVERNIGHT_FILL_PRIORITIZED laptop batch (LAP-8 CONV-12-BAYESIAN-FHRR); pure-FHRR (no download). amplitude=sqrt(prob), likelihood reweight, |proj|^2 readout; Monty Hall + medical diagnosis + spam filter.
PRE-REGISTERED: HARD-PASS bayes-correct>=0.85. MIDDLE>=0.65. HARD-FAIL<0.65.
...
ANCHOR_NAME = "lap8_bayesian_fhrr_cpu_v1"
