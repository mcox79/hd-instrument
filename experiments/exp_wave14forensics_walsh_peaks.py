...
def main(smoke: bool = False) -> None:
    ...
    if smoke:
        ...
        # Bracket alpha_c*N=627; go up to N to see full degradation
        config = {"mode": "full", "N": 4096,
                  "K_list": [30, 100, 300, 627, 1000, 1500, 2000, 3000, 3500],
                  "seeds": [17, 23, 31, 41, 53]}
    print(f"wave14forensics_walsh_peaks. mode={config['mode']} device={device}", flush=True)
    ...
    out_dir = get_output_dir("wave14forensics_walsh_peaks")
