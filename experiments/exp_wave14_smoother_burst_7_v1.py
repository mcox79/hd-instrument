"""Smoother burst variant 7 — seed=7*7+30, larger N or K."""
...
def run_experiment(smoke):
    ...
    seed = 7*7 + 30
    K = 100 + 7*100  # K varies per variant
