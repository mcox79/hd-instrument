"""Bet B Alt 1: 4-class taxonomy N=4096 high-power (v2: 25 seeds).

PARENT: wave14_betB_nscaling_v1 MIDDLE at N=8192 (BIC_delta=-0.0036, too small).
v2 returns to N=4096 with 25 seeds for BIC statistical power to cross -30 threshold.
...
N_FULL = 4096      # v2: back to N=4096 with more seeds (v1 N=8192 gave MIDDLE)
N_SMOKE = 512
SEEDS_FULL = list(range(7, 32))  # v2: 25 seeds for strong BIC power
SEEDS_SMOKE = [17]
BATCH_SIZE_FULL = 64
BATCH_SIZE_SMOKE = 16
EPOCHS_FULL = 5
...
def _instrumentation_selftest():
    ...
    assert N_FULL == 4096, f"N_FULL should be 4096 for v2; got {N_FULL}"
...
def main():
    ...
    outdir = get_output_dir("wave14_betB_nscaling_v2")
