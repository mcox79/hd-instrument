...
ANCHOR_NAME = "multi_head_sparse_key_battery_long_gpu_v1"
...
if RUN_MODE == "smoke":
    ...
    SEEDS = [7, 17, 23, 29, 37, 41, 43, 47, 53, 59]; N_GRID = [4096, 8192, 16384, 32768]; LOADS = [0.02, 0.05, 0.1, 0.15, 0.2, 0.3, 0.45, 0.6, 0.8, 1.0]
