...
Pre-reg: preregs/2026-05-21_wave14_bet_f_label_cardinality_sweep.md
"""
...
N_LABELS = 32  # extends Sketch 1 (16 labels) to test 32-label substrate-coset capacity
...
def compute_verdict(summary):
    ...
    if not per_p:
        return ("BET_F_S1_INCONCLUSIVE", "Missing recovery data.")
    ...
    if rate_at_p005 >= PASS_RECOVERY and rate_at_p005 > ctrl_at_p005 + 0.15:
        return ("BET_F_S1_TOPOLOGY_PROTECTED",
...
def run_smoke():
    out_dir = get_output_dir("wave14_bet_f_label_cardinality_sweep_smoke")
...
def run_main():
    out_dir = get_output_dir("wave14_bet_f_label_cardinality_sweep")
