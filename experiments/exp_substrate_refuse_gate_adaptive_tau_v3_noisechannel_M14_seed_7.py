"""substrate_refuse_gate_adaptive_tau_v3_noisechannel_M14 sibling seed=7.

FIRST cell using M1.3 NoiseChannel. Closes M3 milestone M1.4.

v2 landed MIDDLE_BAND (adaptive arms tied FIXED at fixed-substrate; substrate
determinism is STRUCTURAL). Cortex NoiseChannel (shipped c5e5e66a) injects
stochastic coupling at boundary; adaptive arms now see intermediate-confidence-
band PDF.

4 ARMS (arms-must-differ): FIXED_V_REL_256 / SLIDING_WINDOW / BAYESIAN_CI /
PERCENTILE
...
CHUNKED single-seed-per-cell. SEED=7 pinned. Cortex-scoped torch.Generator
distinct from substrate numpy rng.
...
# Pinned seed
SEED = 7
ANCHOR_NAME = "substrate_refuse_gate_adaptive_tau_v3_noisechannel_M14_seed_%d" % SEED
...
CONFIG_VERSION = (
    "ANCHOR=%s,arms=[FIXED_V_REL_256,SLIDING_WINDOW,BAYESIAN_CI,PERCENTILE],"
...
def _write_minimal_metrics(out_dir: Path, verdict: str, verdict_msg: str,
    ...
    try:
        ...
        m = {
            ...
            "_hardening_marker": "v3_refuse_gate_adaptive_tau_noisechannel_M14_chunked",
        }
        if extra:
            m.update(extra)
...
def _write_import_crash_sentinel(exc: BaseException) -> None:
    try:
        ...
        s = {
            ...
            "_hardening_marker": "v3_refuse_gate_adaptive_tau_noisechannel_M14_import_crash",
        }
...
def main() -> int:
    ...
    from experiments._substrate_refuse_gate_adaptive_tau_v3_noisechannel_M14_core import (
        run_one_seed_v3, aggregate_and_verdict, selftest,
    ...
    for seed in remaining:
        _write_minimal_metrics(out_dir, "RUNNING",
                                ...
                                extra={"_phase": "seed_running",
                                       ...
                                       "backend": backend})
        t0 = time.time()
        result = run_one_seed_v3(seed, run_mode=RUN_MODE)
        result["N"] = N_used
    ...
    final["_hardening_marker"] = "v3_refuse_gate_adaptive_tau_noisechannel_M14_chunked"
    final["backend"] = backend
    final["seed"] = SEED
    final["n_seeds"] = 1
    final["corpus_provenance"] = ("synthetic_substrate_refuse_gate_v3_M14_"
                                    "cortex_noisechannel_temperature_softmax")
