...
OPQ-rotation core at seed=13 (the replicate seed used throughout this
lineage for chain-grade promotion). A runner-death on this process loses
only seed=13, not the sibling seed=7 run.

Core:
  experiments/exp_encoder_opq_rotation_v1_core.py
Prereg:
  preregs/2026-07-04_exp_encoder_opq_rotation_v1.md

run_tag="seed13" isolates this seed's mining shards + checkpoints + metrics
under data/substrate_concept_encoder_opq_rotation_seed13/.
...
from experiments import (  # noqa: E402
    exp_encoder_opq_rotation_v1_core as core,
)
...
def main() -> int:
    ...
    if "--smoke" in sys.argv:
        return core.run_rotation("smoke", SEED, "auto", core.v3.N_DIM_DEFAULT,
    ...
    if run_mode not in ("smoke", "full"):
        run_mode = "full"
    return core.run_rotation(run_mode, SEED, "auto", core.v3.N_DIM_DEFAULT,
                             None, run_tag=RUN_TAG)
