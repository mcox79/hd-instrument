"""Smoother burst variant 1 — seed=1*7+30, larger N or K."""
...
def run_experiment(smoke):
    ...
    seed = 1*7 + 30
    K = 100 + 1*100  # K varies per variant
