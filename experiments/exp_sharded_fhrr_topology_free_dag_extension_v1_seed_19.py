"""sharded_fhrr_topology_free_dag_extension_v1 seed=19 entry point.

Pre-reg: preregs/2026-07-02_sharded_fhrr_topology_free_dag_extension_v1.md
Core: exp_sharded_fhrr_topology_free_dag_extension_v1.py
...
_CORE = Path(__file__).with_name("exp_sharded_fhrr_topology_free_dag_extension_v1.py")
