"""
exp_t5c_kblam_disc_everylayer_gpu_v1 -- Tier-5c Path B FOUNDATION: KBLaM-pattern fact-KB adapter; HELD-OUT recall -- GPU.
...
ANCHOR_NAME = "t5c_kblam_disc_everylayer_gpu_v1"; MODEL = "EleutherAI/pythia-160m"; ENCODER = "BAAI/bge-large-en-v1.5"
...
def _selftest():
    ...
    print("[selftest] PASS: t5c-kblam-disc-everylayer-gpu-v1", flush=True)
