...
Pre-reg: preregs/2026-05-21_wave14r_multihop_N2048.md
"""
...
N_FULL = 2048  # small end of N scaling curve (below v3 baseline N=4096)
N_SMOKE = 512
...
def run_smoke():
    out_dir = get_output_dir("wave14r_multihop_N2048_smoke")
    log_event("experiment_started", name="wave14r_multihop_N2048", mode="smoke")
    ...
    log_event("experiment_outcome", name="wave14r_multihop_N2048",
              mode="smoke", verdict=verdict, verdict_msg=msg, elapsed_s=elapsed)
    print(f"\nSMOKE OK: {verdict}", flush=True)


def run_main():
    out_dir = get_output_dir("wave14r_multihop_N2048")
    log_event("experiment_started", name="wave14r_multihop_N2048", mode="full")
