"""
exp_pb_pinv_capacity_n_scaling_v1 -- propose-back (does pinv capacity stay alpha_c~1 across N) -- CPU.
...
ANCHOR_NAME = "pb_pinv_capacity_n_scaling_v1"
FLIP = 0.05; STEPS = 8
...
if RUN_MODE == "smoke":
    ...
    SEEDS = [7, 17, 23]; N_SWEEP = [512, 1024, 2048, 4096]; LOADS = [0.2, 0.4, 0.55, 0.7, 0.8, 0.85, 0.9, 0.95]
