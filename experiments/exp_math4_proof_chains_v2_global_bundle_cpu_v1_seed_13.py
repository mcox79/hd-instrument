"""math4_proof_chains_v2_global_bundle_cpu_v1 seed=13 entry point.

Pre-reg: preregs/2026-07_math4_proof_chains_v2_global_bundle_cpu_v1.md
Core: exp_math4_proof_chains_v2_global_bundle_cpu_v1.py
...
_CORE = Path(__file__).with_name("exp_math4_proof_chains_v2_global_bundle_cpu_v1.py")
