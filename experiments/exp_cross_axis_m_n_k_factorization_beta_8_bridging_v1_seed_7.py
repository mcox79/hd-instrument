"""cross_axis_m_n_k_factorization_beta_8_bridging_v1 -- seed_7.
...
PRIOR (substrate-KB 2026-07-01 concept-query at cosine < 0.33):
  ...
  - v2 (DIS_beta4) CG at beta=4 MEASURED@data/exp_cross_axis_m_n_k_discriminating_arm_v2_seed_7/metrics.json (3-seed CG)
...
ANCHOR_NAME = "cross_axis_m_n_k_factorization_beta_8_bridging_v1_seed_7"
SEED_THIS_CHUNK = 7
...
def _main() -> None:
    ...
    metrics = {
        ...
        "primitive_reference_v1_saturated": (
            "exp_cross_axis_m_n_k_2d_coarse_gpu_v1_seed_7 (Skunkworks demoted MM)"
        ),
        "cell_chunked": True,
