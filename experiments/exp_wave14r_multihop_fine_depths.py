...
Pre-reg: preregs/2026-05-21_wave14r_multihop_fine_depths.md
"""
...
NUM_FACTS_FULL = 100
NUM_FACTS_SMOKE = 20
HOP_DEPTHS_FULL = [1, 2, 3, 5, 8, 13, 20, 30, 45, 50]  # fine-grained to localize cliff
...
def run_smoke():
    out_dir = get_output_dir("wave14r_multihop_fine_depths_smoke")
    log_event("experiment_started", name="wave14r_multihop_fine_depths", mode="smoke")
    ...
    log_event("experiment_outcome", name="wave14r_multihop_fine_depths",
              mode="smoke", verdict=verdict, verdict_msg=msg, elapsed_s=elapsed)
    print(f"\nSMOKE OK: {verdict}", flush=True)


def run_main():
    out_dir = get_output_dir("wave14r_multihop_fine_depths")
    log_event("experiment_started", name="wave14r_multihop_fine_depths", mode="full")
