"""Wrapper: seed_7 entry-point for cortex_2 Phase 2 apply-probe v1.

Delegates to `exp_cortex_2_phase_2_apply_probe_v1_core.py`.
...
_CORE = Path(__file__).resolve().parent / "exp_cortex_2_phase_2_apply_probe_v1_core.py"
