"""
q_b1_chain_depth_100_v1_n16384 -- Q-B1: heteroassoc chain at depth-100 at N=16384.

Ceiling chase: depth-80 HARD_PASS recent cycle. Push to depth-100 to map degradation slope.
...
PRE-REGISTERED BANDS:
  ...
  Calibration: depth-80 HP set per prior cycle; depth-100 bands derived from empirical Q-B1 decay table (super-exponential, lambda 0.015 at low d rising to 0.040 at deep d). For d>80 extrapolated with lambda=0.030. HP=0.055; HF=0.05 (~2.5x below HP).
...
ANCHOR_NAME = "q_b1_chain_depth_100_v1_n16384"
...
def compute_verdict(results: List[Dict]) -> tuple:
    ...
    if hp5 and hp10 and hp20 and hp30 and hp45 and hpapex:
        return ("HARD_PASS", f"HARD_PASS: all depth thresholds met at N=16384 depth-100. {summary}")
