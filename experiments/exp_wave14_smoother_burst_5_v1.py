"""Smoother burst variant 5 — seed=5*7+30, larger N or K."""
...
def run_experiment(smoke):
    ...
    seed = 5*7 + 30
    K = 100 + 5*100  # K varies per variant
