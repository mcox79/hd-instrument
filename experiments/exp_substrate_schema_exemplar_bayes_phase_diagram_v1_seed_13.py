"""substrate_schema_exemplar_bayes_phase_diagram_v1 sibling seed=13.

Phase-diagram sweep of schema exemplar-Bayes (vmPFC analog) over
...
SWEEP: n_ex in {1,5,10,50,100} x n_classes in {2,5,10,50} x N in {2048,4096,8192} = 60 pts
CPU-only (numpy + scipy.special.logsumexp); no GPU needed.

PRE-REG: preregs/2026-06-28_substrate_schema_exemplar_bayes_phase_diagram_v1.md
CARDINALITY_OK_FULL: 3600 records per seed (60 pts x 3 arms x 20 queries)
...
SEED = 13
ANCHOR_NAME = f"substrate_schema_exemplar_bayes_phase_diagram_v1_seed_{SEED}"
...
CONFIG_VERSION = (
    ...
    f"n_ex=[1,5,10,50,100],n_classes=[2,5,10,50],N=[2048,4096,8192],"
    f"prior_strength=1.0,arms=[SCHEMA_BAYES,NEAREST_EXEMPLAR,UNIFORM_RANDOM],"
    f"expected_n_full=3600,expected_n_smoke=90,"
...
def _write_minimal_metrics(out_dir: Path, verdict: str, verdict_msg: str,
    ...
    try:
        ...
        m = {
            ...
            "_hardening_marker": "v1_schema_exemplar_bayes_phase_diagram_chunked",
        }
        if extra:
            m.update(extra)
...
def _write_import_crash_sentinel(exc: BaseException) -> None:
    try:
        ...
        s = {
            ...
            "_hardening_marker": "v1_schema_exemplar_bayes_phase_diagram_import_crash",
        }
...
def main() -> int:
    ...
    from experiments._substrate_schema_exemplar_bayes_phase_diagram_v1_core import (
    ...
    final["_hardening_marker"] = "v1_schema_exemplar_bayes_phase_diagram_chunked"
