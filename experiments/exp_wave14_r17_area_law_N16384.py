...
Pre-reg: preregs/2026-05-21_wave14_r17_area_law_N16384.md
"""
...
def run_experiment(smoke):
    ...
    config = {"mode": "smoke" if smoke else "full",
              "N": 512 if smoke else 16384,  # extreme-N follow-up to confirm area-law continues
...
def run_smoke():
    out_dir = get_output_dir("wave14_r17_area_law_N16384_smoke")
...
def run_main():
    out_dir = get_output_dir("wave14_r17_area_law_N16384")
