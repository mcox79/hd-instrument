"""substrate_schema_exemplar_bayes_capacity_stress_v3 sibling seed=7.

v3 CHAIN-GRADE REVIVAL of v2 MM (3-seed). Per Skunkworks recommendation:
  (a) tighten alpha range (drop n_cl=500 extreme FLOOR; add n_cl=100)
  (b) >=5 seeds (5 sibling files)
  (c) HP threshold UNCHANGED at 0.05 (5-seed mean+majority is the chain-grade gate)
...
PRE-REG: preregs/2026-06-28_substrate_schema_exemplar_bayes_capacity_stress_v3.md
...
SEED = 23
ANCHOR_NAME = f"substrate_schema_exemplar_bayes_capacity_stress_v3_seed_{SEED}"
...
CONFIG_VERSION = (
    ...
    f"expected_n_full=3840,expected_n_smoke=90,n_seeds_v3=5,"
...
def _write_minimal_metrics(out_dir: Path, verdict: str, verdict_msg: str,
    ...
    try:
        ...
        m = {
            ...
            "_hardening_marker": "v3_schema_exemplar_bayes_capacity_stress_chunked",
        }
        if extra:
            m.update(extra)
...
def _write_import_crash_sentinel(exc: BaseException) -> None:
    try:
        ...
        s = {
            ...
            "_hardening_marker": "v3_schema_exemplar_bayes_capacity_stress_import_crash",
        }
...
def main() -> int:
    ...
    from experiments._substrate_schema_exemplar_bayes_capacity_stress_v3_core import (
    ...
    final["_hardening_marker"] = "v3_schema_exemplar_bayes_capacity_stress_chunked"
