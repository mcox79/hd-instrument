"""
exp_t5c_g_pythia160m_8layer_v1 -- Tier-5c Phase C: multi-layer Flamingo adapter continued training (LOCAL 4060 Ti) -- GPU.
...
ANCHOR_NAME = "t5c_g_pythia160m_8layer_v1"; MODEL = "EleutherAI/pythia-160m"; LAYERS = [2,3,4,5,6,7,8,9]
...
def _selftest():
    ...
    print("[selftest] PASS: g-pythia160m-8layer", flush=True)
