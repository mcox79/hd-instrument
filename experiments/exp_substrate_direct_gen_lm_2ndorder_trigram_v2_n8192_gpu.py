"""
substrate_direct_gen_lm_2ndorder_trigram_v2_n8192_gpu -- substrate-direct LM that BEATS bigram baseline (GPU).
...
ANCHOR_NAME = "substrate_direct_gen_lm_2ndorder_trigram_v2_n8192_gpu"
...
def run_seed(seed: int, n_dim: int) -> Dict:
    ...
    # count baselines (numpy on full ids)
    tn = ids[:sp]
    ...
    ve = ids[sp:]; nb = min(2000, len(ve) - 2)
