"""
exp_multi_head_sparse_key_M2_v1 -- propose-back: multi-head M-sweep at production sparsity (where does MMV gain saturate) -- CPU.
...
ANCHOR_NAME = "pb_multihead_M_sweep_production_v1"
HEADS = [1, 2, 4, 8]; F_SPARSE = 0.05; FLIP = 0.05
