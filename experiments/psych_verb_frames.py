...
Build the transitivity prior:  .venv/Scripts/python.exe experiments/psych_verb_frames.py --build
"""
...
ASSET = os.path.join(REPO, "data/psych_verb_frames_v1/psych_verb_transitivity_ud_ewt.json")
