...
Pre-reg: preregs/2026-05-21_wave14d_multi_task_cl_v10_lowreplay.md
"""
...
REPLAY_FRAC = 0.05  # v9 maximum replay; compound with EMA
...
def run_smoke():
    out_dir = get_output_dir("wave14d_multi_task_cl_v10_lowreplay_smoke")
...
def run_main():
    out_dir = get_output_dir("wave14d_multi_task_cl_v10_lowreplay")
