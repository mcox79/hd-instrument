...
ANCHOR_NAME = "substrate_native_reasoning_K10_K20_n16384_v1"
_N_SUFFIX = 16384; N = 16384; assert N == _N_SUFFIX
RUN_MODE = ("smoke" if "--smoke" in sys.argv else os.environ.get("HDLAB_RUN_MODE", "full")).lower()
_ap = argparse.ArgumentParser(); _ap.add_argument("--smoke", action="store_true"); _ap.add_argument("--self-test", action="store_true"); _ARGS, _ = _ap.parse_known_args()
if RUN_MODE == "smoke":
    SEEDS = [1, 2]; N_DIM = 1024; V_C = 300; CHAINS = 150; KS = [1, 2, 3, 5]
else:
    SEEDS = [7, 17, 23]; N_DIM = 16384; V_C = 4000; CHAINS = 250; KS = [1, 3, 5, 8, 10, 15, 20]
...
def _selftest():
    ...
    assert N == 16384; print("[selftest] PASS: 1hop 2hop", flush=True)
...
def run_seed(seed) -> Dict:
    ...
    return {"seed": seed, "acc_by_k": acc_by_k, "k3_acc": acc_by_k.get("k3", 0.0), "k10_acc": acc_by_k.get("k10", 0.0)}
