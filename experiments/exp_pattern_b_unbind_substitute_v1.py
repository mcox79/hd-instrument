"""
exp_pattern_b_unbind_substitute_v1 -- Pattern B Phase-1 algebra: VSA filler substitution + retrieval -- CPU.
...
ANCHOR_NAME = "pattern_b_unbind_substitute_v1"; N = 1024
...
def run() -> Dict:
    ...
    for k in BINDINGS:
        ...
        print("  bindings=%d substitution_retrieval_acc=%.3f" % (k, acc), flush=True)
...
def verdict(r) -> Tuple[str, str]:
    ...
    if a4 >= 0.95:
        return ("HARD_PASS", "HARD_PASS: VSA filler substitution + retrieval >=0.95 at 4 bindings -- Pattern B substitution is reliable; substrate-native compositional editing works. " + summary)
    if a4 >= 0.85:
