"""substrate_refuse_gate_v8_conformal_v1 sibling seed=19.

v8 SURGICAL FIX from v7: vary the cal SOURCE (regime), not alpha on same source.
See _substrate_refuse_gate_v8_conformal_v1_core.py docstring for full context.
