"""
q_a3_l62_cross_layer_composition_v1_n8192 -- Q-A3/PP-12: L=61 cross-layer composition at N=8192.

CONTEXT (v375 cycle 44 all-night burst):
  N=8192 series: L=19..L=51 all EXACT-1.0000.
  L=55 is rung 36 in the N=8192 depth ladder.
...
SCIENTIFIC QUESTION:
  Does cross-layer composition fidelity remain EXACT-1.0 at L=52 N=8192?
  If yes: extends N=8192 cross-N series to L=52 (cross-N at L=52).
...
FORMULA SELF-TESTS (PROT-022):
  1. L=51 chain: 57-ctx Hadamard roundtrip recovers xi_L1.
...
ANCHOR_NAME = "q_a3_l62_cross_layer_composition_v1_n8192"
