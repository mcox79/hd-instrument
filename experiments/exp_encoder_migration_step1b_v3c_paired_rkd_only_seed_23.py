...
core at seed=23 to extend the in_batch-RKD-only-NCE-off robustness evidence
(seeds 7/13 already landed; this adds a 3rd seed for the best-ckpt-stability
audit). A runner-death on this process loses only seed=23.
...
run_tag="seed23" isolates this seed's mining shards + checkpoints + metrics
under data/substrate_concept_encoder_v1b_v3c_full_paired_seed23/.
