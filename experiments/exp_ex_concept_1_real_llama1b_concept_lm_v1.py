"""
ex_concept_1_real_pythia_concept_lm_v1 -- EX-CONCEPT-1 REAL at LLAMA-3.2-1B: substrate next-concept-LM on REAL Llama-1B tokens (Phase 2) -- CPU.
...
ANCHOR_NAME = "ex_concept_1_real_llama1b_concept_lm_v1"
