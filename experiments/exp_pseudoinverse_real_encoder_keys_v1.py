"""
exp_pseudoinverse_real_encoder_keys_v1 -- propose-back follow-on to Batch E Cell 2 (pseudoinverse 8x) -- CPU.
...
ANCHOR_NAME = "pseudoinverse_real_encoder_keys_v1"
...
def verdict(ps) -> Tuple[str, str]:
    ...
    summary = "on real whitened MiniLM keys: hebb_alpha_c=%.3f pinv_alpha_c=%.3f | pinv vs hebb: %s (synthetic was 8x)" % (h, pv, ratio_txt)
