"""
substrate_capacity_composition_full_b2xb4xhier_v3_n4096_gpu -- full capacity-axis composition M_crit (GPU).
...
ANCHOR_NAME = "substrate_capacity_composition_full_b2xb4xhier_v3_n4096_gpu"
...
if RUN_MODE == "smoke":
    ...
    N_DIM = N; N_DG = N * 4; SEEDS = [7, 17, 23]; M_DENSE = [60, 150, 300, 450]; M_SPARSE = [600, 1800, 5400, 12000, 24000]
...
def _selftest():
    ...
    assert N == 4096; print("[selftest] PASS: sparse_completion dense_recall", flush=True)
