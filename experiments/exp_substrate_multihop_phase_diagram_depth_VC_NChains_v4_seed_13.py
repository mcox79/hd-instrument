"""substrate_multihop_phase_diagram_depth_VC_NChains_v4_seed_13

CHUNKED phase-diagram cell (seed=13). Thin wrapper around
experiments._multihop_phase_diagram_v4_base.run_one_seed(seed=13).
...
try:
    ...
    sentinel = {
        "anchor_name": "substrate_multihop_phase_diagram_depth_VC_NChains_v4_seed_13",
        "verdict": "UNKNOWN",
