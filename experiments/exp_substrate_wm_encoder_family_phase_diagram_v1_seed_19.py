"""substrate_wm_encoder_family_phase_diagram_v1 sibling seed=13.

See seed_7 module docstring for full description. This file is the seed=13
sibling; only SEED differs.
