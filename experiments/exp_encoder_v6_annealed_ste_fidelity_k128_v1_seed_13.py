...
annealed-STE gradient-fidelity nested ablation at K=128 for seed=13. A
runner-death on this process loses only seed=13, not the sibling seed=7 run.
...
data/substrate_concept_encoder_v6_annealste_seed13/ and the seed-suffixed dir.
