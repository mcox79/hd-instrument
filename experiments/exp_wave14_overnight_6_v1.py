"""Overnight experiment variant 6 — heavy multi-condition smoother sweep with high trial count."""
...
def run_experiment(smoke):
    ...
    seed = 6 * 100 + 7
    # Variant 6 varies: smaller N, different K and depth combos
    Ns = [4096, 16384, 65536]
    ...
    summary = {"results": results, "seed": seed, "variant": 6}
    verdict, msg = compute_verdict(summary)
    return summary, verdict, msg, time.monotonic()-t0, {"smoke":smoke,"seed":seed,"variant":6}
