"""
q_a3_l30_cross_layer_composition_v1_n8192 -- Q-A3/PP-12: L=30 cross-layer composition at N=8192.
...
CONTEXT (v368 refill cycle):
  ...
  L=30 is the 10th rung in the N=8192 cross-N depth ladder.

SCIENTIFIC QUESTION:
  Does cross-layer composition fidelity remain EXACT-1.0 at L=30 N=8192?
  If yes: extends N=8192 cross-N series to L=30 (2-N cross-N {N=4096+N=8192} at L=30).

MEMORY ESTIMATE (on-demand W):
  One W matrix at a time: 8192 x 8192 x 4 bytes = 268 MB. Well within 8 GB GPU.

PRE-REGISTERED BANDS (Q-A3 L=30 N=8192):
...
TIMEOUT ESTIMATE: L=29 N=8192 elapsed ~4s (5-seed). L=30 near-linear.
...
ANCHOR_NAME = "q_a3_l30_cross_layer_composition_v1_n8192"
...
# M_MID: 28 entries for L2..L29, M_OUTER = L30
# Total layers: 1 (L1=M_INNER) + 28 (M_MID) + 1 (M_OUTER=L30) = 30 = L_DEPTH
