"""substrate_hypothesis_gen_pipeline_composition_v1_seed_7 -- M3 concern #1 functional-requirement-first composition test (single-seed chunk).
...
ANCHOR_NAME = "substrate_hypothesis_gen_pipeline_composition_v1_seed_7"
SEED_THIS_CHUNK = 7
