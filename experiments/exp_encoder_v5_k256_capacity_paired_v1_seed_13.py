"""Thin per-seed wrapper (CHUNKED single-seed-per-cell): runs the shared v5
K-capacity core at seed=13 (the replicate seed, matching this lineage's own
convention). A runner-death on this process loses only seed=13, not the
sibling seed=7 run (exp_encoder_v5_k256_capacity_paired_v1_seed_7.py).

Core: experiments/exp_encoder_v5_k256_capacity_paired_v1_core.py
