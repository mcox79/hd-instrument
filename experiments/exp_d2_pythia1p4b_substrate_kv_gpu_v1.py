"""
exp_pythia_substrate_memory_mve_gpu_v1 -- D2 (Tier-5 scale): substrate-KV memory keyed by Pythia-1.4B hidden states -- GPU.
...
ANCHOR_NAME = "d2_pythia1p4b_substrate_kv_gpu_v1"; MODEL = "EleutherAI/pythia-1.4b"
...
def _selftest():
    ...
    print("[selftest] PASS: d2-pythia1p4b-substrate-kv", flush=True)
