"""
q_a3_l64_cross_layer_composition_v1_n16384 -- Q-A3/PP-12: L=64 cross-layer composition at N=16384.

CONTEXT (v372 cycle 41 batch):
  N=16384 series: L=20..L=63 all EXACT-1.0000 (L=63 NEW DEEPEST project history v372).
  L=64 is rung 45 in the N=16384 depth ladder.
...
ANCHOR_NAME = "q_a3_l64_cross_layer_composition_v1_n16384"
...
if RUN_MODE == "smoke":
    ...
    SEEDS = [7, 17]
    M_INNER = 20
    # 62 middle layers (L2..L63), then M_OUTER=L64
...
# M_MID: 62 entries for L2..L63, M_OUTER = L64
# Total layers: 1 (L1=M_INNER) + 62 (M_MID) + 1 (M_OUTER=L64) = 64 = L_DEPTH
