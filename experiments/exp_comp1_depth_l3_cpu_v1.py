"""
exp_comp1_depth_l3_cpu_v1.py -- compositional depth L=3 retrieval (first cliff gate) -- CPU.

ROUTING: Research COMP_DEPTH_GATING / COMP_OVERCOME_BARRIER_BATCH (COMP-1 DEPTH-L3); pure-FHRR (no download). Bind K=10 L2 shards into an L3 composite; retrieve a leaf with hierarchical cleanup. Is L=3 the cliff?
...
PRE-REGISTERED: HARD-PASS recall>=0.90 at L=3 K=10. MIDDLE within 0.20. HARD-FAIL else.
...
ANCHOR_NAME = "comp1_depth_l3_cpu_v1"
