...
instruction file section 13): runs the shared v4 convergence core at seed=7
(matches the whole v3/v3c/v3e lineage's primary seed for direct
comparability, and matches the specific v3e seed7 landed run this cell's
COSINE arm is a Gate-D positive-control reproduction of).

Core (all training/eval/verdict logic lives here; not duplicated):
  experiments/exp_encoder_v4_convergence_lr_hold_v1_core.py
Prereg:
  preregs/2026-07-04_exp_encoder_v4_convergence_lr_hold_v1.md
...
from experiments import (  # noqa: E402
    exp_encoder_v4_convergence_lr_hold_v1_core as core,
)
...
def main() -> int:
    ...
    if "--smoke" in sys.argv:
        return core.run_convergence("smoke", SEED, "auto", core.v3.N_DIM_DEFAULT,
    ...
    if run_mode not in ("smoke", "full"):
        run_mode = "full"
    return core.run_convergence(run_mode, SEED, "auto", core.v3.N_DIM_DEFAULT,
                                None, run_tag=RUN_TAG)
