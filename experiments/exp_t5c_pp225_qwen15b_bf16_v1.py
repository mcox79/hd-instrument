"""
exp_t5c_pp225_qwen15b_bf16_v1 -- Path B rescue R3: supervised projection head (bypass cross-attn) -- GPU.
...
ANCHOR_NAME = "t5c_pp225_qwen15b_bf16_v1"; MODEL = "Qwen/Qwen2.5-1.5B-Instruct"; ENCODER = "BAAI/bge-large-en-v1.5"
...
def _selftest():
    ...
    assert int(_n.argmax([0.1, 0.9])) == 1, "argmax"; print("[selftest] PASS: pp225-qwen15b-bf16", flush=True)
