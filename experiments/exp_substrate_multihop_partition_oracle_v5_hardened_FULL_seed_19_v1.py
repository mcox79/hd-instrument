...
ANCHOR_NAME = "substrate_multihop_partition_oracle_v5_hardened_FULL_seed_19_v1"
_LLM_CALL_COUNTER = [0]
...
def _selftest() -> None:
    ...
    # T9: anchor binding
    assert "_hardened_" in ANCHOR_NAME and ANCHOR_NAME.endswith("_v1") and "_seed_19_" in ANCHOR_NAME
...
if __name__ == "__main__":
    ...
    metrics = {
        ...
        "DESIGN_NOTE": (
            ...
            "BIAS-Q saturation @0.95 (tightened); Fix #28 per-arm reads. CHUNKED single-seed-per-cell sibling (seed=19); 3-cell redundancy strategy against runner-zombie episodes (USER 2026-06-28 chunked directive). Source HARD_PASS smoke: data/exp_substrate_multihop_partition_oracle_v5_hardened_v1_smoke/metrics.json (BASELINE_A=0.39 ORACLE_B=0.90 lift=0.51 unsat)."
        ),
    }
