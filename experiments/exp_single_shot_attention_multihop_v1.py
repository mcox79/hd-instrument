"""
exp_substrate_vs_bare_llm_hotpot_v1 -- single-shot joint-attention multi-hop confirmation: single-shot top-k + Qwen attends both hops in ONE pass -- GPU.
...
ANCHOR_NAME = "single_shot_attention_multihop_v1"
