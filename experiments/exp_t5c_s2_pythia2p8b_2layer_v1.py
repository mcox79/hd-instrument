"""
exp_t5c_s2_pythia2p8b_2layer_v1 -- Tier-5c Phase C: multi-layer Flamingo adapter continued training (LOCAL 4060 Ti) -- GPU.
...
ANCHOR_NAME = "t5c_s2_pythia2p8b_2layer_v1"; MODEL = "EleutherAI/pythia-2.8b"; LAYERS = [15, 16]
...
def _selftest():
    ...
    print("[selftest] PASS: s2-pythia2p8b-2layer", flush=True)
