...
Pre-reg: preregs/2026-05-21_wave14r_multihop_FHRR_v1.md
"""
...
def run_smoke():
    out_dir = get_output_dir("wave14r_multihop_FHRR_v1_smoke")
...
def run_main():
    out_dir = get_output_dir("wave14r_multihop_FHRR_v1")
