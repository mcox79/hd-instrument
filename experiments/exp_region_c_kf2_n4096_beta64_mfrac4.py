"""PHASE REGION C -- KF-2 variant: M_frac=4, beta=64 at N=4096.

Identical physics probe to region_c_kf1; uses same Kerdock substrate.
KF-2 labeling reflects the cross-codebook isolation lineage.
Runs in same overnight_queue slot for comparison. Results should match kf1.

N-suffix: _n4096 -> production N = 4096 (PROT-018 binding).
Anchor: region_c_kf2_n4096_beta64_mfrac4
Queue: overnight_queue
Pre-reg: preregs/2026-05-29_phase_region_cd_n4096.md
Parent: phase_region_cd_v1_n4096; kf2_cross_codebook_v2_n8192 (v268 HARD_PASS)
"""
...
_drv_spec = importlib.util.spec_from_file_location("phcd_drv_rc_kf2", _drv_path)
...
HP_RET_MIN = _drv.HP_RETENTION_C_MIN
HF_RET_MAX = _drv.HF_RETENTION_C_MAX
HP_SEEDS   = _drv.HP_SEEDS_C_MIN


def get_output_dir() -> Path:
    name = os.environ.get("HDLAB_EXP_NAME", "region_c_kf2_n4096_beta64_mfrac4")
...
def _instrumentation_selftest() -> None:
    ...
    print(f"[selftest] region_c_kf2_n4096_beta64_mfrac4 PASS "
...
def main():
    ...
    print(f"[run] region_c_kf2_n4096_beta64_mfrac4 smoke={smoke} N={N_cfg} "
