...
Pre-reg: preregs/2026-05-21_wave14_continual_8N_2000edits.md
"""
...
def run_experiment(smoke):
    ...
    config = {"mode": "smoke" if smoke else "full", "N": 1024 if smoke else 4096,
              "M_stored": 2048 if smoke else 32768,  # M=8N (max for 32-coset Kerdock)
              "n_edits": 10 if smoke else 2000,  # 5x continual stress at max M
...
def run_smoke():
    out_dir = get_output_dir("wave14_continual_8N_2000edits_smoke")
...
def run_main():
    out_dir = get_output_dir("wave14_continual_8N_2000edits")
