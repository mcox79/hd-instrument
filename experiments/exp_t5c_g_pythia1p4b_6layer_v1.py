"""
exp_t5c_g_pythia1p4b_6layer_v1 -- Tier-5c Phase C: multi-layer Flamingo adapter continued training (LOCAL 4060 Ti) -- GPU.
...
ANCHOR_NAME = "t5c_g_pythia1p4b_6layer_v1"; MODEL = "EleutherAI/pythia-1.4b"; LAYERS = [8,9,10,11,12,13]
...
def _selftest():
    ...
    print("[selftest] PASS: g-pythia1p4b-6layer", flush=True)
