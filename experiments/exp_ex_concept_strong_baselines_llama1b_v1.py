"""
ex_concept_1_strong_baselines_and_variants_v1 -- Phase 2: EX-CONCEPT strong baselines (trigram+neural) on REAL Llama-1B concepts -- GPU.
...
ANCHOR_NAME = "ex_concept_strong_baselines_llama1b_v1"
