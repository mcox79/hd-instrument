"""substrate_partition_oracle_brain_composition_hint_v1 (seed=7).
...
ANCHOR_NAME = "substrate_partition_oracle_brain_composition_hint_v1_seed_7"
_LLM_CALL_COUNTER = [0]
...
CONFIG_VERSION = (
    "ANCHOR=%s,substratePartOracleBrainCompV1Seed7: N=%d V_C=%d V_P=%d depth=%d "
...
def _selftest() -> None:
    ...
    # T15: anchor binding (seed=7 sibling)
...
if __name__ == "__main__":
    ...
    metrics = {
        ...
        "DESIGN_NOTE": (
            ...
            "single-seed sibling (seed=7); siblings seed=13 and seed=19 "
