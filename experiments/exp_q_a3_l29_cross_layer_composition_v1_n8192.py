"""
q_a3_l29_cross_layer_composition_v1_n8192 -- Q-A3/PP-12: L=29 cross-layer composition at N=8192.

CONTEXT (v367 refill cycle):
  N=4096 series: L=2..L=35 all EXACT-1.0000.
  N=8192: L=19, L=22..L=28 all HARD_PASS EXACT-1.0000 (v367 recent L=27/L=28 completed).
  L=29 is the 9th rung in the N=8192 cross-N depth ladder.

SCIENTIFIC QUESTION:
  Does cross-layer composition fidelity remain EXACT-1.0 at L=29 N=8192?
  If yes: extends N=8192 cross-N confirmation to L=29 (2-N cross-N {N=4096+N=8192} at L=29).

MEMORY ESTIMATE (on-demand W):
  One W matrix at a time: 8192 x 8192 x 4 bytes = 268 MB. Well within 8 GB GPU.

PRE-REGISTERED BANDS (Q-A3 L=29 N=8192):
...
TIMEOUT ESTIMATE: L=28 N=8192 FULL elapsed ~3s (5-seed). L=29 near-linear.
  ceil(1.5 * 4 * 1.0 * 5) = ceil(30) -> 300s.
"""
import sys
...
ANCHOR_NAME = "q_a3_l29_cross_layer_composition_v1_n8192"
...
# M_MID: 27 entries for L2..L28, M_OUTER = L29
# Total layers: 1 (L1=M_INNER) + 27 (M_MID) + 1 (M_OUTER=L29) = 29 = L_DEPTH
