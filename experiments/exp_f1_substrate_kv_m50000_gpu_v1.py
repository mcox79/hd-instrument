"""
exp_pythia_substrate_memory_mve_gpu_v1 -- F1 Tier-5a capacity ceiling probe (M=50000): substrate-KV memory keyed by Pythia-2.8B (3B-class) hidden states -- GPU.
...
ANCHOR_NAME = "f1_substrate_kv_m50000_gpu_v1"; MODEL = "EleutherAI/pythia-2.8b"
RUN_MODE = ("smoke" if "--smoke" in sys.argv else os.environ.get("HDLAB_RUN_MODE", "full")).lower()
_ap = argparse.ArgumentParser(); _ap.add_argument("--smoke", action="store_true"); _ap.add_argument("--self-test", action="store_true"); _ARGS, _ = _ap.parse_known_args()
SMOKE = RUN_MODE == "smoke"
M = 1000 if SMOKE else 50000; NOISE = 0.10; IN_CONTEXT_CEIL = 64
...
def _selftest():
    ...
    print("[selftest] PASS: f1-substrate-kv-m50000", flush=True)
