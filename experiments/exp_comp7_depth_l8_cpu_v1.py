"""
exp_comp7_depth_l8_cpu_v1.py -- compositional depth L=8 (extreme; asymptote) -- CPU.

ROUTING: Research COMP_OVERCOME_BARRIER_BATCH P1 (COMP-7 DEPTH-L8); pure-FHRR (no download). L=8 K=10 retrieval with hierarchical cleanup; maps asymptote (where humans typically max out).
...
PRE-REGISTERED: HARD-PASS recall>=0.30 at L=8 (informational asymptote). MIDDLE within 0.20. HARD-FAIL else.
...
ANCHOR_NAME = "comp7_depth_l8_cpu_v1"
