...
ANCHOR_NAME = "pp155_hp_rescue_n32768_cpu_v1"
...
def _selftest():
    import numpy as _n; assert abs(_n.corrcoef([1.0, 2, 3], [1.0, 2, 3])[0, 1] - 1.0) < 1e-9, "corr"; print("[selftest] PASS: pp155-hp-rescue-n32768", flush=True)
def run() -> Dict:
    g = np.random.default_rng(202); N = 32768; VK = 80; VV = 400; TR = 60 if SMOKE else 200
