...
core at seed=31 to extend the in_batch-RKD-only-NCE-off robustness evidence
(seeds 7/13/23/29; this adds a 5th seed for the best-ckpt-stability audit).
A runner-death on this process loses only seed=31.
...
run_tag="seed31" isolates this seed's mining shards + checkpoints + metrics
under data/substrate_concept_encoder_v1b_v3c_full_paired_seed31/.
