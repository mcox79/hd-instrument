"""
q_a3_l38_cross_layer_composition_v1_n16384 -- Q-A3/PP-12: L=38 cross-layer composition at N=16384.

CONTEXT (v363 refill cycle):
  N=4096 series: L=2..L=35 all EXACT-1.0000 (21st consecutive streak).
  N=16384: L=20..L=36 all HARD_PASS (18 rungs confirmed). L=37 in current batch.
  L=38 is the 19th rung in the N=16384 depth ladder.

SCIENTIFIC QUESTION:
  Does cross-layer composition fidelity remain EXACT-1.0 at L=38 N=16384?

PRE-REGISTERED BANDS (PP-12/Q-A3 L=38 N=16384):
...
TIMEOUT ESTIMATE: L=36 elapsed~15s (5-seed estimate); L=38 scales linearly.
...
ANCHOR_NAME = "q_a3_l38_cross_layer_composition_v1_n16384"
