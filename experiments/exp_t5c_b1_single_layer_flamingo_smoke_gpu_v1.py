...
ROUTING: TIER5C_FULL_ROADMAP Phase B decisive smoke (Research AUTHORIZE, <1 GPU-hr). The categorical Tier-5c decision: insert ONE
...
ANCHOR_NAME = "t5c_b1_single_layer_flamingo_smoke_gpu_v1"; MODEL = "EleutherAI/pythia-160m"; LAYER = 6
STEPS = 40 if "--smoke" in sys.argv else 150
RUN_MODE = ("smoke" if "--smoke" in sys.argv else os.environ.get("HDLAB_RUN_MODE", "full")).lower()
_ap = argparse.ArgumentParser(); _ap.add_argument("--smoke", action="store_true"); _ap.add_argument("--self-test", action="store_true"); _ARGS, _ = _ap.parse_known_args()
SMOKE = RUN_MODE == "smoke"
N_TRAIN = 16 if SMOKE else 48; N_EVAL = 12 if SMOKE else 32
...
def _selftest():
    ...
    print("[selftest] PASS: t5c-b1-single-layer-flamingo-smoke", flush=True)
