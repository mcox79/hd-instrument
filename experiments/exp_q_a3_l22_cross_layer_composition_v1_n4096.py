"""
q_a3_l22_cross_layer_composition_v1_n4096 -- Q-A3: L=22 cross-layer composition at N=4096.

Ceiling chase: L=21 HARD_PASS EXACT-1.0000 unanimous 5/5 (v353). 7 consecutive L-extensions
(L=15..L=21) all EXACT-1.0000 at N=4096. L-ceiling has NOT been found. L=22 is the next step.
22 W matrices x ~67 MB each = ~1474 MB total. Fits in 8 GB GPU with margin.

Note: M per stage halves each level per isochoric design; alpha_c constraint ensures validity.
At L=22 M_OUTER=2, M_MID21=2, ..., M_MID7=2 (floored at 2 from L=7+).

PRE-REGISTERED BANDS (ceiling push, prior L=21 EXACT-1.0 unanimous; L=22 expected same):
  ...
  HARD-FAIL: any L_fid < 0.85 OR l22_acc < 0.5. Ceiling found at L=22.
...
QUEUE: overnight_queue (GPU; 22 W matrices at N=4096 ~1474 MB).
"""
import sys
...
ANCHOR_NAME = "q_a3_l22_cross_layer_composition_v1_n4096"
