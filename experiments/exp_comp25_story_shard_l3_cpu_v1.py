"""
exp_comp25_story_shard_l3_cpu_v1.py -- story shards (~500 atoms) retrieved by theme -- CPU.

ROUTING: Research COMP_DIRECTION_CONFIRMED P5 (COMP-25 STORY-SHARD-L3); pure-FHRR (no download). 100 story composites (~500 atoms each); retrieve by theme among all stories.
...
PRE-REGISTERED: HARD-PASS theme-retrieval >=0.85 on 100 stories. MIDDLE within 0.15. HARD-FAIL else.
...
ANCHOR_NAME = "comp25_story_shard_l3_cpu_v1"
...
NSHARD = 100; MBODY = 500; NFEAT = 3; BAR = 0.85; LABEL = "STORY"
def _selftest():
