...
Pre-reg: preregs/2026-05-21_wave14_continual_32N_kerdock_only.md
"""
...
def run_experiment(smoke):
    ...
    config = {"mode": "smoke" if smoke else "full", "N": 1024 if smoke else 4096,
              "M_stored": 2048 if smoke else 131072,  # full = 32N (32-coset Kerdock supports 32N)
...
def run_smoke():
    out_dir = get_output_dir("wave14_continual_32N_kerdock_only_smoke")
...
def run_main():
    out_dir = get_output_dir("wave14_continual_32N_kerdock_only")
