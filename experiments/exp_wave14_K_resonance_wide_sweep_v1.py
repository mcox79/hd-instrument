...
def run_experiment(smoke):
    ...
    cfg = {"N":8192 if smoke else 65536,
           "K_grid":[500, 1000, 2000] if smoke else [64, 128, 256, 500, 750, 1000, 1500, 2000, 2500, 3000, 4000, 5000, 8000, 10000],
...
def run_smoke():
    out_dir = get_output_dir("wave14_K_resonance_wide_sweep_v1_smoke")
...
def run_main():
    out_dir = get_output_dir("wave14_K_resonance_wide_sweep_v1")
