...
ANCHOR_NAME = "legal_citation_1000seed_cpu_v1"
...
def _selftest():
    ...
    assert np.allclose(a * R * b * np.conj(a * R), b, atol=1e-3), "bind/unbind"; print("[selftest] PASS: legal-citation-1000seed", flush=True)
def run() -> Dict:
    g = np.random.default_rng(82); N = 8192; VC = 1200 if SMOKE else 4000; AVG = 3; NSEED = 150 if SMOKE else 1000; THRESH = 0.18
