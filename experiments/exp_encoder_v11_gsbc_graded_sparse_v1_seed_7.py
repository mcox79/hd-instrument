...
graded-code cell for seed=7. A runner-death on this process loses only seed=7,
not the sibling seed=13 run.
...
data/substrate_concept_encoder_v11_gsbc_seed7/ and the seed-suffixed dir.
