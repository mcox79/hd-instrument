"""
exp_t5c_gpu_t5c3_6layer_pythia160m_v1 -- Tier-5c Phase C: multi-layer Flamingo adapter continued training (LOCAL 4060 Ti) -- GPU.
...
ANCHOR_NAME = "t5c_gpu_t5c3_6layer_pythia160m_v1"; MODEL = "EleutherAI/pythia-160m"; LAYERS = [3, 4, 5, 6, 7, 8]
...
def _selftest():
    ...
    print("[selftest] PASS: gpu-t5c3-6layer", flush=True)
