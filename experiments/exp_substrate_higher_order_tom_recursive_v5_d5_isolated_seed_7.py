"""Seed=7 wrapper for substrate_higher_order_tom_recursive_v5_d5_isolated.
...
# Set HDLAB_EXP_NAME so the core cell's _seed_match auto-detects seed=7.
# The core cell already parses --seed and HDLAB_EXP_NAME ending in _seed_<N>.
...
# Inject --seed 7 if not already in argv (defensive)
if not any(a == "--seed" for a in sys.argv):
    sys.argv.extend(["--seed", "7"])
