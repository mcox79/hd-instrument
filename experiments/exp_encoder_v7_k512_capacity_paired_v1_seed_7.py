...
instruction file section 13): runs the shared v7 K-capacity core at seed=7
(matches the whole v3/v3c/v3e/v4/v5/v6 lineage's primary seed for direct
comparability).

Core (all training/eval/verdict logic lives here; not duplicated):
  experiments/exp_encoder_v7_k512_capacity_paired_v1_core.py
Prereg:
  preregs/2026-07-04_exp_encoder_v7_k512_capacity_paired_v1.md
