"""
q_a3_l83_cross_layer_composition_v1_n8192 -- Q-A3/PP-12: L=83 cross-layer composition at N=8192.

CONTEXT (v379 cycle 49 all-night burst):
  N=8192 series continues depth ladder past L=80 (HARD_PASS).
  Per-stage alpha = 100/8192 = 0.0122 << alpha_c=0.138.

PRE-REGISTERED BANDS (Q-A3 L=83 N=8192):
...
ANCHOR_NAME = "q_a3_l83_cross_layer_composition_v1_n8192"
_N_SUFFIX = 8192
N = 8192
