"""Smoother burst variant 4 — seed=4*7+30, larger N or K."""
...
def run_experiment(smoke):
    ...
    seed = 4*7 + 30
    K = 100 + 4*100  # K varies per variant
