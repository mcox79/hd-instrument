"""
exp_t5c_c1_multilayer_flamingo_train_gpu_v1 -- Tier-5c Phase C: multi-layer Flamingo adapter continued training (LOCAL 4060 Ti) -- GPU.
...
def _selftest():
    ...
    print("[selftest] PASS: t5c-c1-multilayer-flamingo-train", flush=True)
