...
Pre-reg: preregs/2026-05-21_wave14_bet_f_sketch4_bound_states.md
"""
...
N_LABELS = 8  # Sketch 4 dislocation bound states: non-Z labels (parafermion sectors)
...
def compute_verdict(summary):
    ...
    if not per_p:
        return ("BET_F_S4_INCONCLUSIVE", "Missing recovery data.")
    ...
    if rate_at_p005 >= PASS_RECOVERY and rate_at_p005 > ctrl_at_p005 + 0.15:
        return ("BET_F_S4_TOPOLOGY_PROTECTED",
...
def run_smoke():
    out_dir = get_output_dir("wave14_bet_f_sketch4_bound_states_smoke")
...
def run_main():
    out_dir = get_output_dir("wave14_bet_f_sketch4_bound_states")
