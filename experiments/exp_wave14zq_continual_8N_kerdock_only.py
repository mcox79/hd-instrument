...
Pre-reg: preregs/2026-05-21_wave14zq_continual_8N_kerdock_only.md
"""
...
def run_smoke():
    out_dir = get_output_dir("wave14zq_continual_8N_kerdock_only_smoke")
...
def run_main():
    out_dir = get_output_dir("wave14zq_continual_8N_kerdock_only")
