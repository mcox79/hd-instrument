"""
q_b1_chain_depth_80_v1_n8192 -- Q-B1: heteroassoc chain at depth-80 at N=8192.

Ceiling chase: depth-60 HARD_PASS this cycle; depth-70 shipped in parallel.
  Ship depth-80 to get full slope picture in one overnight batch.
...
PRE-REGISTERED BANDS (extends d70 spec; conservative ceiling):
  ...
  Calibration: continuing exponential fit from d55/d60/d70 (all HP).
    lambda ~ 0.004; d80 = d60 * exp(-0.004*20) ~ d60 * 0.923. If d60=0.25 => d80~0.23.
    Conservative HP at 0.10 (well below theoretical ~0.23 with margin for saturation).
    HF at 0.04 (>2.5x below HP threshold).
    Wider bands because this is 20 steps further than most-recent confirmed anchor.
...
ANCHOR_NAME = "q_b1_chain_depth_80_v1_n8192"
...
def compute_verdict(results: List[Dict]) -> tuple:
    ...
    if hp5 and hp10 and hp20 and hp30 and hp45 and hp80:
        return ("HARD_PASS", f"HARD_PASS: all depth thresholds met at N=8192 depth-80. {summary}")
