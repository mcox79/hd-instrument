...
Pre-reg: preregs/2026-05-21_wave14d_multi_task_cl_v9.md
"""
...
def run_smoke():
    out_dir = get_output_dir("wave14d_multi_task_cl_v9_smoke")
...
def run_main():
    out_dir = get_output_dir("wave14d_multi_task_cl_v9")
