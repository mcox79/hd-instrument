"""
q_a3_l113_cross_layer_composition_v1_n16384 -- Q-A3/PP-12: L=113 cross-layer composition at N=16384.

CONTEXT (v378 cycle 48 all-night burst):
  N=16384 series: L=20..L=112 all EXACT-1.0000 (L=112 NEW DEEPEST cycle 47).
  L=113 is rung 94 in the N=16384 depth ladder.
...
SCIENTIFIC QUESTION:
  Does cross-layer composition fidelity remain EXACT-1.0 at L=113 N=16384?

PRE-REGISTERED BANDS (PP-12/Q-A3 L=113 N=16384):
  HARD-PASS: all 113 level fidelities >= 0.9999 unanimous (5/5 seeds) AND l113_acc >= 0.5.
  MIDDLE: any L_fid in [0.85, 0.9999) OR graceful degradation.
  HARD-FAIL: any L_fid < 0.85 OR l113_acc < 0.5.

FORMULA SELF-TESTS (PROT-022):
  1. L=113 chain: 112-ctx Hadamard roundtrip recovers xi_L1.
...
ANCHOR_NAME = "q_a3_l113_cross_layer_composition_v1_n16384"
