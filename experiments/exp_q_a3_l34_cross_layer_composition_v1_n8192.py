"""
q_a3_l34_cross_layer_composition_v1_n8192 -- Q-A3/PP-12: L=34 cross-layer composition at N=8192.

CONTEXT (v370 refill cycle):
  N=4096 series: L=2..L=35 all EXACT-1.0000.
  N=8192: {L=19, L=22..L=32} all HARD_PASS EXACT-1.0000 (L=32 completed in v370 cycle).
  L=34 is the 14th rung in the N=8192 cross-N depth ladder (paired with L=33 this cycle).
  Also establishes 2-N cross-N {N=4096+N=8192} at L=34 (N=4096 already passed L=34).

SCIENTIFIC QUESTION:
  Does cross-layer composition fidelity remain EXACT-1.0 at L=34 N=8192?
  If yes: extends N=8192 cross-N series to L=34 (2-N cross-N at L=34).

MEMORY ESTIMATE (on-demand W):
  One W matrix at a time: 8192 x 8192 x 4 bytes = 268 MB. Well within 8 GB GPU.

PRE-REGISTERED BANDS (Q-A3 L=34 N=8192):
...
TIMEOUT ESTIMATE: L=32 N=8192 elapsed ~5s (5-seed). L=34 near-linear.
  ceil(1.5 * 6 * 1.0 * 1) = 9s. Use PROT-019 floor: 21600s.
"""
import sys
...
ANCHOR_NAME = "q_a3_l34_cross_layer_composition_v1_n8192"
