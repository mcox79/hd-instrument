...
Pre-reg: preregs/2026-05-21_wave14_bet_f_sketch1_burgers.md
"""
...
N_LABELS = 16  # 2D Burgers vector: 4 magnitudes x 4 angles
...
def run_smoke():
    out_dir = get_output_dir("wave14_bet_f_sketch1_burgers_smoke")
...
def run_main():
    out_dir = get_output_dir("wave14_bet_f_sketch1_burgers")
