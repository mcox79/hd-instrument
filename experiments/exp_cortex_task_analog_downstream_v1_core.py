"""exp_cortex_task_analog_downstream_v1 CORE -- shared task-analog logic.

Test whether cortex facade INVOCATION on a downstream task produces
measurably-better task-utility than either (a) individual-primitives-with-
no-facade-composition, or (b) no-cortex-at-all baseline.

Distinct claim from `exp_cortex_integration_end_to_end_v1` (integration-
fidelity CG math #51). This cell = "cortex layer actually helps on a
downstream task the substrate cares about."

Prereg: preregs/2026-07-04_exp_cortex_task_analog_downstream_v1.md
...
ANCHOR_BASE = "exp_cortex_task_analog_downstream_v1"
...
def _selftest_basic_pipeline() -> None:
    ...
    differ (META_RULE_AF proxy). Fast (<5s)."""
    seed = 7
