"""
exp_substrate_capacity_battery_gpu_v1 -- BUNDLED fine sparsity-curve capacity sweep, all on GPU -- GPU.
...
ANCHOR_NAME = "substrate_sparsity_fine_battery_gpu_v1"
FLIP = 0.05; STEPS = 6
_DEV = torch.device("cuda" if torch.cuda.is_available() else "cpu")
RULES = ["dense", "sparse0.02", "sparse0.05", "sparse0.08", "sparse0.12", "sparse0.20", "sparse0.35", "sparse0.50"]
