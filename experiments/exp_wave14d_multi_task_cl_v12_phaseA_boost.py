...
Pre-reg: preregs/2026-05-21_wave14d_multi_task_cl_v12_phaseA_boost.md
"""
...
EPOCHS_FULL = 5
EPOCHS_SMOKE = 1
PHASE_A_EPOCHS_FULL = 15  # v12: very extended Phase A baseline
REPLAY_FRAC = 0.30  # combined with deep Phase A
...
def run_smoke():
    out_dir = get_output_dir("wave14d_multi_task_cl_v12_phaseA_boost_smoke")
...
def run_main():
    out_dir = get_output_dir("wave14d_multi_task_cl_v12_phaseA_boost")
