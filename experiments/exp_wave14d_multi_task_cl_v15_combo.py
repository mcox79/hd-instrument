...
Pre-reg: preregs/2026-05-21_wave14d_multi_task_cl_v15_combo.md
"""
...
REPLAY_FRAC = 0.25  # v9 maximum replay; compound with EMA
...
def run_smoke():
    out_dir = get_output_dir("wave14d_multi_task_cl_v15_combo_smoke")
...
def run_main():
    out_dir = get_output_dir("wave14d_multi_task_cl_v15_combo")
