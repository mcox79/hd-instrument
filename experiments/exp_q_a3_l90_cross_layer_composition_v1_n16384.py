"""
q_a3_l90_cross_layer_composition_v1_n16384 -- Q-A3/PP-12: L=90 cross-layer composition at N=16384.

CONTEXT (v374 cycle 44 all-night burst):
  N=16384 series: L=20..L=89 all EXACT-1.0000 (queued cycle 44).
  L=90 is rung 71 in the N=16384 depth ladder.
...
SCIENTIFIC QUESTION:
  Does cross-layer composition fidelity remain EXACT-1.0 at L=90 N=16384?

PRE-REGISTERED BANDS (PP-12/Q-A3 L=90 N=16384):
  HARD-PASS: all 87 level fidelities >= 0.9999 unanimous (5/5 seeds) AND l90_acc >= 0.5.
  MIDDLE: any L_fid in [0.85, 0.9999) OR graceful degradation.
  HARD-FAIL: any L_fid < 0.85 OR l90_acc < 0.5.

FORMULA SELF-TESTS (PROT-022):
  1. L=90 chain: 89-ctx Hadamard roundtrip recovers xi_L1.
     [INPUT: 2-element +-1 vectors, 89 context ops] [EXPECTED: decode = xi_L1 exactly]
  ...
  4. M_MID length == L_DEPTH - 2 == 88.
     [INPUT: L_DEPTH=90] [EXPECTED: len(M_MID)=88]
...
ANCHOR_NAME = "q_a3_l90_cross_layer_composition_v1_n16384"
