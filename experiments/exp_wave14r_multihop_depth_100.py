...
Pre-reg: preregs/2026-05-21_wave14r_multihop_depth_100.md
"""
...
NUM_FACTS_FULL = 100
NUM_FACTS_SMOKE = 20
HOP_DEPTHS_FULL = [1, 5, 10, 25, 50, 75, 100]
...
def run_smoke():
    out_dir = get_output_dir("wave14r_multihop_depth_100_smoke")
    log_event("experiment_started", name="wave14r_multihop_depth_100", mode="smoke")
    ...
    log_event("experiment_outcome", name="wave14r_multihop_depth_100",
              mode="smoke", verdict=verdict, verdict_msg=msg, elapsed_s=elapsed)
    print(f"\nSMOKE OK: {verdict}", flush=True)


def run_main():
    out_dir = get_output_dir("wave14r_multihop_depth_100")
    log_event("experiment_started", name="wave14r_multihop_depth_100", mode="full")
