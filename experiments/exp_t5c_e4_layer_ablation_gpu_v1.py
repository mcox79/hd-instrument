"""
exp_t5c_e4_layer_ablation_gpu_v1 -- Tier-5c Phase C: multi-layer Flamingo adapter continued training (LOCAL 4060 Ti) -- GPU.
...
ANCHOR_NAME = "t5c_e4_layer_ablation_gpu_v1"; MODEL = "EleutherAI/pythia-160m"; LAYERS = [4, 5]
...
def _selftest():
    ...
    print("[selftest] PASS: t5c-e4-layer-ablation", flush=True)
