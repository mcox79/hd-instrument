"""PHASE REGION D -- KF-2 variant: M_frac=12, beta=64 at N=4096.

Identical physics probe to region_d_kf1; KF-2 labeling lineage.

N-suffix: _n4096 -> production N = 4096 (PROT-018 binding).
Anchor: region_d_kf2_n4096_beta64_mfrac12
Queue: overnight_queue
Pre-reg: preregs/2026-05-29_phase_region_cd_n4096.md
Parent: phase_region_cd_v1_n4096
"""
...
_drv_spec = importlib.util.spec_from_file_location("phcd_drv_rd_kf2", _drv_path)
...
HP_RET_MAX = _drv.HP_RETENTION_D_MAX
HF_RET_MIN = _drv.HF_RETENTION_D_MIN
HP_SEEDS   = _drv.HP_SEEDS_D_MIN


def get_output_dir() -> Path:
    name = os.environ.get("HDLAB_EXP_NAME", "region_d_kf2_n4096_beta64_mfrac12")
...
def _instrumentation_selftest() -> None:
    ...
    print(f"[selftest] region_d_kf2_n4096_beta64_mfrac12 PASS "
...
def main():
    ...
    print(f"[run] region_d_kf2_n4096_beta64_mfrac12 smoke={smoke} N={N_cfg} "
          f"M_frac={M_FRAC} beta={BETA} seeds={seeds} device={device_str}", flush=True)
    t0 = time.time()
