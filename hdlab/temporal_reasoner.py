...
__bf_note__ = 'Reichenbach E/R/S reference-time + Allen interval algebra (pinned framework); transitive-closure + iconicity fallback heuristics; CAT genuinely-BF'
__bf_corrections__ = []
