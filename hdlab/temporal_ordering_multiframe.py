...
from hdlab import temporal_ordering as T  # noqa: E402  (shared extractor; self-contained promotion #1)
from hdlab.temporal_ordering import _perceptron_tagger as _tagger  # noqa: E402  (in-substrate tagger, promotion #1)
