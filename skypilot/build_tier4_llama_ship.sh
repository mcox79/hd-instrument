#!/usr/bin/env bash
# Build WSL-native ~/tier4-llama-ship/ bundle for SkyPilot launch.
set -euo pipefail

SRC=/mnt/d/AI/hd-instrument
DST=/root/tier4-llama-ship
...
cp "${SRC}/experiments/exp_substrate_tier4_hopfield_attention_substitution_llama_3_2_1b_v1.py" \
   "${DST}/experiments/exp_substrate_tier4_hopfield_attention_substitution_llama_3_2_1b_v1.py"
...
cp "${SRC}/skypilot/tier4_llama.yaml" "${DST}/skypilot/tier4_llama.yaml"
