"""TIER-2 P1 benchmark: FB15K-237 multi-hop TRAVERSAL on CPU (real triples). Substrate-native (traverse stored triples), NOT link-prediction-inference. Write-tool authored."""
import pathlib
...
'''
(EXP / "exp_fb15k237_multihop_traversal_cpu_v1.py").write_text(CELL, encoding="utf-8"); print("wrote fb15k237_multihop_traversal")
