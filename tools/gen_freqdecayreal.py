"""Real-data validation of the continual-learning STRENGTH: FREQUENCY-DECAY-REAL. Audits graceful frequency-selective
forgetting under realistic structure: ZIPFIAN access frequency + CORRELATED item embeddings (topic clusters). Tests
retrievability tracks real frequency (AUC>=0.70) at 3x capacity. Pure-FHRR. Write-tool authored."""
import pathlib
...
'''
(EXP / "exp_freq_decay_real_cpu_v1.py").write_text(CELL, encoding="utf-8"); print("wrote freq_decay_real")
