"""Research WAVE-4: LAP4-5 ZKP-RANGE-PROOF (prove v in [0,2^n) without revealing v; Bulletproofs-analog via Pedersen + CDS OR-per-bit). Pure-python crypto. Write-tool authored."""
import pathlib
...
'''
(EXP / "exp_lap4_5_zkp_range_proof_cpu_v1.py").write_text(CELL, encoding="utf-8"); print("wrote zkp_range_proof")
