"""Research ARCH-2 NOW-1: TEMPORAL/CONTEXTUAL GROUNDING via a "now" shard.
Same query returns context-appropriate different answers when grounded in a "now" context vector; ungrounded query is
ambiguous. Tests the "now"-shard primitive (collapses temporal/multimodal/embodiment/multi-agent barriers). Pure-FHRR. Write-tool authored."""
import pathlib
...
'''
(EXP / "exp_now1_temporal_grounding_cpu_v1.py").write_text(CELL, encoding="utf-8"); print("wrote now1_temporal_grounding")
