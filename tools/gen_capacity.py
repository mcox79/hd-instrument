"""Substrate bundle-capacity curve: sweep #superposed pairs k vs dimension N, find where cleanup recall degrades. Follows tonight's high-fanout result (capacity held at <=50 tails; this finds the limit). Pure-numpy. Write-tool authored."""
import pathlib
...
'''
(EXP / "exp_substrate_bundle_capacity_cpu_v1.py").write_text(CELL, encoding="utf-8"); print("wrote substrate_bundle_capacity")
