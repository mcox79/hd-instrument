"""Robustness audit of the SLIPNET cross-domain win: SLIPNET-NOISE. Real graphs aren't perfectly isomorphic. Tests whether
relation-type correspondence recovery survives graph NOISE (edge delete + add) -- is the cross-domain crack robust or fragile?
Pure-FHRR. Write-tool authored."""
import pathlib
...
'''
(EXP / "exp_slipnet_noise_cpu_v1.py").write_text(CELL, encoding="utf-8"); print("wrote slipnet_noise")
