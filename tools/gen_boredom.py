"""Research REVIVAL_SUBSTRATE_NATIVE Sprint-1: BOREDOM DETECTION (motivation, P=0.60, substrate-only).
Intrinsic-motivation primitive: substrate measures repeated-pattern density -- a "boredom" signal that rises when inputs
repeat recent experience and falls on novelty. Mechanism: cleanup-margin of a new input against a decayed recent-experience
bundle. Tests boredom discriminates repeated vs novel inputs. Pure-FHRR. Write-tool authored."""
import pathlib
...
'''
(EXP / "exp_boredom_detection_cpu_v1.py").write_text(CELL, encoding="utf-8"); print("wrote boredom_detection")
