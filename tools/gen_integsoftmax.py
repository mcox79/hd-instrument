"""Research 5X ARCHITECTURAL Sprint-1: INTEG-SOFTMAX-T1. Tests the FIX for my INTEGRATION-ALGEBRA WEAK result: replace
additive flow-control with MULTIPLICATIVE (geometric/softmax) integration -- the universal integration operator (Physarum +
hypothalamus + GWT + MoE). Multiplicative gating maximizes BALANCED satisfaction (no drive starved). Pure-FHRR/numpy. Write-tool authored."""
import pathlib
...
'''
(EXP / "exp_integ_softmax_t1_cpu_v1.py").write_text(CELL, encoding="utf-8"); print("wrote integ_softmax_t1")
