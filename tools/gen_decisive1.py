"""DECISIVE-1 (Research P4): substrate-as-speculative-draft acceptance rate alpha. Substrate caches (context-hidden -> Pythia next-token); retrieves a draft for test contexts; alpha = match vs Pythia argmax. CPU (Pythia-160M). Write-tool authored."""
import pathlib
...
'''
(EXP / "exp_decisive1_spec_draft_accept_cpu_v1.py").write_text(CELL, encoding="utf-8"); print("wrote decisive1_spec_draft_accept_cpu")
