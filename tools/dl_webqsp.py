"""Download RoG-WebQSP (real KG-QA with per-question subgraphs). Run on the runner."""
import json
from datasets import load_dataset

OUT = "C:/dev/hd-instrument/data/datasets/webqsp_rog.jsonl"
ds = load_dataset("rmanluo/RoG-webqsp", split="train", streaming=True)
n = 0
with open(OUT, "w", encoding="utf-8") as f:
    for r in ds:
        ...
        if n >= 2000:
            break
print("wrote", n, "webqsp questions to", OUT, flush=True)
# inspect one graph
import json as _j
