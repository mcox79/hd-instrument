"""TIER-2 P1: WebQSP substrate-encoded-subgraph K-hop traversal coverage (RoG-webqsp, real benchmark). Tests FHRR graph-store fidelity for multi-hop answer reachability. Write-tool authored."""
import pathlib
...
'''
(EXP / "exp_webqsp_substrate_traversal_cpu_v1.py").write_text(CELL, encoding="utf-8"); print("wrote webqsp_substrate_traversal")
