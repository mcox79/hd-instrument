"""Research WAVE-3: LAP3-8 ZKP-PROOF-PRIMITIVE (Schnorr zero-knowledge proof-of-knowledge of a substrate fact). Pure-python crypto. Write-tool authored."""
import pathlib
...
'''
(EXP / "exp_lap3_8_zkp_primitive_cpu_v1.py").write_text(CELL, encoding="utf-8"); print("wrote zkp_primitive")
