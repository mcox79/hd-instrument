"""AGGRESSIVE_OVERNIGHT THRUST-2 MATH: MATH-3 CALCULUS-DERIVATIVE (substrate-only). Substrate recovers an expression's
structure (coeff, var-power, outer-fn) and applies stored derivative rules (power rule + chain rule) compositionally.
Tests derivative accuracy on generated expressions. Pure-FHRR + symbolic rules. Write-tool authored."""
import pathlib
...
'''
(EXP / "exp_math3_calculus_derivative_cpu_v1.py").write_text(CELL, encoding="utf-8"); print("wrote math3_calculus_derivative")
