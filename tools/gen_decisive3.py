"""Generator: DECISIVE-3 -- substrate deterministic multi-hop completeness vs a probabilistic top-k (LazyGraphRAG-style) baseline. CPU, pure-numpy/VSA."""
import pathlib
...
'''
(EXP / "exp_decisive3_multihop_completeness_cpu_v1.py").write_text(HEAD.format(body=BODY), encoding="utf-8"); print("wrote decisive3")
