"""Research WAVE-3 (data-gated, routed to GPU): LAP3-5 GRAM-MATRIX-CONDITION-DIAGNOSTIC -- frozen encoder Gram condition number -> fp32-vs-bf16 head recommendation. torch+HF (GPU/home). Write-tool authored."""
import pathlib
...
'''
(EXP / "exp_lap3_5_gram_matrix_diag_gpu_v1.py").write_text(CELL, encoding="utf-8"); print("wrote gram_matrix_diag")
