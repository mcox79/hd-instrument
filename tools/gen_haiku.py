"""Research WAVE-2: LAP2-11 CONV-1-CREATIVE-FORM (haiku via substrate topic-word retrieval + syllable constraint-fill). Pure-FHRR. Write-tool authored."""
import pathlib
...
'''
(EXP / "exp_lap2_11_haiku_cpu_v1.py").write_text(CELL, encoding="utf-8"); print("wrote haiku")
