...
HARD_RULES = (
    ...
    "PYTHONHASHSEED=0). If a tool call is DENIED: stop and report the denial text verbatim; do not retry a variant. Do NOT fan out to "
...
PHASES = (
    ...
    "we lose signal upstream? are all upstream components brain-foundational?\"\n"
    ...
    "6. FINALIZE: documentation highlighting every component you interacted with or created and its brain-foundational status; "
