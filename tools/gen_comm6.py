"""AGGRESSIVE_OVERNIGHT THRUST-1 COMMUNICATE: COMM-6 INTENT-DECODING (substrate-only). Each intent has multiple varied
surface realizations (style variation + noise); substrate decodes the core INTENT from the surface. Tests decoding accuracy
under surface variation. Pure-FHRR. Write-tool authored."""
import pathlib
...
'''
(EXP / "exp_comm6_intent_decoding_cpu_v1.py").write_text(CELL, encoding="utf-8"); print("wrote comm6_intent_decoding")
