"""Research WAVE-4: LAP4-8 CAUSAL-DISCOVERY (substrate recovers causal DAG structure from observational data). Pure-numpy. Write-tool authored."""
import pathlib
...
'''
(EXP / "exp_lap4_8_causal_discovery_cpu_v1.py").write_text(CELL, encoding="utf-8"); print("wrote causal_discovery")
