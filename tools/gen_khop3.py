"""Research CPU-P2: SUBSTRATE-K-HOP-3HOP -- deterministic 3-hop chain traversal at production KB scale. HARD-PASS recall>=0.70. CPU numpy/VSA. Write-tool authored."""
import pathlib
...
'''
(EXP / "exp_substrate_khop_3hop_cpu_v1.py").write_text(HEAD.format(body=BODY), encoding="utf-8"); print("wrote substrate_khop_3hop")
