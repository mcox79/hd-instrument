"""Research overnight laptop STRETCH: ARGUMENTATION-1 (Dung abstract argumentation, grounded semantics). Pure-FHRR. Write-tool authored."""
import pathlib
...
'''
(EXP / "exp_argumentation_grounded_cpu_v1.py").write_text(CELL, encoding="utf-8"); print("wrote argumentation_grounded")
