"""Research overnight laptop batch: LAP-5 SCHEMA-LAYER (category prototype/schema extraction; compression). Pure-FHRR, synthetic categories (no download). Write-tool authored."""
import pathlib
...
'''
(EXP / "exp_lap5_schema_layer_cpu_v1.py").write_text(CELL, encoding="utf-8"); print("wrote lap5_schema_layer")
