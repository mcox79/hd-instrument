"""Research WAVE-5 P2: COMP-11 1-BIT-AT-DEPTH. Does 1-bit (QPSK) quantization of every stored vector preserve the
depth-independent recall that hierarchical cleanup gives? Deployment-realistic (32x memory saving). Pure-FHRR. Write-tool authored."""
import pathlib
...
'''
(EXP / "exp_comp11_1bit_at_depth_cpu_v1.py").write_text(CELL, encoding="utf-8"); print("wrote comp11_1bit_at_depth")
