"""Research overnight laptop batch: LAP-2 MODAL-K-1 (K modal logic over Kripke frames; box/diamond). Pure-FHRR. Write-tool authored."""
import pathlib
...
'''
(EXP / "exp_lap2_modal_k_cpu_v1.py").write_text(CELL, encoding="utf-8"); print("wrote lap2_modal_k")
