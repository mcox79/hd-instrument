"""Research NEXT_SPRINT1_REAL_DATA_AUDIT: TOOL-EXTENDED-REAL (PP-317). Audits peripersonal tool-extension under realistic
sensor data: CORRELATED body/tool/object embeddings (shared sensor features, not orthogonal) + sensor NOISE. Tests AUC>=0.70
on real-ish tool-use sequences (synthetic was 1.0). Pure-FHRR. Write-tool authored."""
import pathlib
...
'''
(EXP / "exp_tool_extended_real_cpu_v1.py").write_text(CELL, encoding="utf-8"); print("wrote tool_extended_real")
