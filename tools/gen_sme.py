"""Research REVIVAL_SUBSTRATE_NATIVE Sprint-2: D3.1 STRUCTURAL-ALIGNMENT-SME (cross-domain, P=0.48, substrate-only).
Gentner Structure-Mapping as substrate ops: cross-domain analogy by RELATIONAL STRUCTURE alone (not entity surface). Two
isomorphic relation graphs from different domains (unrelated entity vectors); recover the entity correspondence via iterated
structural-role message passing. Genuinely informative (the P9-retracted cross-domain question, different mechanism). Pure-FHRR. Write-tool authored."""
import pathlib
...
'''
(EXP / "exp_d3_1_structural_alignment_sme_cpu_v1.py").write_text(CELL, encoding="utf-8"); print("wrote d3_1_structural_alignment_sme")
