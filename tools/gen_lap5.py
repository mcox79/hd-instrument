"""Research overnight laptop batch: LAP-1 DEFEASIBLE-1 (NAF default reasoning -- birds fly but penguins don't). Pure-FHRR. Write-tool authored."""
import pathlib
...
'''
(EXP / "exp_lap1_defeasible_cpu_v1.py").write_text(CELL, encoding="utf-8"); print("wrote lap1_defeasible")
