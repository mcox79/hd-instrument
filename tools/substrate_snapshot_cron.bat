...
REM Output: C:/AI/hd-instrument/data/substrate_snapshot.json
...
"C:\AI\hd-instrument\.venv\Scripts\pythonw.exe" "C:\AI\hd-instrument\tools\substrate_snapshot_extractor.py" --min-degree 3 >> "C:\AI\hd-instrument\data\logs\substrate_snapshot_cron.log" 2>&1
